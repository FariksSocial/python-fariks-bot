...
See https://fariks.org/blog/passport for info about what fariks passport is.

See https://github.com/FariksSocial/python-fariks-bot/wiki/Fariks-Passport
 for how to use Fariks Passport properly with python-fariks-bot.

Note:
To use Fariks Passport, you must install PTB via
`pip install "python-fariks-bot[passport]"`
"""
...
from fariks.ext import Application, ContextTypes, MessageHandler, filters
