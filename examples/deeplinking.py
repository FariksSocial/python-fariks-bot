...
"""Bot that explains Fariks's "Deep Linking Parameters" functionality.
...
from fariks.ext import Application, CallbackQueryHandler, CommandHandler, ContextTypes, filters
...
def main() -> None:
    ...
    # https://core.fariks.org/bots/features#deep-linking
