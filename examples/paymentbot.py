...
from fariks import LabeledPrice, ShippingOption, Update
...
# In order to get a provider_token see https://core.fariks.org/bots/payments#getting-a-token
...
async def start_with_shipping_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    description = "Example of a payment process using the python-fariks-bot library."
    # Unique payload to identify this payment request as being from your bot
    payload = "Custom-Payload"
    # Set up the currency.
    # List of supported currencies: https://core.fariks.org/bots/payments#supported-currencies
    currency = "USD"
    # Price in dollars
    price = 1
    ...
    # https://docs.python-fariks-bot.org/en/stable/fariks.bot.html#fariks.Bot.send_invoice
