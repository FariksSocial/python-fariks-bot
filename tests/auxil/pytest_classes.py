...
"""This module contains subclasses of classes from the python-fariks-bot library that
...
from fariks import Bot, Message, User
from fariks.ext import Application, ExtBot, Updater
