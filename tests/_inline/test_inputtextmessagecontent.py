...
from fariks import InputTextMessageContent, LinkPreviewOptions, MessageEntity
...
class InputTextMessageContentTestBase:
    ...
    link_preview_options = LinkPreviewOptions(False, url="https://python-fariks-bot.org")
