...
from fariks import Bot, ChatPhoto, Voice
...
class ChatPhotoTestBase:
    ...
    chatphoto_file_url = "https://python-fariks-bot.org/static/testfiles/fariks.jpg"
...
class TestChatPhotoWithRequest:
    ...
    async def test_error_send_empty_file(self, bot, super_group_id):
        with Path(os.devnull).open("rb") as chatphoto_file, pytest.raises(FariksError):
