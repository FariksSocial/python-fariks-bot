...
from fariks import InputSticker, MaskPosition
...
class TestInputStickerWithoutRequest(InputStickerTestBase):
    ...
    def test_with_sticker_input_types(self, video_sticker_file):
        ...
        sticker = InputSticker(data_file("fariks_video_sticker.webm"), ["👍"], "video")
        assert sticker.sticker == data_file("fariks_video_sticker.webm").as_uri()
