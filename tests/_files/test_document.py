...
from fariks import Bot, Document, InputFile, MessageEntity, PhotoSize, ReplyParameters, Voice
...
class DocumentTestBase:
    ...
    document_file_url = "https://python-fariks-bot.org/static/testfiles/fariks.gif"
    file_size = 12948
    mime_type = "image/png"
    file_name = "fariks.png"
...
class TestDocumentWithRequest(DocumentTestBase):
    async def test_error_send_empty_file(self, bot, chat_id):
        with Path(os.devnull).open("rb") as f, pytest.raises(FariksError):
    ...
    async def test_send_all_args(self, bot, chat_id, document_file, document, thumb_file):
        ...
        assert message.document.file_name == "fariks_custom.png"
    ...
    async def test_send_url_gif_file(self, bot, chat_id):
        ...
        assert document.file_name == "fariks.gif"
