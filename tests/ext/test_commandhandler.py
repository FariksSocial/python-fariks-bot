...
from fariks import Bot, Chat, Message, Update
from fariks.ext import CallbackContext, CommandHandler, JobQueue, filters
...
class BaseTest:
    ...
    def _test_edited(self, message, handler_edited, handler_not_edited):
        ...
        :param message: ``fariks.Message`` to check against the handlers
