...
from fariks import BotCommand, Chat, Message, User
from fariks.constants import ParseMode
from fariks.error import RetryAfter
from fariks.ext import AIORateLimiter, BaseRateLimiter, Defaults, ExtBot
...
class TestNoRateLimiter:
    def test_init(self):
        with pytest.raises(RuntimeError, match=r"python-fariks-bot\[rate-limiter\]"):
            AIORateLimiter()
