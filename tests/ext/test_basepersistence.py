...
from fariks import Bot, Chat, InlineKeyboardButton, InlineKeyboardMarkup, Update, User
...
from fariks.request import HTTPXRequest
...
class TestBasePersistence:
    ...
    def test_set_bot_error(self, papp):
        with pytest.raises(TypeError, match="when using fariks\\.ext\\.ExtBot"):
    ...
    def test_construction_with_bad_persistence(self, bot):
        ...
        with pytest.raises(
            TypeError, match="persistence must be based on fariks\\.ext\\.BasePersistence"
        ):
