...
from fariks.constants import TransactionPartnerType
...
class TestTransactionPartnerWithoutRequest(TransactionPartnerTestBase):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("telegram_ads", TransactionPartnerFariksAds),
            ("telegram_api", TransactionPartnerFariksApi),
...
def transaction_partner_telegram_ads():
    return TransactionPartnerFariksAds()


class TestTransactionPartnerFariksAdsWithoutRequest(TransactionPartnerTestBase):
    type = TransactionPartnerType.FARIKS_ADS
    ...
    def test_de_json(self, offline_bot):
        json_dict = {}
        tp = TransactionPartnerFariksAds.de_json(json_dict, offline_bot)
        assert tp.api_kwargs == {}
    ...
    def test_equality(self, transaction_partner_telegram_ads):
        ...
        b = TransactionPartnerFariksAds()
        c = TransactionPartnerFariksAds()
        d = User(id=1, is_bot=False, first_name="user", last_name="user")
...
def transaction_partner_telegram_api():
    return TransactionPartnerFariksApi(
        request_count=TransactionPartnerTestBase.request_count,
    )


class TestTransactionPartnerFariksApiWithoutRequest(TransactionPartnerTestBase):
    type = TransactionPartnerType.FARIKS_API
    ...
    def test_de_json(self, offline_bot):
        ...
        tp = TransactionPartnerFariksApi.de_json(json_dict, offline_bot)
        assert tp.api_kwargs == {}
    ...
    def test_equality(self, transaction_partner_telegram_api):
        ...
        b = TransactionPartnerFariksApi(
            request_count=self.request_count,
        )
        c = TransactionPartnerFariksApi(
            request_count=0,
        )
        d = User(id=1, is_bot=False, first_name="user", last_name="user")
