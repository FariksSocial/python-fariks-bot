...
from fariks._utils.types import FileInput, ODVInput
from fariks.ext import Defaults
...
from tests.test_official.scraper import FariksParameter
...
def check_required_param(
    tg_param: FariksParameter, param: inspect.Parameter, method_or_obj_name: str
) -> bool:
    """Checks if the method/class parameter is a required/optional param as per Fariks docs.

    Returns:
        :obj:`bool`: The boolean returned represents whether our parameter's requirement (optional
            or required) is the same as Fariks's or not.
    """
    ...
    Returns:
        :obj:`tuple`: A tuple containing:
            * :obj:`bool`: The boolean returned represents whether our parameter's type annotation
              is the same as Fariks's or not.
