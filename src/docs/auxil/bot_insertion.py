...
keyword_args = [
    ...
    (
        ...
        "        to be passed to the Fariks API. See :meth:`~fariks.Bot.do_api_request` for"
        "        limitations."
    ),
    "",
]
...
media_write_timeout_change = [
    "    write_timeout (:obj:`float` | :obj:`None`, optional): Value to pass to "
    "        :paramref:`fariks.request.BaseRequest.post.write_timeout`. By default, ``20`` "
...
get_updates_read_timeout_addition = [
    ...
    "",
    "        .. versionchanged:: 20.7",
    "           Defaults to :attr:`~fariks.request.BaseRequest.DEFAULT_NONE` instead of ",
    "           ``2``.",
]
