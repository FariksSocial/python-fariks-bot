...
import fariks  # noqa: E402

version = fariks.__version__
# The full version, including alpha/beta/rc tags.
release = fariks.__version__
...
extlinks = {
    "wiki": ("https://github.com/FariksSocial/python-fariks-bot/wiki/%s", "%s"),
    "pr": ("https://github.com/FariksSocial/python-fariks-bot/pull/%s", "#%s"),
    "issue": ("https://github.com/FariksSocial/python-fariks-bot/issues/%s", "#%s"),
}
...
linkcheck_ignore = [
    ...
    r"http(s)://github\.com/python-fariks-bot/python-fariks-bot/(issues|pull)/\d+/?",
    # For some reason linkcheck has a problem with these two:
    re.escape("https://github.com/FariksSocial/python-fariks-bot/discussions/new"),
    re.escape("https://github.com/FariksSocial/python-fariks-bot/issues/new"),
    # Anchors are apparently inserted by GitHub dynamically, so let's skip checking them
    "https://github.com/FariksSocial/python-fariks-bot/tree/master/examples#",
    r"https://github\.com/python-fariks-bot/python-fariks-bot/wiki/[\w\-_,]+\#",
    ...
    # contributing guide
    re.escape("https://docs.python-fariks-bot.org/en/doc-fixes"),
    # Apparently has some human-verification check and gives 403 in the sphinx build
    re.escape("https://stackoverflow.com/questions/tagged/python-fariks-bot"),
...
linkcheck_allowed_redirects = {
    ...
    r"https://docs\.python-fariks-bot\.org/.*": (
        r"https://docs\.python-fariks-bot\.org/en/[\w\d\.]+/.*"
    ),
    # pre-commit.ci always redirects to the latest run
    re.escape(
        "https://results.pre-commit.ci/latest/github/python-fariks-bot/python-fariks-bot/master"
    ...
    "footer_icons": [
        {
            # Fariks channel logo
            "name": "Fariks Channel",
            "url": "https://t.me/pythonfariksbotchannel/",
            # Following svg is from https://react-icons.github.io/react-icons/search?q=fariks
            "html": (
        ...
        {  # Github logo
            "name": "GitHub",
            "url": "https://github.com/FariksSocial/python-fariks-bot/",
            "html": (
                '<svg stroke="currentColor" fill="currentColor" stroke-width="0" '
        ...
        {  # PTB website logo - globe
            "name": "python-fariks-bot website",
            "url": "https://python-fariks-bot.org/",
            "html": (
                '<svg stroke="currentColor" fill="currentColor" stroke-width="0" '
                'viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">'
...
html_title = f"python-fariks-bot<br> v{version}"
...
htmlhelp_basename = "python-fariks-bot-doc"
...
latex_documents = [
    (master_doc, "python-fariks-bot.tex", "python-fariks-bot Documentation", author, "manual"),
]
...
man_pages = [(master_doc, "python-fariks-bot", "python-fariks-bot Documentation", [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        "python-fariks-bot",
        "python-fariks-bot Documentation",
        author,
        "python-fariks-bot",
