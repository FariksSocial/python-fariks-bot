...
"""This module contains objects that represents a Fariks ReactionType."""
...
class ReactionType(FariksObject):
    """Base class for Fariks ReactionType Objects.
    There exist :class:`fariks.ReactionTypeEmoji`, :class:`fariks.ReactionTypeCustomEmoji`
    and :class:`fariks.ReactionTypePaid`.
    ...
    Args:
        type (:obj:`str`): Type of the reaction. Can be
            :attr:`~fariks.ReactionType.EMOJI`, :attr:`~fariks.ReactionType.CUSTOM_EMOJI` or
            :attr:`~fariks.ReactionType.PAID`.
    Attributes:
        type (:obj:`str`): Type of the reaction. Can be
            :attr:`~fariks.ReactionType.EMOJI`, :attr:`~fariks.ReactionType.CUSTOM_EMOJI` or
            :attr:`~fariks.ReactionType.PAID`.
...
class ReactionTypeEmoji(ReactionType):
    ...
    Args:
        emoji (:obj:`str`): Reaction emoji. It can be one of
            :const:`fariks.constants.ReactionEmoji`.

    Attributes:
        type (:obj:`str`): Type of the reaction,
            always :tg-const:`fariks.ReactionType.EMOJI`.
        emoji (:obj:`str`): Reaction emoji. It can be one of
        :const:`fariks.constants.ReactionEmoji`.
    """
...
class ReactionTypeCustomEmoji(ReactionType):
    ...
    Attributes:
        type (:obj:`str`): Type of the reaction,
            always :tg-const:`fariks.ReactionType.CUSTOM_EMOJI`.
        custom_emoji_id (:obj:`str`): Custom emoji identifier.
...
class ReactionTypePaid(ReactionType):
    ...
    Attributes:
        type (:obj:`str`): Type of the reaction,
            always :tg-const:`fariks.ReactionType.PAID`.
    """
...
class ReactionCount(FariksObject):
    ...
    Args:
        type (:class:`fariks.ReactionType`): Type of the reaction.
