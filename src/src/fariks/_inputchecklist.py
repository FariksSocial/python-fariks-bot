...
"""This module contains an objects that are related to Fariks input checklists."""
...
class InputChecklistTask(FariksObject):
    """
    ...
    Args:
        ...
        text (:obj:`str`):
            Text of the task;
            :tg-const:`fariks.constants.InputChecklistLimit.MIN_TEXT_LENGTH`\
-:tg-const:`fariks.constants.InputChecklistLimit.MAX_TEXT_LENGTH` characters after
            entities parsing.
        parse_mode (:obj:`str`, optional):
            |parse_mode|
        text_entities (Sequence[:class:`fariks.MessageEntity`], optional):
...
-:tg-const:`fariks.constants.InputChecklistLimit.MAX_TEXT_LENGTH` characters after
        ...
        parse_mode (:obj:`str`):
            Optional. |parse_mode|
        text_entities (Sequence[:class:`fariks.MessageEntity`]):
...
class InputChecklist(FariksObject):
    """
    ...
    Args:
        title (:obj:`str`):
            ...
            :tg-const:`fariks.constants.InputChecklistLimit.MIN_TITLE_LENGTH`\
-:tg-const:`fariks.constants.InputChecklistLimit.MAX_TITLE_LENGTH` characters after
            entities parsing.
        parse_mode (:obj:`str`, optional):
            |parse_mode|
        title_entities (Sequence[:class:`fariks.MessageEntity`], optional):
        ...
        tasks (Sequence[:class:`fariks.InputChecklistTask`]):
            List of
            :tg-const:`fariks.constants.InputChecklistLimit.MIN_TASK_NUMBER`\
-:tg-const:`fariks.constants.InputChecklistLimit.MAX_TASK_NUMBER` tasks in
            the checklist.
...
-:tg-const:`fariks.constants.InputChecklistLimit.MAX_TITLE_LENGTH` characters after
        ...
        parse_mode (:obj:`str`):
            Optional. |parse_mode|
        title_entities (Sequence[:class:`fariks.MessageEntity`]):
