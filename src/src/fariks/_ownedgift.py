...
from fariks._uniquegift import UniqueGift
...
class OwnedGift(FariksObject):
    """This object describes a gift received and owned by a user or a chat. Currently, it
    can be one of:

    * :class:`fariks.OwnedGiftRegular`
    * :class:`fariks.OwnedGiftUnique`
    ...
    """:const:`fariks.constants.OwnedGiftType.REGULAR`"""
    UNIQUE: Final[str] = constants.OwnedGiftType.UNIQUE
    """:const:`fariks.constants.OwnedGiftType.UNIQUE`"""
    ...
    def de_json(cls, data: JSONDict, bot: "Bot | None" = None) -> "OwnedGift":
        ...
        Args:
            ...
            bot (:class:`fariks.Bot`, optional): The bot associated with this object.
...
class OwnedGifts(FariksObject):
    ...
    Args:
        ...
        gifts (Sequence[:class:`fariks.OwnedGift`]): The list of gifts.
...
class OwnedGiftRegular(OwnedGift):
    ...
    Args:
        gift (:class:`fariks.Gift`): Information about the regular gift.
        ...
        sender_user (:class:`fariks.User`, optional): Sender of the gift if it is a known user.
        ...
        was_refunded (:obj:`bool`, optional): :obj:`True`, if the gift was refunded and isn't
            available anymore.
        convert_star_count (:obj:`int`, optional): Number of Fariks Stars that can be
            claimed by the receiver instead of the gift; omitted if the gift cannot be converted
            to Fariks Stars; for gifts received on behalf of business accounts only.
        prepaid_upgrade_star_count (:obj:`int`, optional): Number of Fariks Stars that were
        ...
        unique_gift_number (:obj:`int`, optional): Unique number reserved for this gift when
            upgraded. See the number field in :class:`~fariks.UniqueGift`

            ... versionadded:: 22.6

    Attributes:
        type (:obj:`str`): Type of the gift, always :attr:`~fariks.OwnedGift.REGULAR`.
        gift (:class:`fariks.Gift`): Information about the regular gift.
        owned_gift_id (:obj:`str`): Optional. Unique identifier of the gift for the bot; for
            gifts received on behalf of business accounts only.
        sender_user (:class:`fariks.User`): Optional. Sender of the gift if it is a known user.
    ...
    def de_json(cls, data: JSONDict, bot: "Bot | None" = None) -> "OwnedGiftRegular":
        """See :meth:`fariks.OwnedGift.de_json`."""
        data = cls._parse_data(data)
    ...
    def parse_entity(self, entity: MessageEntity) -> str:
        ...
        from a given :class:`fariks.MessageEntity` of :attr:`entities`.
...
class OwnedGiftUnique(OwnedGift):
    ...
    Args:
        gift (:class:`fariks.UniqueGift`): Information about the unique gift.
        ...
        transfer_star_count (:obj:`int`, optional): Number of Fariks Stars that must be paid
    ...
    Attributes:
        type (:obj:`str`): Type of the owned gift, always :tg-const:`~fariks.OwnedGift.UNIQUE`.
        gift (:class:`fariks.UniqueGift`): Information about the unique gift.
        owned_gift_id (:obj:`str`): Optional. Unique identifier of the received gift for the
            bot; for gifts received on behalf of business accounts only.
        sender_user (:class:`fariks.User`): Optional. Sender of the gift if it is a known user.
