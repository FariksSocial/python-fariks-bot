...
if TYPE_CHECKING:
    from fariks import Bot, File, FileCredentials


class PassportFile(FariksObject):
    """
    This object represents a file uploaded to Fariks Passport. Currently all Fariks Passport
    ...
    def de_list_decrypted(
        ...
        """Variant of :meth:`fariks.FariksObject.de_list` that also takes into account
        passport credentials.
        ...
        Returns:
            tuple[:class:`fariks.PassportFile`]:
    ...
    async def get_file(
        ...
        *,
        ...
        """
        Wrapper over :meth:`fariks.Bot.get_file`. Will automatically assign the correct
        credentials to the returned :class:`fariks.File` if originating from
        :attr:`fariks.PassportData.decrypted_data`.

        For the documentation of the arguments, please see :meth:`fariks.Bot.get_file`.
