...
"""This module contains the classes that represent Fariks PassportElementError."""
...
class PassportElementError(FariksObject):
    """Baseclass for the PassportElementError* classes.

    This object represents an error in the Fariks Passport element which was submitted that
    ...
    Args:
        ...
        type (:obj:`str`): The section of the user's Fariks Passport which has the error.
...
class PassportElementErrorDataField(PassportElementError):
    ...
    Objects of this class are comparable in terms of equality. Two objects of this class are
    considered equal, if their :attr:`~fariks.PassportElementError.source`, :attr:`type`,
    :attr:`field_name`, :attr:`data_hash` and :attr:`message` are equal.

    Args:
        type (:obj:`str`): The section of the user's Fariks Passport which has the error, one of
...
class PassportElementErrorFile(PassportElementError):
    ...
    Args:
        type (:obj:`str`): The section of the user's Fariks Passport which has the issue, one of
...
class PassportElementErrorTranslationFile(PassportElementError):
    ...
    Args:
        type (:obj:`str`): Type of element of the user's Fariks Passport which has the issue,
