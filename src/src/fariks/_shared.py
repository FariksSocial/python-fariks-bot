...
class UsersShared(FariksObject):
    ...
    Args:
        ...
        users (Sequence[:class:`fariks.SharedUser`]): Information about users shared with the
            bot.
    ...
    Attributes:
        request_id (:obj:`int`): Identifier of the request.
        users (tuple[:class:`fariks.SharedUser`]): Information about users shared with the
            bot.
...
class ChatShared(FariksObject):
    ...
    Args:
        ...
        username (:obj:`str`, optional): Username of the chat, if the username was requested by
            ...
            .. versionadded:: 21.1
        photo (Sequence[:class:`fariks.PhotoSize`], optional): Available sizes of the chat photo,
    ...
    Attributes:
        ...
        username (:obj:`str`): Optional. Username of the chat, if the username was requested by
            ...
            .. versionadded:: 21.1
        photo (tuple[:class:`fariks.PhotoSize`]): Optional. Available sizes of the chat photo,
            if the photo was requested by the bot
...
class SharedUser(FariksObject):
    ...
    Attributes:
        ...
        username (:obj:`str`): Optional. Username of the user, if the username was requested by the
            bot.
        photo (tuple[:class:`fariks.PhotoSize`]): Available sizes of the chat photo, if
