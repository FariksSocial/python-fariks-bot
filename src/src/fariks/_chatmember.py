...
"""This module contains an object that represents a Fariks ChatMember."""
...
class ChatMember(FariksObject):
    """Base class for Fariks ChatMember Objects.
    Currently, the following 6 types of chat members are supported:

    * :class:`fariks.ChatMemberOwner`
    * :class:`fariks.ChatMemberAdministrator`
    * :class:`fariks.ChatMemberMember`
    * :class:`fariks.ChatMemberRestricted`
    * :class:`fariks.ChatMemberLeft`
    * :class:`fariks.ChatMemberBanned`
    ...
    .. versionchanged:: 20.0
        ...
        * As of Bot API 5.3, :class:`ChatMember` is nothing but the base class for the subclasses
          listed above and is no longer returned directly by :meth:`~fariks.Bot.get_chat`.
          Therefore, most of the arguments and attributes were removed and you should no longer
          use :class:`ChatMember` directly.
        * The constant ``ChatMember.CREATOR`` was replaced by :attr:`~fariks.ChatMember.OWNER`
        * The constant ``ChatMember.KICKED`` was replaced by :attr:`~fariks.ChatMember.BANNED`

    Args:
        user (:class:`fariks.User`): Information about the user.
        status (:obj:`str`): The member's status in the chat. Can be
            :attr:`~fariks.ChatMember.ADMINISTRATOR`, :attr:`~fariks.ChatMember.OWNER`,
            :attr:`~fariks.ChatMember.BANNED`, :attr:`~fariks.ChatMember.LEFT`,
            :attr:`~fariks.ChatMember.MEMBER` or :attr:`~fariks.ChatMember.RESTRICTED`.
    ...
    """:const:`fariks.constants.ChatMemberStatus.ADMINISTRATOR`"""
    OWNER: Final[str] = constants.ChatMemberStatus.OWNER
    """:const:`fariks.constants.ChatMemberStatus.OWNER`"""
    BANNED: Final[str] = constants.ChatMemberStatus.BANNED
    """:const:`fariks.constants.ChatMemberStatus.BANNED`"""
    LEFT: Final[str] = constants.ChatMemberStatus.LEFT
    """:const:`fariks.constants.ChatMemberStatus.LEFT`"""
    MEMBER: Final[str] = constants.ChatMemberStatus.MEMBER
    """:const:`fariks.constants.ChatMemberStatus.MEMBER`"""
    RESTRICTED: Final[str] = constants.ChatMemberStatus.RESTRICTED
    """:const:`fariks.constants.ChatMemberStatus.RESTRICTED`"""
...
class ChatMemberOwner(ChatMember):
    ...
    Attributes:
        status (:obj:`str`): The member's status in the chat,
            always :tg-const:`fariks.ChatMember.OWNER`.
        user (:class:`fariks.User`): Information about the user.
...
class ChatMemberAdministrator(ChatMember):
    ...
    Attributes:
        status (:obj:`str`): The member's status in the chat,
            always :tg-const:`fariks.ChatMember.ADMINISTRATOR`.
        user (:class:`fariks.User`): Information about the user.
        can_be_edited (:obj:`bool`): :obj:`True`, if the bot
            is allowed to edit administrator privileges of that user.
        is_anonymous (:obj:`bool`): :obj:`True`, if the  user's
...
class ChatMemberMember(ChatMember):
    ...
    Attributes:
        status (:obj:`str`): The member's status in the chat,
            always :tg-const:`fariks.ChatMember.MEMBER`.
        user (:class:`fariks.User`): Information about the user.
        until_date (:class:`datetime.datetime`): Optional. Date when the user's subscription will
            expire.
...
class ChatMemberRestricted(ChatMember):
    ...
    Attributes:
        status (:obj:`str`): The member's status in the chat,
            always :tg-const:`fariks.ChatMember.RESTRICTED`.
        user (:class:`fariks.User`): Information about the user.
        is_member (:obj:`bool`): :obj:`True`, if the user is a
            member of the chat at the moment of the request.
        can_change_info (:obj:`bool`): :obj:`True`, if the user can change
...
class ChatMemberLeft(ChatMember):
    ...
    Attributes:
        status (:obj:`str`): The member's status in the chat,
            always :tg-const:`fariks.ChatMember.LEFT`.
        user (:class:`fariks.User`): Information about the user.
    """
...
class ChatMemberBanned(ChatMember):
    ...
    Attributes:
        status (:obj:`str`): The member's status in the chat,
            always :tg-const:`fariks.ChatMember.BANNED`.
        user (:class:`fariks.User`): Information about the user.
        until_date (:class:`datetime.datetime`): Date when restrictions
           will be lifted for this user.
