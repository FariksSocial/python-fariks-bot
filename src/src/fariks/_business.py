...
"""This module contains the Fariks Business related classes."""
...
class BusinessBotRights(FariksObject):
    """
    ...
    Args:
        ...
        can_view_gifts_and_stars (:obj:`bool`, optional): True, if the bot can view gifts and the
            amount of Fariks Stars owned by the business account.
        can_convert_gifts_to_stars (:obj:`bool`, optional): True, if the bot can convert regular
            gifts owned by the business account to Fariks Stars.
        ...
        can_transfer_stars (:obj:`bool`, optional): True, if the bot can transfer Fariks Stars
...
class BusinessConnection(FariksObject):
    """
    ...
    Args:
        ...
        user (:class:`fariks.User`): Business account user that created the business connection.
...
class BusinessMessagesDeleted(FariksObject):
    """
    ...
    Args:
        ...
        chat (:class:`fariks.Chat`): Information about a chat in the business account. The bot
...
class BusinessIntro(FariksObject):
    """
    This object contains information about the start page settings of a Fariks Business account.
    ...
    Args:
        ...
        sticker (:class:`fariks.Sticker`, optional): Sticker of the business intro.
...
class BusinessLocation(FariksObject):
    """
    This object contains information about the location of a Fariks Business account.
    ...
    Args:
        ...
        location (:class:`fariks.Location`, optional): Location of the business.
...
class BusinessOpeningHoursInterval(FariksObject):
    """
...
class BusinessOpeningHours(FariksObject):
    """
    ...
    Args:
        time_zone_name (:obj:`str`): Unique name of the time zone for which the opening
            hours are defined.
        opening_hours (Sequence[:class:`fariks.BusinessOpeningHoursInterval`]): List of
