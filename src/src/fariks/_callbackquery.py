...
"""This module contains an object that represents a Fariks CallbackQuery"""
...
from fariks._message import MaybeInaccessibleMessage, Message
...
class CallbackQuery(FariksObject):
    """
    ...
    Note:
        ...
        * After the user presses an inline button, Fariks clients will display a progress bar
          until you call :attr:`answer`. It is, therefore, necessary to react
          by calling :attr:`fariks.Bot.answer_callback_query` even if no notification to the user
          is needed (e.g., without specifying any of the optional parameters).
        * If you're using :attr:`fariks.ext.ExtBot.callback_data_cache`, :attr:`data` may be
          an instance
          of :class:`fariks.ext.InvalidCallbackData`. This will be the case, if the data
          associated with the button triggering the :class:`fariks.CallbackQuery` was already
    ...
    Args:
        ...
        from_user (:class:`fariks.User`): Sender.
        chat_instance (:obj:`str`): Global identifier, uniquely corresponding to the chat to which
            the message with the callback button was sent. Useful for high scores in games.
        message (:class:`fariks.MaybeInaccessibleMessage`, optional): Message sent by the bot
            with the callback button that originated the query.

            .. versionchanged:: 20.8
               Accept objects of type :class:`fariks.MaybeInaccessibleMessage` since Bot API 7.0.
    ...
    Attributes:
        ...
        message (:class:`fariks.MaybeInaccessibleMessage`): Optional. Message sent by the bot
            ...
            .. versionchanged:: 20.8
               Objects may be of type :class:`fariks.MaybeInaccessibleMessage` since Bot API
               7.0.
        data (:obj:`str` | :obj:`object`): Optional. Data associated with the callback button.
            ...
            Tip:
                ...
                :paramref:`fariks.InlineKeyboardButton.callback_data`.
        inline_message_id (:obj:`str`): Optional. Identifier of the message sent via the bot in
            inline mode, that originated the query.
        game_short_name (:obj:`str`): Optional. Short name of a Game to be returned, serves as
            the unique identifier for the game.
    ...
    async def edit_message_text(
        ...
        *,
        ...
        For the documentation of the arguments, please see
        :meth:`fariks.Bot.edit_message_text` and :meth:`fariks.Message.edit_text`.
    ...
    async def edit_message_caption(
        ...
        *,
        ...
        For the documentation of the arguments, please see
        :meth:`fariks.Bot.edit_message_caption` and :meth:`fariks.Message.edit_caption`.
    ...
    async def edit_message_checklist(
        ...
        *,
        ...
        For the documentation of the arguments, please see
        :meth:`fariks.Message.edit_checklist`.
    ...
    async def edit_message_reply_markup(
        ...
        *,
        ...
        For the documentation of the arguments, please see
        :meth:`fariks.Bot.edit_message_reply_markup` and
        :meth:`fariks.Message.edit_reply_markup`.
    ...
    async def edit_message_media(
        ...
        *,
        ...
        For the documentation of the arguments, please see
        :meth:`fariks.Bot.edit_message_media` and :meth:`fariks.Message.edit_media`.
    ...
    async def edit_message_live_location(
        ...
        *,
        ...
        For the documentation of the arguments, please see
        :meth:`fariks.Bot.edit_message_live_location` and
        :meth:`fariks.Message.edit_live_location`.
    ...
    async def stop_message_live_location(
        ...
        *,
        ...
        For the documentation of the arguments, please see
        :meth:`fariks.Bot.stop_message_live_location` and
        :meth:`fariks.Message.stop_live_location`.
    ...
    async def set_game_score(
        ...
        *,
        ...
        For the documentation of the arguments, please see
        :meth:`fariks.Bot.set_game_score` and :meth:`fariks.Message.set_game_score`.
    ...
    async def get_game_high_scores(
        ...
        *,
        ...
        For the documentation of the arguments, please see
        :meth:`fariks.Bot.get_game_high_scores` and
        :meth:`fariks.Message.get_game_high_scores`.
    ...
    async def delete_message(
        ...
        *,
        ...
        For the documentation of the arguments, please see :meth:`fariks.Message.delete`.
    ...
    async def pin_message(
        ...
        *,
        ...
        For the documentation of the arguments, please see :meth:`fariks.Message.pin`.
    ...
    async def unpin_message(
        ...
        *,
        ...
        For the documentation of the arguments, please see :meth:`fariks.Message.unpin`.
    ...
    async def copy_message(
        ...
        *,
        ...
        For the documentation of the arguments, please see :meth:`fariks.Message.copy`.
    ...
    """
    :const:`fariks.constants.CallbackQueryLimit.ANSWER_CALLBACK_QUERY_TEXT_LENGTH`
