...
"""This module contains an object that represents a Fariks ReplyKeyboardMarkup."""
...
class ReplyKeyboardMarkup(FariksObject):
    ...
    .. seealso::
        Another kind of keyboard would be the :class:`fariks.InlineKeyboardMarkup`.
    ...
    Args:
        keyboard (Sequence[Sequence[:obj:`str` | :class:`fariks.KeyboardButton`]]): Array of
            button rows, each represented by an Array of :class:`fariks.KeyboardButton` objects.
        ...
        selective (:obj:`bool`, optional): Use this parameter if you want to show the keyboard to
            ...
            1) Users that are @mentioned in the :attr:`~fariks.Message.text` of the
               :class:`fariks.Message` object.
        ...
        input_field_placeholder (:obj:`str`, optional): The placeholder to be shown in the input
            ...
            :tg-const:`fariks.ReplyKeyboardMarkup.MIN_INPUT_FIELD_PLACEHOLDER`-
            :tg-const:`fariks.ReplyKeyboardMarkup.MAX_INPUT_FIELD_PLACEHOLDER`
            characters.
    ...
    Attributes:
        keyboard (tuple[tuple[:class:`fariks.KeyboardButton`]]): Array of button rows,
            each represented by an Array of :class:`fariks.KeyboardButton` objects.
        resize_keyboard (:obj:`bool`): Optional. Requests clients to resize the keyboard vertically
            for optimal fit (e.g., make the keyboard smaller if there are just two rows of
            buttons). Defaults to :obj:`False`, in which case the custom keyboard is always of the
            same height as the app's standard keyboard.
    ...
    def from_button(
        ...
        **kwargs: object,
        ...
        Args:
            button (:class:`fariks.KeyboardButton` | :obj:`str`): The button to use in
                the markup.
    ...
    def from_row(
        ...
        **kwargs: object,
        ...
        Args:
            button_row (Sequence[:class:`fariks.KeyboardButton` | :obj:`str`]): The button to
                use in the markup.
    ...
    def from_column(
        ...
        **kwargs: object,
        ...
        Args:
            button_column (Sequence[:class:`fariks.KeyboardButton` | :obj:`str`]): The button
    ...
    """:const:`fariks.constants.ReplyLimit.MIN_INPUT_FIELD_PLACEHOLDER`

    .. versionadded:: 20.0
    """
    MAX_INPUT_FIELD_PLACEHOLDER: Final[int] = constants.ReplyLimit.MAX_INPUT_FIELD_PLACEHOLDER
    """:const:`fariks.constants.ReplyLimit.MAX_INPUT_FIELD_PLACEHOLDER`
