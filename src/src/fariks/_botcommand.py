...
"""This module contains an object that represents a Fariks Bot Command."""
...
class BotCommand(FariksObject):
    ...
    Args:
        command (:obj:`str`): Text of the command; :tg-const:`fariks.BotCommand.MIN_COMMAND`-
            :tg-const:`fariks.BotCommand.MAX_COMMAND` characters. Can contain only lowercase
            English letters, digits and underscores.
        description (:obj:`str`): Description of the command;
            :tg-const:`fariks.BotCommand.MIN_DESCRIPTION`-
            :tg-const:`fariks.BotCommand.MAX_DESCRIPTION` characters.
    ...
    """:const:`fariks.constants.BotCommandLimit.MIN_COMMAND`

    .. versionadded:: 20.0
    """
    MAX_COMMAND: Final[int] = constants.BotCommandLimit.MAX_COMMAND
    """:const:`fariks.constants.BotCommandLimit.MAX_COMMAND`

    .. versionadded:: 20.0
    """
    MIN_DESCRIPTION: Final[int] = constants.BotCommandLimit.MIN_DESCRIPTION
    """:const:`fariks.constants.BotCommandLimit.MIN_DESCRIPTION`

    .. versionadded:: 20.0
    """
    MAX_DESCRIPTION: Final[int] = constants.BotCommandLimit.MAX_DESCRIPTION
    """:const:`fariks.constants.BotCommandLimit.MAX_DESCRIPTION`
