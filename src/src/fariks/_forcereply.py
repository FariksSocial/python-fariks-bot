...
"""This module contains an object that represents a Fariks ForceReply."""
...
class ForceReply(FariksObject):
    """
    Upon receiving a message with this object, Fariks clients will display a reply interface to
    the user (act as if the user has selected the bot's message and tapped 'Reply'). This can be
    extremely useful if you want to create user-friendly step-by-step interfaces without having
    to sacrifice `privacy mode <https://core.fariks.org/bots/features#privacy-mode>`_. Not
    ...
    Args:
        ...
        input_field_placeholder (:obj:`str`, optional): The placeholder to be shown in the input
            ...
            :tg-const:`fariks.ForceReply.MIN_INPUT_FIELD_PLACEHOLDER`-
            :tg-const:`fariks.ForceReply.MAX_INPUT_FIELD_PLACEHOLDER`
            characters.
