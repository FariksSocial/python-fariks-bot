...
"""This module contains an object that represents a Fariks MessageEntity."""
...
class MessageEntity(FariksObject):
    """
    ...
    Args:
        type (:obj:`str`): Type of the entity. Can be :attr:`MENTION` (``@username``),
            ...
            (``https://fariks.org``), :attr:`EMAIL` (``do-not-reply@fariks.org``),
        ...
        user (:class:`fariks.User`, optional): For :attr:`TEXT_MENTION` only, the mentioned
             user.
        ...
        custom_emoji_id (:obj:`str`, optional): For :attr:`CUSTOM_EMOJI` only, unique identifier
            of the custom emoji. Use :meth:`fariks.Bot.get_custom_emoji_stickers` to get full
        ...
        date_time_format (:obj:`str`, optional): For :attr:`DATE_TIME` only, the string that
            ...
            <https://core.fariks.org/bots/api#date-time-entity-formatting>`_ for more details and
            :class:`fariks.constants.MessageEntityDateTimeFormats` for all possible formats.
    ...
    def adjust_message_entities_to_utf_16(text: str, entities: _SEM) -> _SEM:
        ...
        Tip:
            Only the offsets and lengths calulated in UTF-16 is acceptable by the Fariks Bot API.
        ...
        Args:
            ...
            entities (Sequence[:class:`fariks.MessageEntity`]): Sequence of entities
                with offset and length calculated in Unicode

        Returns:
            Sequence[:class:`fariks.MessageEntity`]: Sequence of entities
    ...
    def shift_entities(by: str | int, entities: _SEM) -> _SEM:
        ...
        Returns:
            Sequence[:class:`fariks.MessageEntity`]: Sequence of entities with the offset shifted
        """
    ...
    def concatenate(
        ...
        *args: tuple[str, _SEM] | tuple[str, _SEM, bool],
        ...
        Examples:
            ...
            the message in a :class:`~fariks.ext.CallbackQueryHandler`:
        ...
        Args:
            *args (tuple[:obj:`str`, Sequence[:class:`fariks.MessageEntity`]] | \
                tuple[:obj:`str`, Sequence[:class:`fariks.MessageEntity`], :obj:`bool`]):
        ...
        Returns:
            tuple[:obj:`str`, Sequence[:class:`fariks.MessageEntity`]]: The concatenated text
            and its entities
        """
        output_text = ""
