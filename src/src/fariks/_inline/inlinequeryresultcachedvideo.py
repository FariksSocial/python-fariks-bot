...
"""This module contains the classes that represent Fariks InlineQueryResultCachedVideo."""
...
class InlineQueryResultCachedVideo(InlineQueryResult):
    """
    Represents a link to a video file stored on the Fariks servers. By default, this video file
    ...
    Attributes:
        type (:obj:`str`): :tg-const:`fariks.constants.InlineQueryResultType.VIDEO`.
        id (:obj:`str`): Unique identifier for this result,
            :tg-const:`fariks.InlineQueryResult.MIN_ID_LENGTH`-
            :tg-const:`fariks.InlineQueryResult.MAX_ID_LENGTH` Bytes.
        video_file_id (:obj:`str`): A valid file identifier for the video file.
