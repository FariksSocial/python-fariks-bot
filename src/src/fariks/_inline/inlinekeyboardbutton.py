...
"""This module contains an object that represents a Fariks InlineKeyboardButton."""

from typing import TYPE_CHECKING, Final

from fariks import constants
from fariks._copytextbutton import CopyTextButton
from fariks._games.callbackgame import CallbackGame
from fariks._loginurl import LoginUrl
from fariks._switchinlinequerychosenchat import SwitchInlineQueryChosenChat
...
from fariks._webappinfo import WebAppInfo

if TYPE_CHECKING:
    from fariks import Bot


class InlineKeyboardButton(FariksObject):
    ...
    Note:
        ...
        * If your bot allows for arbitrary callback data, in keyboards returned in a response
          from fariks, :attr:`callback_data` may be an instance of
          :class:`fariks.ext.InvalidCallbackData`. This will be the case, if the data
        ...
        * Since Bot API 5.5, it's now allowed to mention users by their ID in inline keyboards.
          This will only work in Fariks versions released after December 7, 2021.
          Older clients will display *unsupported message*.
        * :attr:`style` option will only work in Fariks versions released after February 9, 2026.
    ...
    .. seealso:: :class:`fariks.InlineKeyboardMarkup`
    ...
    Args:
        ...
        login_url (:class:`fariks.LoginUrl`, optional): An ``HTTPS`` URL used to automatically
            authorize the user. Can be used as a replacement for the Fariks Login Widget.
        ...
        callback_data (:obj:`str` | :obj:`object`, optional): Data to be sent in a callback query
            ...
            :tg-const:`fariks.InlineKeyboardButton.MIN_CALLBACK_DATA`-
            :tg-const:`fariks.InlineKeyboardButton.MAX_CALLBACK_DATA` bytes.
            If the bot instance allows arbitrary callback data, anything can be passed.

            Tip:
                The value entered here will be available in :attr:`fariks.CallbackQuery.data`.

            .. seealso:: :wiki:`Arbitrary callback_data <Arbitrary-callback_data>`

        web_app (:class:`fariks.WebAppInfo`, optional): Description of the `Web App
            <https://core.fariks.org/bots/webapps>`_  that will be launched when the user presses
            the button. The Web App will be able to send an arbitrary message on behalf of the user
            using the method :meth:`~fariks.Bot.answer_web_app_query`. Available only in
            private chats between a user and the bot. Not supported for messages sent on behalf of
            a Fariks Business account.

            .. versionadded:: 20.0
        switch_inline_query (:obj:`str`, optional): If set, pressing the button will prompt the
            user to select one of their chats, open that chat and insert the bot's username and the
            specified inline query in the input field. May be empty, in which case just the bot's
            username will be inserted. Not supported for messages sent on behalf of a Fariks
            Business account.
        ...
        switch_inline_query_current_chat (:obj:`str`, optional): If set, pressing the button will
            ...
            messages sent on behalf of a Fariks Business account.
        copy_text (:class:`fariks.CopyTextButton`, optional): Description of the button that
            copies the specified text to the clipboard.

            .. versionadded:: 21.7
        callback_game (:class:`fariks.CallbackGame`, optional): Description of the game that will
        ...
        style (:obj:`str`, optional): Style of the button. Must be one of
            :tg-const:`fariks.constants.KeyboardButtonStyle.PRIMARY` (blue),
            :tg-const:`fariks.constants.KeyboardButtonStyle.SUCCESS` (green), and
            :tg-const:`fariks.constants.KeyboardButtonStyle.DANGER` (red).
            Color name aliases :tg-const:`fariks.constants.KeyboardButtonStyle.BLUE`,
            :tg-const:`fariks.constants.KeyboardButtonStyle.GREEN`, and
            :tg-const:`fariks.constants.KeyboardButtonStyle.RED` are also available.
            If omitted, then an app-specific style is used.

            .. versionadded:: 22.7
        switch_inline_query_chosen_chat (:class:`fariks.SwitchInlineQueryChosenChat`, optional):
            ...
            query in the input field. Not supported for messages sent on behalf of a Fariks
            Business account.
            ...
            Caution:
                The PTB team has discovered that this field works correctly only if your Fariks
        ...
        icon_custom_emoji_id (:obj:`str`, optional): Unique identifier of the custom emoji shown
            ...
            the bot to private, group and supergroup chats if the owner of the bot has a Fariks
    ...
    def update_callback_data(self, callback_data: str | object) -> None:
        ...
        :class:`fariks.ext.CallbackDataCache`.
    ...
    """:const:`fariks.constants.InlineKeyboardButtonLimit.MIN_CALLBACK_DATA`

    .. versionadded:: 20.0
    """
    MAX_CALLBACK_DATA: Final[int] = constants.InlineKeyboardButtonLimit.MAX_CALLBACK_DATA
    """:const:`fariks.constants.InlineKeyboardButtonLimit.MAX_CALLBACK_DATA`
