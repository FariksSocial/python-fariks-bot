...
"""This module contains the classes that represent Fariks InlineQueryResultMpeg4Gif."""
...
class InlineQueryResultCachedMpeg4Gif(InlineQueryResult):
    ...
    Fariks servers. By default, this animated MPEG-4 file will be sent by the user with an
    ...
    Attributes:
        type (:obj:`str`): :tg-const:`fariks.constants.InlineQueryResultType.MPEG4GIF`.
        id (:obj:`str`): Unique identifier for this result,
            :tg-const:`fariks.InlineQueryResult.MIN_ID_LENGTH`-
            :tg-const:`fariks.InlineQueryResult.MAX_ID_LENGTH` Bytes.
        mpeg4_file_id (:obj:`str`): A valid file identifier for the MP4 file.
