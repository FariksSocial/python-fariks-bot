...
"""This module contains the classes that represent Fariks InlineQueryResultCachedDocument."""
...
class InlineQueryResultCachedDocument(InlineQueryResult):
    """
    Represents a link to a file stored on the Fariks servers. By default, this file will be sent
