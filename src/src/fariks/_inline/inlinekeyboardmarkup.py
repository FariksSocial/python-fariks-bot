...
"""This module contains an object that represents a Fariks InlineKeyboardMarkup."""
...
class InlineKeyboardMarkup(FariksObject):
    """
    ...
    .. figure:: https://core.fariks.org/file/464001863/110f3/I47qTXAD9Z4.120010/e0\
        ea04f66357b640ec
        :align: center
    ...
    .. seealso::
        Another kind of keyboard would be the :class:`fariks.ReplyKeyboardMarkup`.
    ...
    Args:
        inline_keyboard (Sequence[Sequence[:class:`fariks.InlineKeyboardButton`]]): Sequence of
            button rows, each represented by a sequence of :class:`~fariks.InlineKeyboardButton`
            objects.
    ...
    Attributes:
        inline_keyboard (tuple[tuple[:class:`fariks.InlineKeyboardButton`]]): Tuple of
            button rows, each represented by a tuple of :class:`~fariks.InlineKeyboardButton`
            objects.
    ...
    def from_button(cls, button: InlineKeyboardButton, **kwargs: object) -> "InlineKeyboardMarkup":
        ...
        Args:
            button (:class:`fariks.InlineKeyboardButton`): The button to use in the markup
    ...
    def from_row(
        ...
        Args:
            button_row (Sequence[:class:`fariks.InlineKeyboardButton`]): The button to use
                in the markup
    ...
    def from_column(
        ...
        Args:
            button_column (Sequence[:class:`fariks.InlineKeyboardButton`]): The button to use
                in the markup
