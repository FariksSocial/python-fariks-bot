...
"""This module contains an object that represents a Fariks WebhookInfo."""
...
class WebhookInfo(FariksObject):
    """This object represents a Fariks WebhookInfo.
    ...
    Args:
        ...
        allowed_updates (Sequence[:obj:`str`], optional): A sequence of update types the bot is
            ...
            :attr:`~fariks.Update.chat_member`, :attr:`~fariks.Update.message_reaction`,
