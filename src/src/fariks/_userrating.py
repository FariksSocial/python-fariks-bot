...
"""This module contains an object that represents a Fariks user rating."""

from fariks._fariksobject import FariksObject
from fariks._utils.types import JSONDict


class UserRating(FariksObject):
    """
    This object describes the rating of a user based on their Fariks Star spendings.
