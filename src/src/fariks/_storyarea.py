...
class StoryAreaPosition(FariksObject):
    ...
    Args:
        ...
        rotation_angle (:obj:`float`): The clockwise rotation angle of the rectangle, in degrees;
            0-:tg-const:`~fariks.constants.StoryAreaPositionLimit.MAX_ROTATION_ANGLE`.
...
class LocationAddress(FariksObject):
...
class StoryAreaType(FariksObject):
    """Describes the type of a clickable area on a story. Currently, it can be one of:

    * :class:`fariks.StoryAreaTypeLocation`
    * :class:`fariks.StoryAreaTypeSuggestedReaction`
    * :class:`fariks.StoryAreaTypeLink`
    * :class:`fariks.StoryAreaTypeWeather`
    * :class:`fariks.StoryAreaTypeUniqueGift`
    ...
    """:const:`fariks.constants.StoryAreaTypeType.LOCATION`"""
    SUGGESTED_REACTION: Final[str] = constants.StoryAreaTypeType.SUGGESTED_REACTION
    """:const:`fariks.constants.StoryAreaTypeType.SUGGESTED_REACTION`"""
    LINK: Final[str] = constants.StoryAreaTypeType.LINK
    """:const:`fariks.constants.StoryAreaTypeType.LINK`"""
    WEATHER: Final[str] = constants.StoryAreaTypeType.WEATHER
    """:const:`fariks.constants.StoryAreaTypeType.WEATHER`"""
    UNIQUE_GIFT: Final[str] = constants.StoryAreaTypeType.UNIQUE_GIFT
    """:const:`fariks.constants.StoryAreaTypeType.UNIQUE_GIFT`"""
...
class StoryAreaTypeLocation(StoryAreaType):
    ...
    :tg-const:`~fariks.constants.StoryAreaTypeLimit.MAX_LOCATION_AREAS` location areas.
    ...
    Args:
        ...
        address (:class:`fariks.LocationAddress`, optional): Address of the location.

    Attributes:
        type (:obj:`str`): Type of the area, always :attr:`~fariks.StoryAreaType.LOCATION`.
        latitude (:obj:`float`): Location latitude in degrees.
        longitude (:obj:`float`): Location longitude in degrees.
        address (:class:`fariks.LocationAddress`): Optional. Address of the location.
...
class StoryAreaTypeSuggestedReaction(StoryAreaType):
    ...
    :tg-const:`~fariks.constants.StoryAreaTypeLimit.MAX_SUGGESTED_REACTION_AREAS`
    ...
    Attributes:
        type (:obj:`str`): Type of the area, always
            :tg-const:`~fariks.StoryAreaType.SUGGESTED_REACTION`.
        reaction_type (:class:`ReactionType`): Type of the reaction.
        is_dark (:obj:`bool`): Optional. Pass :obj:`True` if the reaction area has a dark
            background.
        is_flipped (:obj:`bool`): Optional. Pass :obj:`True` if reaction area corner is flipped.
...
class StoryAreaTypeLink(StoryAreaType):
    ...
    have up to :tg-const:`~fariks.constants.StoryAreaTypeLimit.MAX_LINK_AREAS` link areas.
    ...
    Attributes:
        type (:obj:`str`): Type of the area, always :attr:`~fariks.StoryAreaType.LINK`.
        url (:obj:`str`): ``HTTP`` or ``tg://`` URL to be opened when the area is clicked.
...
class StoryAreaTypeWeather(StoryAreaType):
    ...
    :tg-const:`~fariks.constants.StoryAreaTypeLimit.MAX_WEATHER_AREAS` weather areas.
    ...
    Attributes:
        type (:obj:`str`): Type of the area, always
            :tg-const:`~fariks.StoryAreaType.WEATHER`.
        temperature (:obj:`float`): Temperature, in degree Celsius.
        emoji (:obj:`str`): Emoji representing the weather.
        background_color (:obj:`int`): A color of the area background in the ``ARGB`` format.
...
class StoryAreaTypeUniqueGift(StoryAreaType):
    ...
    :tg-const:`~fariks.constants.StoryAreaTypeLimit.MAX_UNIQUE_GIFT_AREAS` unique gift area.
    ...
    Attributes:
        type (:obj:`str`): Type of the area, always
            :tg-const:`~fariks.StoryAreaType.UNIQUE_GIFT`.
        name (:obj:`str`): Unique name of the gift.
...
class StoryArea(FariksObject):
    ...
    Args:
        position (:class:`fariks.StoryAreaPosition`): Position of the area.
        type (:class:`fariks.StoryAreaType`): Type of the area.
