...
"""This module contains an object that represents a Fariks Poll."""
...
from fariks._utils.argumentparsing import (
    de_json_optional,
    de_list_optional,
    parse_sequence_arg,
    to_timedelta,
)
from fariks._utils.datetime import (
...
if TYPE_CHECKING:
    from fariks import Bot, InputPollOptionMedia, MaybeInaccessibleMessage


class PollMedia(FariksObject):
    """
    ...
    Args:
        animation (:class:`fariks.Animation`, optional): Media is an animation, information about
            the animation
        audio (:class:`fariks.Audio`, optional): Media is an audio file, information about the
            file; currently, can't be received in a poll option
        document (:class:`fariks.Document`, optional): Media is a general file, information about
            the file; currently, can't be received in a poll option
        live_photo (:class:`fariks.LivePhoto`, optional): Media is a live photo, information
            about the live photo
        location (:class:`fariks.Location`, optional): Media is a shared location, information
            about the location
        photo (Sequence[:class:`fariks.PhotoSize`], optional): Media is a photo, available sizes
            of the photo
        sticker (:class:`fariks.Sticker`, optional): Media is a sticker, information about the
            sticker; currently, for poll options only
        venue (:class:`fariks.Venue`, optional): Media is a venue, information about the venue
        video (:class:`fariks.Video`, optional): Media is a video, information about the video
    ...
    Attributes:
        ...
        location (:class:`fariks.Location`): Optional. Media is a shared location, information
            about the location
        photo (tuple[:class:`fariks.PhotoSize`]): Optional. Media is a photo, available sizes
            of the photo
        sticker (:class:`fariks.Sticker`): Optional. Media is a sticker, information about the
            sticker; currently, for poll options only
        venue (:class:`fariks.Venue`): Optional. Media is a venue, information about the venue
...
class InputPollOption(FariksObject):
    """
    ...
    Args:
        text (:obj:`str`): Option text,
            :tg-const:`fariks.PollOption.MIN_LENGTH`-:tg-const:`fariks.PollOption.MAX_LENGTH`
            characters.
        text_parse_mode (:obj:`str`, optional): |parse_mode|
            Currently, only custom emoji entities are allowed.
        text_entities (Sequence[:class:`fariks.MessageEntity`], optional): Special entities
        ...
        media (:class:`fariks.InputPollOptionMedia`, optional): Media added to the poll option.
    ...
    Attributes:
        ...
        text_parse_mode (:obj:`str`): Optional. |parse_mode|
            Currently, only custom emoji entities are allowed.
        text_entities (Sequence[:class:`fariks.MessageEntity`]): Special entities
            that appear in the option :paramref:`text`. It can be specified instead of
            :paramref:`text_parse_mode`.
            Currently, only custom emoji entities are allowed.
            This list is empty if the text does not contain entities.
    ...
    def de_json(cls, data: JSONDict, bot: "Bot | None" = None) -> "InputPollOption":
        """See :meth:`fariks.FariksObject.de_json`. The :paramref:`media` field will
...
class PollOption(FariksObject):
    ...
    Args:
        ...
        text_entities (Sequence[:class:`fariks.MessageEntity`], optional): Special entities
            ...
            .. versionadded:: 21.2
        media (:class:`fariks.PollMedia`, optional): Media added to the poll option.

            .. versionadded:: 22.8
        added_by_user (:class:`fariks.User`, optional): User who added the option;
            omitted if the option wasn't added by a user after poll creation.

            .. versionadded:: 22.8
        added_by_chat (:class:`fariks.Chat`, optional): Chat that added the option;
    ...
    Attributes:
        ...
        text (:obj:`str`): Option text,
            ...
            characters.
        voter_count (:obj:`int`): Number of users that voted for this option.
        text_entities (tuple[:class:`fariks.MessageEntity`]): Special entities
            that appear in the option text. Currently, only custom emoji entities are allowed in
            poll option texts.
    ...
    def parse_entity(self, entity: MessageEntity) -> str:
        ...
        from a given :class:`fariks.MessageEntity` of :attr:`text_entities`.
    ...
    def parse_entities(self, types: list[str] | None = None) -> dict[MessageEntity, str]:
        ...
        Args:
            types (list[:obj:`str`], optional): List of ``MessageEntity`` types as strings. If the
                    ...
                    Defaults to :attr:`fariks.MessageEntity.ALL_TYPES`.
    ...
    """:const:`fariks.constants.PollLimit.MIN_OPTION_LENGTH`

    .. versionadded:: 20.0
    """
    MAX_LENGTH: Final[int] = constants.PollLimit.MAX_OPTION_LENGTH
    """:const:`fariks.constants.PollLimit.MAX_OPTION_LENGTH`

    .. versionadded:: 20.0
    """


class PollAnswer(FariksObject):
    """
    ...
    Args:
        ...
        option_persistent_ids (Sequence[:obj:`str`]): Persistent identifiers of the
            ...
            .. versionadded:: 22.8
        user (:class:`fariks.User`, optional): The user that changed the answer to the poll,
            if the voter isn't anonymous. If the voter is anonymous, this field will contain the
            user :tg-const:`fariks.constants.ChatID.FAKE_CHANNEL` for backwards compatibility.

            .. versionchanged:: 20.5
                :paramref:`user` became optional.
        voter_chat (:class:`fariks.Chat`, optional): The chat that changed the answer to the
    ...
    Attributes:
        ...
        option_persistent_ids (tuple[:obj:`str`]): Persistent identifiers of the
            ...
            .. versionadded:: 22.8
        user (:class:`fariks.User`): Optional. The user, who changed the answer to the
            poll, if the voter isn't anonymous. If the voter is anonymous, this field will contain
            the user :tg-const:`fariks.constants.ChatID.FAKE_CHANNEL` for backwards compatibility
...
class PollOptionAdded(FariksObject):
    """
    ...
    Args:
        ...
        poll_message (:class:`fariks.MaybeInaccessibleMessage`, optional): Message
            ...
            :attr:`~fariks.Message.reply_to_message` field even if it itself is a reply.
        option_text_entities (Sequence[:class:`fariks.MessageEntity`], optional): Special
    ...
    Attributes:
        ...
        poll_message (:class:`fariks.MaybeInaccessibleMessage`): Optional. Message
            ...
            Note that the Message object in this field will not contain the
            :attr:`~fariks.Message.reply_to_message` field even if it itself is a reply.
        option_text_entities (tuple[:class:`fariks.MessageEntity`]): Optional. Special
            entities that appear in the :paramref:`option_text`.
    """
    ...
    def de_json(cls, data: JSONDict, bot: "Bot | None" = None) -> "PollOptionAdded":
        """See :meth:`fariks.FariksObject.de_json`."""
        from fariks._message import (  # pylint: disable=import-outside-toplevel  # noqa: PLC0415
    ...
    def parse_option_text_entity(self, entity: MessageEntity) -> str:
        ...
        from a given :class:`fariks.MessageEntity` of :attr:`option_text_entities`.
...
class PollOptionDeleted(FariksObject):
    """
...
class Poll(FariksObject):
    ...
    Args:
        ...
        options (Sequence[:class:`~fariks.PollOption`]): List of poll options.
        ...
        members_only (:obj:`bool`): :obj:`True`, if voting is limited to users who have been
            ...
            :tg-const:`fariks.Poll.MIN_MEMBERSHIP_HOURS` hours.
        ...
        explanation (:obj:`str`, optional): Text that is shown when a user chooses an incorrect
            ...
            0-:tg-const:`fariks.Poll.MAX_EXPLANATION_LENGTH` characters.
        explanation_entities (Sequence[:class:`fariks.MessageEntity`], optional): Special
            ...
            .. versionchanged:: 20.0
               ...
               * |sequenceclassargs|
        explanation_media (:class:`fariks.PollMedia`, optional): Media added to the quiz
            explanation.
        ...
        question_entities (Sequence[:class:`fariks.MessageEntity`], optional): Special entities
        ...
        description (:obj:`str`, optional): Description of the poll;
            for polls inside the :class:`~fariks.Message` object only.

            .. versionadded:: 22.8
        description_entities (Sequence[:class:`fariks.MessageEntity`], optional): Special
            entities like usernames, URLs, bot commands, etc. that appear in the description

            .. versionadded:: 22.8
        media (:class:`fariks.PollMedia`, optional): Media added to the poll description;
            for polls inside the :class:`~fariks.Message` object only.
    ...
    Attributes:
        ...
        question (:obj:`str`): Poll question, :tg-const:`fariks.Poll.MIN_QUESTION_LENGTH`-
            :tg-const:`fariks.Poll.MAX_QUESTION_LENGTH` characters.
        options (tuple[:class:`~fariks.PollOption`]): List of poll options.
        ...
        explanation (:obj:`str`): Optional. Text that is shown when a user chooses an incorrect
            answer or taps on the lamp icon in a quiz-style poll,
            0-:tg-const:`fariks.Poll.MAX_EXPLANATION_LENGTH` characters.
        explanation_entities (tuple[:class:`fariks.MessageEntity`]): Special entities
        ...
        close_date (:obj:`datetime.datetime`): Optional. Point in time when the poll will be
            ...
            .. versionchanged:: 20.3
                |datetime_localization|
        question_entities (tuple[:class:`fariks.MessageEntity`]): Special entities
            that appear in the :attr:`question`. Currently, only custom emoji entities are allowed
            in poll questions.
            This list is empty if the question does not contain entities.
        ...
        description (:obj:`str`): Optional. Description of the poll;
            ...
            .. versionadded:: 22.8
        description_entities (tuple[:class:`fariks.MessageEntity`]): Special
            entities like usernames, URLs, bot commands, etc. that appear in the description
    ...
    def parse_explanation_entity(self, entity: MessageEntity) -> str:
        """Returns the text in :attr:`explanation` from a given :class:`fariks.MessageEntity` of
    ...
    def parse_question_entity(self, entity: MessageEntity) -> str:
        """Returns the text in :attr:`question` from a given :class:`fariks.MessageEntity` of
    ...
    def parse_description_entity(self, entity: MessageEntity) -> str:
        """Returns the text in :attr:`description` from a given :class:`fariks.MessageEntity` of
    ...
    def parse_description_entities(
        ...
        Args:
            types (list[:obj:`str`], optional): List of ``MessageEntity`` types as strings. If the
                    ...
                    Defaults to :attr:`fariks.MessageEntity.ALL_TYPES`.
        Returns:
            dict[:class:`fariks.MessageEntity`, :obj:`str`]: A dictionary of entities
