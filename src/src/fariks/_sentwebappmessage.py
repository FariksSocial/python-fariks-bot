...
"""This module contains an object that represents a Fariks Sent Web App Message."""

from fariks._fariksobject import FariksObject
from fariks._utils.types import JSONDict


class SentWebAppMessage(FariksObject):
    ...
    Args:
        inline_message_id (:obj:`str`, optional): Identifier of the sent inline message. Available
            only if there is an :attr:`inline keyboard <fariks.InlineKeyboardMarkup>` attached to
            the message.
