...
"""This module contains an object that represents a Fariks Bot Access Settings."""
...
class BotAccessSettings(FariksObject):
    """
    ...
    Args:
        ...
        added_users (Sequence[:class:`fariks.User`], optional): The list of other users who
