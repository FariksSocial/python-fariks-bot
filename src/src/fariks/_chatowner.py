...
class ChatOwnerChanged(FariksObject):
    ...
    Args:
        new_owner (:class:`fariks.User`): The new owner of the chat
...
class ChatOwnerLeft(FariksObject):
    ...
    Args:
        new_owner (:class:`fariks.User`, optional): The user who will become the new owner of the
