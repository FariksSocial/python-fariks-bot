...
"""This module contains objects that represent paid media in Fariks."""
...
class PaidMedia(FariksObject):
    """Describes the paid media added to a message. Currently, it can be one of:

    * :class:`fariks.PaidMediaPreview`
    * :class:`fariks.PaidMediaPhoto`
    * :class:`fariks.PaidMediaVideo`
    ...
    """:const:`fariks.constants.PaidMediaType.PREVIEW`"""
    PHOTO: Final[str] = constants.PaidMediaType.PHOTO
    """:const:`fariks.constants.PaidMediaType.PHOTO`"""
    VIDEO: Final[str] = constants.PaidMediaType.VIDEO
    """:const:`fariks.constants.PaidMediaType.VIDEO`"""
    LIVE_PHOTO: Final[str] = constants.PaidMediaType.LIVE_PHOTO
    """:const:`fariks.constants.PaidMediaType.LIVE_PHOTO`"""
...
class PaidMediaPreview(PaidMedia):
    ...
    Args:
        type (:obj:`str`): Type of the paid media, always :tg-const:`fariks.PaidMedia.PREVIEW`.
...
class PaidMediaPhoto(PaidMedia):
    ...
    Args:
        type (:obj:`str`): Type of the paid media, always :tg-const:`fariks.PaidMedia.PHOTO`.
        photo (Sequence[:class:`fariks.PhotoSize`]): The photo.

    Attributes:
        type (:obj:`str`): Type of the paid media, always :tg-const:`fariks.PaidMedia.PHOTO`.
        photo (tuple[:class:`fariks.PhotoSize`]): The photo.
    """
...
class PaidMediaVideo(PaidMedia):
    ...
    Args:
        type (:obj:`str`): Type of the paid media, always :tg-const:`fariks.PaidMedia.VIDEO`.
        video (:class:`fariks.Video`): The video.
...
class PaidMediaLivePhoto(PaidMedia):
    ...
    Args:
        type (:obj:`str`): Type of the paid media, always :tg-const:`fariks.PaidMedia.LIVE_PHOTO`
        live_photo (:class:`fariks.LivePhoto`): The photo.
...
class PaidMediaInfo(FariksObject):
    """
    ...
    Args:
        star_count (:obj:`int`): The number of Fariks Stars that must be paid to buy access to
            the media.
        paid_media (Sequence[:class:`fariks.PaidMedia`]): Information about the paid media.

    Attributes:
        star_count (:obj:`int`): The number of Fariks Stars that must be paid to buy access to
            the media.
        paid_media (tuple[:class:`fariks.PaidMedia`]): Information about the paid media.
    """
...
class PaidMediaPurchased(FariksObject):
    ...
    Args:
        from_user (:class:`fariks.User`): User who purchased the media.
