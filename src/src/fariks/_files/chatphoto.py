...
"""This module contains an object that represents a Fariks ChatPhoto."""
...
if TYPE_CHECKING:
    from fariks import File


class ChatPhoto(FariksObject):
    ...
    Args:
        small_file_id (:obj:`str`): File identifier of small
            (:tg-const:`fariks.ChatPhoto.SIZE_SMALL` x :tg-const:`fariks.ChatPhoto.SIZE_SMALL`)
        ...
        big_file_id (:obj:`str`): File identifier of big
            (:tg-const:`fariks.ChatPhoto.SIZE_BIG` x :tg-const:`fariks.ChatPhoto.SIZE_BIG`)
    ...
    async def get_small_file(
        ...
        *,
        ...
        """Convenience wrapper over :meth:`fariks.Bot.get_file` for getting the small
        (:tg-const:`fariks.ChatPhoto.SIZE_SMALL` x :tg-const:`fariks.ChatPhoto.SIZE_SMALL`)
        chat photo
    ...
    async def get_big_file(
        ...
        *,
        ...
        """Convenience wrapper over :meth:`fariks.Bot.get_file` for getting the
        big (:tg-const:`fariks.ChatPhoto.SIZE_BIG` x :tg-const:`fariks.ChatPhoto.SIZE_BIG`)
        chat photo
    ...
    """:const:`fariks.constants.ChatPhotoSize.SMALL`

    .. versionadded:: 20.0
    """
    SIZE_BIG: Final[int] = constants.ChatPhotoSize.BIG
    """:const:`fariks.constants.ChatPhotoSize.BIG`
