...
"""This module contains an object that represents a Fariks Audio."""
...
class Audio(_BaseThumbedMedium):
    """This object represents an audio file to be treated as music by the Fariks clients.
    ...
    Args:
        ...
        thumbnail (:class:`fariks.PhotoSize`, optional): Thumbnail of the album cover to
