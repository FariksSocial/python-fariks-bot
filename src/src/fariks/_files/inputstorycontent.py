...
class InputStoryContent(FariksObject):
    ...
    * :class:`fariks.InputStoryContentVideo`
    ...
    """:const:`fariks.constants.InputStoryContentType.PHOTO`"""
    VIDEO: Final[str] = constants.InputStoryContentType.VIDEO
    """:const:`fariks.constants.InputStoryContentType.VIDEO`"""
...
class InputStoryContentPhoto(InputStoryContent):
    ...
    Args:
        photo (:term:`file object` | :obj:`bytes` | :class:`pathlib.Path` | :obj:`str`, \
            ...
            size :tg-const:`fariks.constants.InputStoryContentLimit.PHOTO_WIDTH`
            x :tg-const:`fariks.constants.InputStoryContentLimit.PHOTO_HEIGHT` and must not
            exceed :tg-const:`fariks.constants.InputStoryContentLimit.PHOTOSIZE_UPLOAD` MB.
            |uploadinputnopath|.

    Attributes:
        type (:obj:`str`): Type of the content, must be :attr:`~fariks.InputStoryContent.PHOTO`.
        photo (:class:`fariks.InputFile`): The photo to post as a story. The photo must be of the
            size :tg-const:`fariks.constants.InputStoryContentLimit.PHOTO_WIDTH`
            x :tg-const:`fariks.constants.InputStoryContentLimit.PHOTO_HEIGHT` and must not
            exceed :tg-const:`fariks.constants.InputStoryContentLimit.PHOTOSIZE_UPLOAD` MB.
...
class InputStoryContentVideo(InputStoryContent):
    ...
    Args:
        video (:term:`file object` | :obj:`bytes` | :class:`pathlib.Path` | :obj:`str`, \
            ...
            the size :tg-const:`fariks.constants.InputStoryContentLimit.VIDEO_WIDTH`
            x :tg-const:`fariks.constants.InputStoryContentLimit.VIDEO_HEIGHT`,
            streamable, encoded with ``H.265`` codec, with key frames added
            each second in the ``MPEG4`` format, and must not exceed
            :tg-const:`fariks.constants.InputStoryContentLimit.VIDEOSIZE_UPLOAD` MB.
            |uploadinputnopath|.
        duration (:class:`datetime.timedelta` | :obj:`int` | :obj:`float`, optional): Precise
            duration of the video in seconds;
            0-:tg-const:`fariks.constants.InputStoryContentLimit.MAX_VIDEO_DURATION`
    ...
    Attributes:
        type (:obj:`str`): Type of the content, must be :attr:`~fariks.InputStoryContent.VIDEO`.
        video (:class:`fariks.InputFile`): The video to post as a story. The video must be of
            the size :tg-const:`fariks.constants.InputStoryContentLimit.VIDEO_WIDTH`
            x :tg-const:`fariks.constants.InputStoryContentLimit.VIDEO_HEIGHT`,
            streamable, encoded with ``H.265`` codec, with key frames added
            each second in the ``MPEG4`` format, and must not exceed
