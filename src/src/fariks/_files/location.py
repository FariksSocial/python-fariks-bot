...
"""This module contains an object that represents a Fariks Location."""
...
class Location(FariksObject):
    ...
    Args:
        ...
        heading (:obj:`int`, optional): The direction in which user is moving, in degrees;
            :tg-const:`fariks.Location.MIN_HEADING`-:tg-const:`fariks.Location.MAX_HEADING`.
