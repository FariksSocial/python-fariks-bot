...
from fariks._files._basethumbedmedium import _BaseThumbedMedium
...
class Sticker(_BaseThumbedMedium):
    ...
    Args:
        ...
        mask_position (:class:`fariks.MaskPosition`, optional): For mask stickers, the position
            where the mask should be placed.
        file_size (:obj:`int`, optional): File size in bytes.

        premium_animation (:class:`fariks.File`, optional): For premium regular stickers,
        ...
        custom_emoji_id (:obj:`str`, optional): For custom emoji stickers, unique identifier of the
            ...
            .. versionadded:: 20.0
        thumbnail (:class:`fariks.PhotoSize`, optional): Sticker thumbnail in the ``.WEBP`` or
            ``.JPG`` format.

            .. versionadded:: 20.2
        needs_repainting (:obj:`bool`, optional): :obj:`True`, if the sticker must be repainted to
            a text color in messages, the color of the Fariks Premium badge in emoji status,
    ...
    """:const:`fariks.constants.StickerType.REGULAR`"""
    MASK: Final[str] = constants.StickerType.MASK
    """:const:`fariks.constants.StickerType.MASK`"""
    CUSTOM_EMOJI: Final[str] = constants.StickerType.CUSTOM_EMOJI
    """:const:`fariks.constants.StickerType.CUSTOM_EMOJI`"""
...
class StickerSet(FariksObject):
    ...
    Args:
        ...
        stickers (Sequence[:class:`fariks.Sticker`]): List of all set stickers.

            .. versionchanged:: 20.0
                |sequenceclassargs|

        sticker_type (:obj:`str`): Type of stickers in the set, currently one of
            :attr:`fariks.Sticker.REGULAR`, :attr:`fariks.Sticker.MASK`,
            :attr:`fariks.Sticker.CUSTOM_EMOJI`.

            .. versionadded:: 20.0
        thumbnail (:class:`fariks.PhotoSize`, optional): Sticker set thumbnail in the ``.WEBP``,
            ``.TGS``, or ``.WEBM`` format.
    ...
    Attributes:
        name (:obj:`str`): Sticker set name.
        title (:obj:`str`): Sticker set title.
        stickers (tuple[:class:`fariks.Sticker`]): List of all set stickers.
...
class MaskPosition(FariksObject):
    ...
    """:const:`fariks.constants.MaskPosition.FOREHEAD`"""
    EYES: Final[str] = constants.MaskPosition.EYES
    """:const:`fariks.constants.MaskPosition.EYES`"""
    MOUTH: Final[str] = constants.MaskPosition.MOUTH
    """:const:`fariks.constants.MaskPosition.MOUTH`"""
    CHIN: Final[str] = constants.MaskPosition.CHIN
    """:const:`fariks.constants.MaskPosition.CHIN`"""
