...
class InputProfilePhoto(FariksObject):
    ...
    * :class:`InputProfilePhotoAnimated`
    ...
    """:obj:`str`: :tg-const:`fariks.constants.InputProfilePhotoType.STATIC`."""
    ANIMATED = constants.InputProfilePhotoType.ANIMATED
    """:obj:`str`: :tg-const:`fariks.constants.InputProfilePhotoType.ANIMATED`."""
...
class InputProfilePhotoStatic(InputProfilePhoto):
    ...
    Args:
        photo (:term:`file object` | :class:`~fariks.InputFile` | :obj:`bytes` | \
            :class:`pathlib.Path`): The static profile photo. |uploadinputnopath|

    Attributes:
        type (:obj:`str`): :tg-const:`fariks.constants.InputProfilePhotoType.STATIC`.
        photo (:class:`fariks.InputFile` | :obj:`str`): The static profile photo.
...
class InputProfilePhotoAnimated(InputProfilePhoto):
    ...
    Args:
        animation (:term:`file object` | :class:`~fariks.InputFile` | :obj:`bytes` | \
    ...
    Attributes:
        type (:obj:`str`): :tg-const:`fariks.constants.InputProfilePhotoType.ANIMATED`.
        animation (:class:`fariks.InputFile` | :obj:`str`): The animated profile photo.
