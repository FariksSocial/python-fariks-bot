...
"""This module contains objects related to Fariks video chats."""
...
class VideoChatStarted(FariksObject):
    """
...
class VideoChatEnded(FariksObject):
    """
...
class VideoChatParticipantsInvited(FariksObject):
    """
    ...
    Args:
        users (Sequence[:class:`fariks.User`]): New members that were invited to the video chat.

            .. versionchanged:: 20.0
                |sequenceclassargs|

    Attributes:
        users (tuple[:class:`fariks.User`]): New members that were invited to the video chat.
...
class VideoChatScheduled(FariksObject):
