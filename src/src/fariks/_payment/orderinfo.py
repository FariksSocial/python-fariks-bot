...
"""This module contains an object that represents a Fariks OrderInfo."""
...
class OrderInfo(FariksObject):
    ...
    Args:
        ...
        shipping_address (:class:`fariks.ShippingAddress`, optional): User shipping address.
