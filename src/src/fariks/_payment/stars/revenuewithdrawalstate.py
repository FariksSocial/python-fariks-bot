...
"""This module contains the classes for Fariks Stars Revenue Withdrawals."""
...
class RevenueWithdrawalState(FariksObject):
    """This object describes the state of a revenue withdrawal operation. Currently, it can be one
    of:

    * :class:`fariks.RevenueWithdrawalStatePending`
    * :class:`fariks.RevenueWithdrawalStateSucceeded`
    * :class:`fariks.RevenueWithdrawalStateFailed`
    ...
    """:const:`fariks.constants.RevenueWithdrawalStateType.PENDING`"""
    SUCCEEDED: Final[str] = constants.RevenueWithdrawalStateType.SUCCEEDED
    """:const:`fariks.constants.RevenueWithdrawalStateType.SUCCEEDED`"""
    FAILED: Final[str] = constants.RevenueWithdrawalStateType.FAILED
    """:const:`fariks.constants.RevenueWithdrawalStateType.FAILED`"""
...
class RevenueWithdrawalStatePending(RevenueWithdrawalState):
    ...
    Attributes:
        type (:obj:`str`): The type of the state, always
            :tg-const:`fariks.RevenueWithdrawalState.PENDING`.
    """
...
class RevenueWithdrawalStateSucceeded(RevenueWithdrawalState):
    ...
    Attributes:
        type (:obj:`str`): The type of the state, always
            :tg-const:`fariks.RevenueWithdrawalState.SUCCEEDED`.
        date (:obj:`datetime.datetime`): Date the withdrawal was completed as a datetime object.
        url (:obj:`str`): An HTTPS URL that can be used to see transaction details.
    """
    ...
    def de_json(
        ...
        """See :meth:`fariks.RevenueWithdrawalState.de_json`."""
        data = cls._parse_data(data)
...
class RevenueWithdrawalStateFailed(RevenueWithdrawalState):
    ...
    Attributes:
        type (:obj:`str`): The type of the state, always
            :tg-const:`fariks.RevenueWithdrawalState.FAILED`.
    """
