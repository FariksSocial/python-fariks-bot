...
"""This module contains an object that represents a Fariks SuccessfulPayment."""

import datetime as dtm
from typing import TYPE_CHECKING

from fariks._payment.orderinfo import OrderInfo
...
class SuccessfulPayment(FariksObject):
    ...
    Args:
        ...
        shipping_option_id (:obj:`str`, optional): Identifier of the shipping option chosen by the
            user.
        order_info (:class:`fariks.OrderInfo`, optional): Order info provided by the user.
