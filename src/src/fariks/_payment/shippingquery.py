...
"""This module contains an object that represents a Fariks ShippingQuery."""

from collections.abc import Sequence
from typing import TYPE_CHECKING

from fariks._payment.shippingaddress import ShippingAddress
...
if TYPE_CHECKING:
    ...
    from fariks._payment.shippingoption import ShippingOption


class ShippingQuery(FariksObject):
    ...
    Args:
        ...
        shipping_address (:class:`fariks.ShippingAddress`): User specified shipping address.
