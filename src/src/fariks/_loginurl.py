...
"""This module contains an object that represents a Fariks LoginUrl."""

from fariks._fariksobject import FariksObject
from fariks._utils.types import JSONDict


class LoginUrl(FariksObject):
    """This object represents a parameter of the inline keyboard button used to automatically
    authorize a user. Serves as a great replacement for the Fariks Login Widget when the user is
    coming from Fariks. All the user needs to do is tap/click a button and confirm that they want
    to log in. Fariks apps support these buttons as of version 5.7.
    ...
    Note:
        ...
        `Checking authorization <https://core.fariks.org/widgets/login#checking-authorization>`_
    ...
    Args:
        url (:obj:`str`): An HTTPS URL to be opened with user authorization data added to the query
            ...
            <https://core.fariks.org/widgets/login#receiving-authorization-data>`_.
        ...
        bot_username (:obj:`str`, optional): Username of a bot, which will be used for user
            authorization. See
            `Setting up a bot <https://core.fariks.org/widgets/login#setting-up-a-bot>`_
            ...
            <https://core.fariks.org/widgets/login#linking-your-domain-to-the-bot>`_
            for more details.
