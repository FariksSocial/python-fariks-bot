...
"""This module contains an object that represents a Fariks Chat."""
...
from fariks._reaction import ReactionType
...
from fariks._utils.usernames import get_full_name, get_link
from fariks.helpers import escape_markdown
from fariks.helpers import mention_html as helpers_mention_html
from fariks.helpers import mention_markdown as helpers_mention_markdown
...
class _ChatBase(FariksObject):
    """Base class for :class:`fariks.Chat` and :class:`fariks.ChatFullInfo`.
    ...
    """:const:`fariks.constants.ChatType.SENDER`

    .. versionadded:: 13.5
    """
    PRIVATE: Final[str] = constants.ChatType.PRIVATE
    """:const:`fariks.constants.ChatType.PRIVATE`"""
    GROUP: Final[str] = constants.ChatType.GROUP
    """:const:`fariks.constants.ChatType.GROUP`"""
    SUPERGROUP: Final[str] = constants.ChatType.SUPERGROUP
    """:const:`fariks.constants.ChatType.SUPERGROUP`"""
    CHANNEL: Final[str] = constants.ChatType.CHANNEL
    """:const:`fariks.constants.ChatType.CHANNEL`"""
    ...
    def mention_markdown(self, name: str | None = None) -> str:
        ...
        Note:
            ...
            Fariks for backward compatibility. You should use :meth:`mention_markdown_v2`
            instead.
    ...
    async def leave(
        ...
        *,
        ...
        For the documentation of the arguments, please see :meth:`fariks.Bot.leave_chat`.
    ...
    async def get_administrators(
        ...
        *,
        ...
        Returns:
            tuple[:class:`fariks.ChatMember`]: A tuple of administrators in a chat. An Array of
            :class:`fariks.ChatMember` objects that contains information about all
    ...
    async def get_member(
        ...
        *,
        ...
        For the documentation of the arguments, please see :meth:`fariks.Bot.get_chat_member`.
    ...
    async def unban_member(
        ...
        *,
        ...
        For the documentation of the arguments, please see :meth:`fariks.Bot.unban_chat_member`.
    ...
    async def promote_member(
        ...
        *,
        ...
        .. versionchanged:: 20.0
           ...
           :paramref:`~fariks.Bot.promote_chat_member.can_manage_video_chats` in accordance to
           Bot API 6.0.
        .. versionchanged:: 20.6
    ...
    async def restrict_member(
        ...
        *,
        ...
        .. versionadded:: 20.1
            Added :paramref:`~fariks.Bot.restrict_chat_member.use_independent_chat_permissions`.
    ...
    async def set_permissions(
        ...
        *,
        ...
        .. versionadded:: 20.1
            Added :paramref:`~fariks.Bot.set_chat_permissions.use_independent_chat_permissions`.
    ...
    async def delete_message(
        ...
        *,
        ...
        For the documentation of the arguments, please see :meth:`fariks.Bot.delete_message`.
    ...
    async def delete_messages(
        ...
        *,
        ...
        For the documentation of the arguments, please see :meth:`fariks.Bot.delete_messages`.
    ...
    async def send_media_group(
        ...
        *,
        ...
        Returns:
            tuple[:class:`fariks.Message`]: On success, a tuple of :class:`~fariks.Message`
    ...
    async def send_copies(
        ...
        *,
        ...
        For the documentation of the arguments, please see :meth:`fariks.Bot.copy_messages`.
    ...
    async def forward_messages_from(
        ...
        *,
        ...
        For the documentation of the arguments, please see :meth:`fariks.Bot.forward_messages`.
    ...
    async def edit_invite_link(
        ...
        *,
        ...
        .. versionchanged:: 13.8
           Edited signature according to the changes of :meth:`fariks.Bot.edit_chat_invite_link`.
    ...
    async def create_subscription_invite_link(
        ...
        *,
        ...
        For the documentation of the arguments, please see
        :meth:`fariks.Bot.create_chat_subscription_invite_link`.
    ...
    async def edit_subscription_invite_link(
        ...
        *,
        ...
        For the documentation of the arguments, please see
        :meth:`fariks.Bot.edit_chat_subscription_invite_link`.
    ...
    async def get_user_chat_boosts(
        ...
        *,
        ...
        Returns:
            :class:`fariks.UserChatBoosts`: On success, returns the boosts applied in the chat.
        """
    ...
    async def send_gift(
        ...
        *,
        ...
        For the documentation of the arguments, please see :meth:`fariks.Bot.send_gift`.
    ...
    async def transfer_gift(
        ...
        *,
        ...
        For the documentation of the arguments, please see :meth:`fariks.Bot.transfer_gift`.
    ...
    async def repost_story(
        ...
        *,
        ...
        For the documentation of the arguments, please see :meth:`fariks.Bot.repost_story`.
    ...
    async def get_gifts(
        ...
        *,
        ...
        Returns:
            :class:`fariks.OwnedGifts`: On success, returns the gifts owned by the chat.
        """
...
class Chat(_ChatBase):
    ...
    .. versionchanged:: 20.0
        Removed the attribute ``all_members_are_administrators``. As long as Fariks provides
        this field for backwards compatibility, it is available through
        :attr:`~fariks.FariksObject.api_kwargs`.
    ...
    .. _topics: https://fariks.org/blog/topics-in-groups-collectible-usernames#topics-in-groups
    """
