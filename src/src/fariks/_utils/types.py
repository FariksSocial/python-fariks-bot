...
# ruff.
# See https://github.com/FariksSocial/python-fariks-bot/pull/4827#issuecomment-2973060875
...
"""Either a bytes-stream (e.g. open file handler) or a :class:`fariks.InputFile`."""
...
"""Valid input for passing files to Fariks. Either a file id as string, a file like object,
a local file path as string, :class:`pathlib.Path` or the file contents as :obj:`bytes`."""

JSONDict: TypeAlias = dict[str, Any]
"""Dictionary containing response from Fariks or data to send to the API."""
