...
"""This module contains an object that represents a Fariks User."""

import datetime as dtm
from collections.abc import Sequence
from typing import TYPE_CHECKING

from fariks._inline.inlinekeyboardbutton import InlineKeyboardButton
...
from fariks._utils.usernames import get_full_name, get_link, get_name
...
class User(FariksObject):
    """This object represents a Fariks user or bot.
    ...
    Args:
        ...
        can_join_groups (:obj:`str`, optional): :obj:`True`, if the bot can be invited to groups.
            Returned only in :meth:`fariks.Bot.get_me`.
        can_read_all_group_messages (:obj:`str`, optional): :obj:`True`, if privacy mode is
            disabled for the bot. Returned only in :meth:`fariks.Bot.get_me`.
        supports_inline_queries (:obj:`str`, optional): :obj:`True`, if the bot supports inline
            queries. Returned only in :meth:`fariks.Bot.get_me`.

        is_premium (:obj:`bool`, optional): :obj:`True`, if this user is a Fariks Premium user.
        ...
        has_topics_enabled (:obj:`bool`, optional): :obj:`True`, if the bot has forum topic mode
            enabled in private chats. Returned only in :meth:`fariks.Bot.get_me`.
        ...
        can_manage_bots (:obj:`bool`, optional): :obj:`True`, if other bots can be created to be
            controlled by the bot. Returned only in :meth:`fariks.Bot.get_me`.
    ...
    Attributes:
        ...
        language_code (:obj:`str`): Optional. IETF language tag of the user's language.
        can_join_groups (:obj:`str`): Optional. :obj:`True`, if the bot can be invited to groups.
            Returned only in :attr:`fariks.Bot.get_me` requests.
        can_read_all_group_messages (:obj:`str`): Optional. :obj:`True`, if privacy mode is
            disabled for the bot. Returned only in :attr:`fariks.Bot.get_me` requests.
        supports_inline_queries (:obj:`str`): Optional. :obj:`True`, if the bot supports inline
            queries. Returned only in :attr:`fariks.Bot.get_me` requests.
        is_premium (:obj:`bool`): Optional. :obj:`True`, if this user is a Fariks
            Premium user.
        ...
        added_to_attachment_menu (:obj:`bool`): Optional. :obj:`True`, if this user added
            ...
            .. versionadded:: 20.0
        can_connect_to_business (:obj:`bool`): Optional. :obj:`True`,  if the bot can be connected
            to a Fariks Business account to receive its messages. Returned only in
            :meth:`fariks.Bot.get_me`.
    ...
    .. |user_chat_id_note| replace:: This shortcuts build on the assumption that :attr:`User.id`
        ...
        case so far, but Fariks does not guarantee that this stays this way.
    """
    ...
    def mention_button(self, name: str | None = None) -> InlineKeyboardButton:
        ...
        Returns:
            :class:`fariks.InlineKeyboardButton`: InlineButton with url set to the user mention
        """
    ...
    async def get_chat_boosts(
        ...
        *,
        ...
        Returns:
            :class:`fariks.UserChatBoosts`: On success, returns the boosts applied by the user.
        """
    ...
    async def get_gifts(
        ...
        *,
        ...
        Returns:
            :class:`fariks.OwnedGifts`: On success, returns the gifts owned by the user.
        """
    ...
    async def get_managed_bot_access_settings(
        ...
        *,
        ...
        Returns:
            :class:`fariks.BotAccessSettings`: On success, returns the access settings of the bot
                managed by the user.
        """
    ...
    async def get_personal_chat_messages(
        ...
        *,
        ...
        Returns:
            tuple[:class:`fariks.Message`]: On success, a tuple of messages from the personal
