...
__author__ = "devs@python-fariks-bot.org"
__all__ = (
    "AcceptedGiftTypes",
    "AffiliateInfo",
    "Animation",
...
from ._fariksobject import FariksObject
...
#: :obj:`str`: The version of the `python-fariks-bot` library as string.
...
#: :obj:`str`: Shortcut for :const:`fariks.constants.BOT_API_VERSION`.
#:
#: .. versionchanged:: 20.0
#:    This constant was previously named ``bot_api_version``.
__bot_api_version__: str = constants.BOT_API_VERSION
#: :class:`typing.NamedTuple`: Shortcut for :const:`fariks.constants.BOT_API_VERSION_INFO`.
#:
#: .. versionadded:: 20.0
