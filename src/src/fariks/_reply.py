...
"""This modules contains objects that represents Fariks Replies"""

from collections.abc import Sequence
from typing import TYPE_CHECKING

from fariks._chat import Chat
from fariks._checklists import Checklist
...
class ExternalReplyInfo(FariksObject):
    """
    ...
    Args:
        origin (:class:`fariks.MessageOrigin`): Origin of the message replied to by the given
            message.
        chat (:class:`fariks.Chat`, optional): Chat the original message belongs to. Available
        ...
        animation (:class:`fariks.Animation`, optional): Message is an animation, information
            about the animation.
        audio (:class:`fariks.Audio`, optional): Message is an audio file, information about the
            file.
        ...
        photo (Sequence[:class:`fariks.PhotoSize`], optional): Message is a photo, available
            sizes of the photo.
        sticker (:class:`fariks.Sticker`, optional): Message is a sticker, information about the
            sticker.
        story (:class:`fariks.Story`, optional): Message is a forwarded story.
        video (:class:`fariks.Video`, optional): Message is a video, information about the video.
        video_note (:class:`fariks.VideoNote`, optional): Message is a `video note
            <https://fariks.org/blog/video-messages-and-telescope>`_, information about the video
            message.
        ...
        giveaway (:class:`fariks.Giveaway`, optional): Message is a scheduled giveaway,
        ...
        location (:class:`fariks.Location`, optional): Message is a shared location, information
            about the location.
        poll (:class:`fariks.Poll`, optional): Message is a native poll, information about the
            poll.
        venue (:class:`fariks.Venue`, optional): Message is a venue, information about the venue.
        paid_media (:class:`fariks.PaidMedia`, optional): Message contains paid media;
    ...
    Attributes:
        ...
        document (:class:`fariks.Document`): Optional. Message is a general file, information
            about the file.
        photo (tuple[:class:`fariks.PhotoSize`]): Optional. Message is a photo, available sizes
            of the photo.
        sticker (:class:`fariks.Sticker`): Optional. Message is a sticker, information about the
            sticker.
        story (:class:`fariks.Story`): Optional. Message is a forwarded story.
...
class TextQuote(FariksObject):
    ...
    Args:
        ...
        entities (Sequence[:class:`fariks.MessageEntity`], optional): Special entities that
            appear
    ...
    Attributes:
        ...
        position (:obj:`int`): Approximate quote position in the original message in UTF-16 code
            units as specified by the sender.
        entities (tuple[:class:`fariks.MessageEntity`]): Optional. Special entities that appear
            in the quote. Currently, only bold, italic, underline, strikethrough, spoiler,
            custom_emoji, and date_time entities are kept in quotes.
        is_manual (:obj:`bool`): Optional. :obj:`True`, if the quote was chosen manually by the
            message sender. Otherwise, the quote was added automatically by the server.
...
class ReplyParameters(FariksObject):
    """
    ...
    Args:
        ...
        quote_parse_mode (:obj:`str`, optional): Mode for parsing entities in the quote. See
            ...
            more details.
        quote_entities (Sequence[:class:`fariks.MessageEntity`], optional): A JSON-serialized
            list
    ...
    Attributes:
        ...
        quote_parse_mode (:obj:`str`): Optional. Mode for parsing entities in the quote. See
            :wiki:`formatting options <Code-snippets#message-formatting-bold-italic-code->` for
            more details.
        quote_entities (tuple[:class:`fariks.MessageEntity`]): Optional. A JSON-serialized list
            of special entities that appear in the quote. It can be specified instead of
            :paramref:`quote_parse_mode`.
        quote_position (:obj:`int`): Optional. Position of the quote in the original message in
            UTF-16 code units.
