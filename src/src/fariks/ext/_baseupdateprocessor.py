...
from fariks.ext._utils.asyncio import TrackedBoundedSemaphore
...
class SimpleUpdateProcessor(BaseUpdateProcessor):
    """Instance of :class:`fariks.ext.BaseUpdateProcessor` that immediately awaits the
    coroutine, i.e. does not apply any additional processing. This is used by default when
    :attr:`fariks.ext.ApplicationBuilder.concurrent_updates` is :obj:`int`.
