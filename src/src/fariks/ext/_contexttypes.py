...
from fariks.ext._callbackcontext import CallbackContext
from fariks.ext._extbot import ExtBot
from fariks.ext._utils.types import BD, CCT, CD, UD
...
class ContextTypes(Generic[CCT, UD, CD, BD]):
    """
    Convenience class to gather customizable types of the :class:`fariks.ext.CallbackContext`
    interface.
    ...
    Args:
        context (:obj:`type`, optional): Determines the type of the ``context`` argument of all
            ...
            :class:`fariks.ext.CallbackContext`. Defaults to
    ...
    default settings, i.e. if :class:`fariks.ext.ContextTypes` is not used.
