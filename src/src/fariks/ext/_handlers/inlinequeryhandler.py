...
class InlineQueryHandler(BaseHandler[Update, CCT, RT]):
    """
    BaseHandler class to handle Fariks updates that contain a
    :attr:`fariks.Update.inline_query`.
    ...
    Warning:
        ...
        * :attr:`fariks.InlineQuery.chat_type` will not be set for inline queries from secret
    ...
    Args:
        ...
        pattern (:obj:`str` | :func:`re.Pattern <re.compile>`, optional): Regex pattern.
            If not :obj:`None`, :func:`re.match` is used on :attr:`fariks.InlineQuery.query`
        ...
        chat_types (list[:obj:`str`], optional): List of allowed chat types. If passed, will only
            handle inline queries with the appropriate :attr:`fariks.InlineQuery.chat_type`.

            .. versionadded:: 13.5
    Attributes:
        callback (:term:`coroutine function`): The callback function for this handler.
        pattern (:obj:`str` | :func:`re.Pattern <re.compile>`): Optional. Regex pattern to test
            :attr:`fariks.InlineQuery.query` against.
