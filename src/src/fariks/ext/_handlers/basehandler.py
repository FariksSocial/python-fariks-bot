...
class BaseHandler(ABC, Generic[UT, CCT, RT]):
    ...
    2. The type of the second argument of :paramref:`callback`. Must coincide with the type of the
       ...
       :paramref:`callback`. Must be either :class:`~fariks.ext.CallbackContext` or a subclass
       of that class.
    ...
    def check_update(self, update: object) -> bool | object | None:
        ...
        Args:
            update (:obj:`object` | :class:`fariks.Update`): The update to be tested.
    ...
    async def handle_update(
        ...
        arguments. To work with the :class:`fariks.ext.ConversationHandler`, this method
        returns the value returned from :attr:`callback`.
        Note that it can be overridden if needed by the subclassing handler.

        Args:
            update (:obj:`str` | :class:`fariks.Update`): The update to be handled.
            application (:class:`fariks.ext.Application`): The calling application.
    ...
    def collect_additional_context(
        ...
        Args:
            context (:class:`fariks.ext.CallbackContext`): The context object.
            update (:class:`fariks.Update`): The update to gather chat/user id from.
            application (:class:`fariks.ext.Application`): The calling application.
