...
if TYPE_CHECKING:
    ...
    from fariks.ext import BaseRateLimiter, CallbackContext, JobQueue

CCT = TypeVar("CCT", bound="CallbackContext[Any, Any, Any, Any]")
"""An instance of :class:`fariks.ext.CallbackContext` or a custom subclass.
...
"""dict[tuple[:obj:`int` | :obj:`str`, ...], :obj:`object` | None]:
    Dicts as maintained by the :class:`fariks.ext.ConversationHandler`.
...
"""tuple[list[tuple[:obj:`str`, :obj:`float`, dict[:obj:`str`, :class:`object`]]], \
    ...
    :attr:`fariks.ext.CallbackDataCache.persistence_data`.
