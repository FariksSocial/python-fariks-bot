...
from fariks import CallbackQuery, Chat, InlineKeyboardButton, InlineKeyboardMarkup, Message, User
from fariks._utils.datetime import UTC
from fariks.ext import ExtBot
from fariks.ext._callbackdatacache import CallbackDataCache, InvalidCallbackData, _KeyboardData
...
class TestNoCallbackDataCache:
    def test_init(self, bot):
        with pytest.raises(RuntimeError, match=r"python-fariks-bot\[callback-data\]"):
