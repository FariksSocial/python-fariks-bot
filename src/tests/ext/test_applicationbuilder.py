...
from fariks.ext._applicationbuilder import _BOT_CHECKS
from fariks.ext._baseupdateprocessor import SimpleUpdateProcessor
...
class TestApplicationBuilder:
    ...
    def test_default_values(self, bot, monkeypatch, builder):
        ...
        assert "api.fariks.com" in app.bot.base_url
        assert bot.token in app.bot.base_url
        assert "api.fariks.com" in app.bot.base_file_url
