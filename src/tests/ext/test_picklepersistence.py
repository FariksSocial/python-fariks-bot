...
from fariks import Chat, Message, FariksObject, Update, User
from fariks.ext import ContextTypes, PersistenceInput, PicklePersistence
...
class TestPicklePersistence:
    ...
    class DictSub(FariksObject):  # Used for testing our custom (Un)Pickler.
    ...
    async def test_custom_pickler_unpickler_simple(
        ...
        # Now test that pickling of unknown bots in FariksObjects will be replaced by None-
