...
from fariks.ext import ApplicationBuilder, Updater
from fariks.ext.filters import MessageFilter, UpdateFilter
...
# We don't want the tests on fariks.ext to depend on the network, so we use the offline bot
# instead.
