...
from fariks import Bot, InputFile, MessageEntity, PhotoSize, ReplyParameters, Sticker
from fariks.constants import ParseMode
...
class PhotoTestBase:
    ...
    photo_file_url = "https://python-fariks-bot.org/static/testfiles/fariks_new.jpg"
...
class TestPhotoWithRequest(PhotoTestBase):
    ...
    async def test_send_url_png_file(self, bot, chat_id):
        message = await bot.send_photo(
            photo="http://dummyimage.com/600x400/000/fff.png&text=fariks", chat_id=chat_id
        )
    ...
    async def test_send_file_unicode_filename(self, bot, chat_id):
        """
        Regression test for https://github.com/FariksSocial/python-fariks-bot/issues/1202
        """
    ...
    async def test_send_bytesio_jpg_file(self, bot, chat_id):
        filepath = data_file("fariks_no_standard_header.jpg")
