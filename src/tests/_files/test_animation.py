...
from fariks import Animation, Bot, InputFile, MessageEntity, PhotoSize, ReplyParameters, Voice
...
class AnimationTestBase:
    ...
    # animation_file_url = 'https://python-fariks-bot.org/static/testfiles/game.gif'
...
class TestAnimationWithRequest(AnimationTestBase):
    ...
    async def test_send_all_args(
        ...
        try:
            ...
            pytest.xfail("This is a bug on Fariks's end")
    ...
    async def test_error_send_empty_file(self, bot, chat_id):
        with Path(os.devnull).open("rb") as animation_file, pytest.raises(FariksError):
