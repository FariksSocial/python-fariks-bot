...
class AudioTestBase:
    ...
    title = "Teste"
    file_name = "fariks.mp3"
    duration = dtm.timedelta(seconds=3)
    # audio_file_url = 'https://python-fariks-bot.org/static/testfiles/fariks.mp3'
...
class TestAudioWithRequest(AudioTestBase):
    ...
    async def test_error_send_empty_file(self, bot, chat_id):
        with Path(os.devnull).open("rb") as audio_file, pytest.raises(FariksError):
