...
from fariks.constants import BaseInputMediaType, ParseMode
from fariks.error import BadRequest
from fariks.request import RequestData
...
class TestInputMediaVideoWithoutRequest(InputMediaVideoTestBase):
    ...
    def test_with_local_files(self):
        input_media_video = InputMediaVideo(
            data_file("fariks.mp4"),
            thumbnail=data_file("fariks.jpg"),
            cover=data_file("fariks.jpg"),
        )
        assert input_media_video.media == data_file("fariks.mp4").as_uri()
        assert input_media_video.thumbnail == data_file("fariks.jpg").as_uri()
        assert input_media_video.cover == data_file("fariks.jpg").as_uri()
...
class TestInputMediaPhotoWithoutRequest(InputMediaPhotoTestBase):
    ...
    def test_with_local_files(self):
        input_media_photo = InputMediaPhoto(data_file("fariks.mp4"))
        assert input_media_photo.media == data_file("fariks.mp4").as_uri()
...
class TestInputMediaAnimationWithoutRequest(InputMediaAnimationTestBase):
    ...
    def test_with_local_files(self):
        input_media_animation = InputMediaAnimation(
            data_file("fariks.mp4"), thumbnail=data_file("fariks.jpg")
        )
        assert input_media_animation.media == data_file("fariks.mp4").as_uri()
        assert input_media_animation.thumbnail == data_file("fariks.jpg").as_uri()
...
class TestInputMediaAudioWithoutRequest(InputMediaAudioTestBase):
    ...
    def test_with_local_files(self):
        ...
        assert input_media_audio.media == data_file("fariks.mp4").as_uri()
        assert input_media_audio.thumbnail == data_file("fariks.jpg").as_uri()
...
class TestInputMediaStickerWithoutRequest(InputMediaStickerTestBase):
    ...
    def test_with_local_files(self):
        input_media_sticker = InputMediaSticker(
            data_file("fariks_sticker.png"), emoji=self.emoji
        )
        assert input_media_sticker.media == data_file("fariks_sticker.png").as_uri()
        assert input_media_sticker.emoji == self.emoji
...
class TestInputMediaDocumentWithoutRequest(InputMediaDocumentTestBase):
    ...
    def test_with_local_files(self):
        ...
        assert input_media_document.media == data_file("fariks.mp4").as_uri()
        assert input_media_document.thumbnail == data_file("fariks.jpg").as_uri()
...
class TestInputPaidMediaPhotoWithoutRequest(InputMediaPhotoTestBase):
    ...
    def test_with_local_files(self):
        input_paid_media_photo = InputPaidMediaPhoto(data_file("fariks.jpg"))
        assert input_paid_media_photo.media == data_file("fariks.jpg").as_uri()
...
class TestInputMediaLivePhotoWithoutRequest(InputMediaLivePhotoTestBase):
    ...
    def test_with_local_files(self):
        input_media_live_photo = InputMediaLivePhoto(
            media=data_file("fariks.mp4"), photo=data_file("fariks.jpg")
        )
        assert input_media_live_photo.media == data_file("fariks.mp4").as_uri()
        assert input_media_live_photo.photo == data_file("fariks.jpg").as_uri()
...
class TestInputPaidMediaVideoWithoutRequest(InputMediaVideoTestBase):
    ...
    def test_with_local_files(self):
        ...
        assert input_paid_media_video.media == data_file("fariks.mp4").as_uri()
        assert input_paid_media_video.thumbnail == data_file("fariks.jpg").as_uri()
        assert input_paid_media_video.cover == data_file("fariks.jpg").as_uri()
...
class TestInputPaidMediaLivePhotoWithoutRequest(InputMediaLivePhotoTestBase):
    ...
    def test_with_local_files(self):
        ...
        assert input_paid_media_live_photo.media == data_file("fariks.mp4").as_uri()
        assert input_paid_media_live_photo.photo == data_file("fariks.jpg").as_uri()
...
class TestSendMediaGroupWithRequest:
        ...
        async def func():
            return await bot.send_media_group(
                ...
                [
                    ...
                    InputMediaPhoto(data_file("fariks.jpg").read_bytes()),
                ],
            )
    ...
    async def test_send_media_group_with_group_caption(
        ...
        # to Fariks displaying its caption as group caption
    ...
    async def test_send_media_group_default_parse_mode(
        ...
        # Make sure first message got the caption, which will lead to Fariks
