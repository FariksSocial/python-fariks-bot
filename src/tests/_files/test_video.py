...
async def video(bot, chat_id):
    ...
    # Tests using actual VideoQuality objects from real Fariks responses
...
class VideoTestBase:
    ...
    video_file_url = "https://python-fariks-bot.org/static/testfiles/fariks.mp4"
