...
async def main() -> None:
    ...
    await application.bot.set_webhook(url=f"{URL}/fariks", allowed_updates=Update.ALL_TYPES)

    # Set up webserver
    quart_app = Quart(__name__)

    @quart_app.post("/fariks")  # type: ignore[untyped-decorator]
    async def fariks() -> Response:
