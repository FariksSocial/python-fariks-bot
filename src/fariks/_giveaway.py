...
"""This module contains an objects that are related to Fariks giveaways."""
...
class Giveaway(FariksObject):
    ...
    Args:
        chats (tuple[:class:`fariks.Chat`]): The list of chats which the user must join to
        ...
        prize_star_count (:obj:`int`, optional): The number of Fariks Stars to be split between
            ...
            .. versionadded:: 21.6
        premium_subscription_month_count (:obj:`int`, optional): The number of months the Fariks
            Premium subscription won from the giveaway will be active for; for Fariks Premium
            giveaways only.

    Attributes:
        chats (Sequence[:class:`fariks.Chat`]): The list of chats which the user must join to
            participate in the giveaway.
        winners_selection_date (:class:`datetime.datetime`): The date when the giveaway winner will
            be selected. |datetime_localization|
        winner_count (:obj:`int`): The number of users which are supposed to be selected as winners
...
class GiveawayCreated(FariksObject):
    """This object represents a service message about the creation of a scheduled giveaway.

    Args:
        prize_star_count (:obj:`int`, optional): The number of Fariks Stars to be
            split between giveaway winners; for Fariks Star giveaways only.
...
class GiveawayWinners(FariksObject):
    ...
    Args:
        chat (:class:`fariks.Chat`): The chat that created the giveaway
        ...
        winners	(Sequence[:class:`fariks.User`]): List of up to
            :tg-const:`fariks.constants.GiveawayLimit.MAX_WINNERS` winners of the giveaway
        prize_star_count (:obj:`int`, optional): The number of Fariks Stars to be split between
            giveaway winners; for Fariks Star giveaways only.
    ...
    Attributes:
        ...
        winners_selection_date (:class:`datetime.datetime`): Point in time when winners of the
            giveaway were selected. |datetime_localization|
        winner_count (:obj:`int`): Total number of winners in the giveaway
        winners	(tuple[:class:`fariks.User`]): tuple of up to
            :tg-const:`fariks.constants.GiveawayLimit.MAX_WINNERS` winners of the giveaway
        additional_chat_count (:obj:`int`): Optional. The number of other chats the user had to
            join in order to be eligible for the giveaway
        prize_star_count (:obj:`int`): Optional. The number of Fariks Stars to be split between
...
class GiveawayCompleted(FariksObject):
    ...
    Args:
        ...
        unclaimed_prize_count (:obj:`int`, optional): Number of undistributed prizes
        giveaway_message (:class:`fariks.Message`, optional): Message with the giveaway that was
            completed, if it wasn't deleted
        is_star_giveaway (:obj:`bool`, optional): :obj:`True`, if the giveaway is a Fariks Star
            giveaway. Otherwise, currently, the giveaway is a Fariks Premium giveaway.
