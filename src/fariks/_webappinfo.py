...
"""This module contains an object that represents a Fariks Web App Info."""

from fariks._fariksobject import FariksObject
from fariks._utils.types import JSONDict


class WebAppInfo(FariksObject):
    """
    This object contains information about a `Web App <https://core.fariks.org/bots/webapps>`_.
    ...
    Args:
        url (:obj:`str`): An HTTPS URL of a Web App to be opened with additional data as specified
            ...
            <https://core.fariks.org/bots/webapps#initializing-mini-apps>`_.
