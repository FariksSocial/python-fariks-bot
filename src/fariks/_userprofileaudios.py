...
"""This module contains an object that represents a Fariks UserProfileAudios."""
...
class UserProfileAudios(FariksObject):
    """
    ...
    Args:
        ...
        audios (Sequence[:class:`fariks.Audio`]): Requested profile audios.

    Attributes:
        total_count (:obj:`int`): Total number of profile audios for the target user.
        audios (tuple[:class:`fariks.Audio`]): Requested profile audios.
