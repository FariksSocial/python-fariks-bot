...
from fariks._utils.argumentparsing import de_json_optional, to_timedelta
...
class ChatInviteLink(FariksObject):
    ...
    Args:
        ...
        creator (:class:`fariks.User`): Creator of the link.
        ...
        subscription_period (:obj:`int` | :class:`datetime.timedelta`, optional): The number of
            ...
            .. versionchanged:: v22.2
                |time-period-input|
        subscription_price (:obj:`int`, optional): The amount of Fariks Stars a user must pay
