...
"""This module contains objects related to Fariks suggested posts."""
...
class SuggestedPostPrice(FariksObject):
    """
    ...
    Args:
        currency (:obj:`str`):
            ...
            Fariks Stars or ``“TON”`` for toncoins.
        amount (:obj:`int`):
            The amount of the currency that will be paid for the post in the smallest units of the
            currency, i.e. Fariks Stars or nanotoncoins. Currently, price in Fariks Stars must
            be between :tg-const:`fariks.constants.SuggestedPost.MIN_PRICE_STARS`
            and :tg-const:`fariks.constants.SuggestedPost.MAX_PRICE_STARS`, and price in
            nanotoncoins must be between
            :tg-const:`fariks.constants.SuggestedPost.MIN_PRICE_NANOTONCOINS`
            and :tg-const:`fariks.constants.SuggestedPost.MAX_PRICE_NANOTONCOINS`.
...
class SuggestedPostParameters(FariksObject):
    """
    ...
    Args:
        price (:class:`fariks.SuggestedPostPrice`, optional):
        ...
        send_date (:class:`datetime.datetime`, optional):
            ...
            must be between :tg-const:`fariks.constants.SuggestedPost.MIN_SEND_DATE`
            second and :tg-const:`fariks.constants.SuggestedPost.MAX_SEND_DATE` seconds (30 days)
            in the future. If the field is omitted, then the post can be published at any time
            within :tg-const:`fariks.constants.SuggestedPost.MAX_SEND_DATE` seconds (30 days) at
            the sole discretion of the user who approves it.
            |datetime_localization|

    Attributes:
        price (:class:`fariks.SuggestedPostPrice`):
...
class SuggestedPostInfo(FariksObject):
    """
    ...
    Args:
        state (:obj:`str`):
            ...
            :tg-const:`~fariks.constants.SuggestedPostInfoState.PENDING`,
            :tg-const:`~fariks.constants.SuggestedPostInfoState.APPROVED`,
            :tg-const:`~fariks.constants.SuggestedPostInfoState.DECLINED`.
    ...
    """:const:`fariks.constants.SuggestedPostInfoState.PENDING`"""
    APPROVED: Final[str] = constants.SuggestedPostInfoState.APPROVED
    """:const:`fariks.constants.SuggestedPostInfoState.APPROVED`"""
    DECLINED: Final[str] = constants.SuggestedPostInfoState.DECLINED
    """:const:`fariks.constants.SuggestedPostInfoState.DECLINED`"""
...
class SuggestedPostDeclined(FariksObject):
    """
    ...
    Args:
        suggested_post_message (:class:`fariks.Message`, optional):
            Message containing the suggested post. Note that the :class:`~fariks.Message` object
            in this field will not contain the :attr:`~fariks.Message.reply_to_message` field
            even if it itself is a reply.
        comment (:obj:`str`, optional):
            Comment with which the post was declined.

    Attributes:
        suggested_post_message (:class:`fariks.Message`):
            Optional. Message containing the suggested post. Note that the
            :class:`~fariks.Message` object in this field will not contain
            the :attr:`~fariks.Message.reply_to_message` field even if it itself is a reply.
        comment (:obj:`str`):
...
class SuggestedPostPaid(FariksObject):
    """
    ...
    Args:
        suggested_post_message (:class:`fariks.Message`, optional):
            ...
            even if it itself is a reply.
        currency (:obj:`str`):
            Currency in which the payment was made. Currently, one of ``“XTR”`` for Fariks Stars
            or ``“TON”`` for toncoins.
        ...
        star_amount (:class:`fariks.StarAmount`, optional):
            The amount of Fariks Stars that was received by the channel; for payments in Fariks
            Stars only.
    ...
    Attributes:
        ...
        star_amount (:class:`fariks.StarAmount`):
            Optional. The amount of Fariks Stars that was received by the channel; for payments
            in Fariks Stars only.
...
class SuggestedPostRefunded(FariksObject):
    """
    ...
    Args:
        ...
        reason (:obj:`str`):
            ...
            one of :tg-const:`fariks.constants.SuggestedPostRefunded.POST_DELETED` if the post
            was deleted within 24 hours of being posted or removed from scheduled messages without
            being posted, or :tg-const:`fariks.constants.SuggestedPostRefunded.PAYMENT_REFUNDED`
...
class SuggestedPostApproved(FariksObject):
    """
...
class SuggestedPostApprovalFailed(FariksObject):
    """
