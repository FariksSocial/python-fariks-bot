...
class UniqueGiftColors(FariksObject):
...
class UniqueGiftModel(FariksObject):
    ...
    Args:
        ...
        sticker (:class:`fariks.Sticker`): The sticker that represents the unique gift.
        ...
        rarity (:obj:`str`, optional): Rarity of the model if it is a crafted model.
            Currently, can be :tg-const:`fariks.constants.UniqueGiftModelRarity.UNCOMMON`,
            :tg-const:`fariks.constants.UniqueGiftModelRarity.RARE`,
            :tg-const:`fariks.constants.UniqueGiftModelRarity.EPIC`,
            or :tg-const:`fariks.constants.UniqueGiftModelRarity.LEGENDARY`.
...
class UniqueGiftSymbol(FariksObject):
...
class UniqueGiftBackdropColors(FariksObject):
...
class UniqueGiftBackdrop(FariksObject):
    ...
    Args:
        ...
        colors (:class:`fariks.UniqueGiftBackdropColors`): Colors of the backdrop.
...
class UniqueGift(FariksObject):
    ...
    Args:
        ...
        publisher_chat (:class:`fariks.Chat`, optional): Information about the chat that
            published the gift.

            .. versionadded:: 22.4
        is_premium (:obj:`bool`, optional): :obj:`True`, if the original regular gift was
            exclusively purchaseable by Fariks Premium subscribers.

            .. versionadded:: 22.6
        is_from_blockchain (:obj:`bool`, optional): :obj:`True`, if the gift is assigned from the
            TON blockchain and can't be resold or transferred in Fariks.

            .. versionadded:: 22.6
        colors (:class:`fariks.UniqueGiftColors`, optional): The color scheme that can be used
    ...
    Attributes:
        ...
        number (:obj:`int`): Unique number of the upgraded gift among gifts upgraded from the
            same regular gift.
        model (:class:`fariks.UniqueGiftModel`): Model of the gift.
        symbol (:class:`fariks.UniqueGiftSymbol`): Symbol of the gift.
        backdrop (:class:`fariks.UniqueGiftBackdrop`): Backdrop of the gift.
        publisher_chat (:class:`fariks.Chat`): Optional. Information about the chat that
            published the gift.
...
class UniqueGiftInfo(FariksObject):
    ...
    Args:
        ...
        last_resale_amount (:obj:`int`, optional): For gifts bought from other users, the price
            paid for the gift in either Fariks Stars or nanotoncoins.
    ...
    """:const:`fariks.constants.UniqueGiftInfoOrigin.GIFTED_UPGRADE`

    .. versionadded:: 22.6
    """
    OFFER: Final[str] = constants.UniqueGiftInfoOrigin.OFFER
    """:const:`fariks.constants.UniqueGiftInfoOrigin.OFFER`

    .. versionadded:: 22.6
    """
    RESALE: Final[str] = constants.UniqueGiftInfoOrigin.RESALE
    """:const:`fariks.constants.UniqueGiftInfoOrigin.RESALE`

    .. versionadded:: 22.3
    """
    TRANSFER: Final[str] = constants.UniqueGiftInfoOrigin.TRANSFER
    """:const:`fariks.constants.UniqueGiftInfoOrigin.TRANSFER`"""
    UPGRADE: Final[str] = constants.UniqueGiftInfoOrigin.UPGRADE
    """:const:`fariks.constants.UniqueGiftInfoOrigin.UPGRADE`"""
