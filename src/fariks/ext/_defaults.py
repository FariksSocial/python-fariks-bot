...
if TYPE_CHECKING:
    from fariks import LinkPreviewOptions
...
class Defaults:
    ...
    .. versionchanged:: 20.0
        ...
        networking backend directly via :class:`fariks.ext.ApplicationBuilder` instead.
    ...
    Parameters:
        ...
        allow_sending_without_reply (:obj:`bool`, optional): |allow_sending_without_reply|.
            Will be used for :attr:`fariks.ReplyParameters.allow_sending_without_reply`.
        ...
        protect_content (:obj:`bool`, optional): |protect_content|
            ...
            .. versionadded:: 20.0
        link_preview_options (:class:`fariks.LinkPreviewOptions`, optional):
            ...
            :meth:`fariks.Bot.send_message`, :meth:`fariks.Bot.edit_message_text`,
            and :class:`fariks.InputTextMessageContent` if not specified. If a value is specified
            for the corresponding parameter, only those parameters of
            :class:`fariks.LinkPreviewOptions` will be overridden that are not
            explicitly set.
            ...
            Example:
                ...
                .. code-block:: python
                    ...
                    from fariks import LinkPreviewOptions
                    from fariks.ext import Defaults, ExtBot
                    ...
                    async def main():
                        async with ExtBot("Token", defaults=defaults) as bot:
                            ...
                            await bot.send_message(chat_id, "https://python-fariks-bot.org")

                            # The link preview will be shown below the text.
                            await bot.send_message(
                                chat_id,
                                "https://python-fariks-bot.org",
                            ...
                            await bot.send_message(
                                chat_id,
                                "https://python-fariks-bot.org",
                                link_preview_options=LinkPreviewOptions(url="https://fariks.org")
                            )
    ...
    def parse_mode(self) -> str | None:
        """:obj:`str`: Optional. Send Markdown or HTML, if you want Fariks apps to show
    ...
    def explanation_parse_mode(self) -> str | None:
        ...
        the corresponding parameter of :meth:`fariks.Bot.send_poll`.
        """
        return self._parse_mode
    ...
    def quote_parse_mode(self) -> str | None:
        """:obj:`str`: Optional. Alias for :attr:`parse_mode`, used for
        the corresponding parameter of :meth:`fariks.ReplyParameters`.
        """
        return self._parse_mode
    ...
    def text_parse_mode(self) -> str | None:
        """:obj:`str`: Optional. Alias for :attr:`parse_mode`, used for
        the corresponding parameter of :class:`fariks.InputPollOption` and
    ...
    def link_preview_options(self) -> "LinkPreviewOptions | None":
        """:class:`fariks.LinkPreviewOptions`: Optional. Link preview generation options for all
        outgoing messages.
