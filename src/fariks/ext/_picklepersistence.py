...
from fariks import Bot, FariksObject
from fariks._utils.types import FilePathInput
from fariks._utils.warnings import warn
from fariks.ext import BasePersistence, PersistenceInput
...
FariksObj = TypeVar("FariksObj", bound=FariksObject)


def _all_subclasses(cls: type[FariksObj]) -> set[type[FariksObj]]:
...
def _reconstruct_to(cls: type[FariksObj], kwargs: dict) -> FariksObj:
    """
    This method is used for unpickling. The data, which is in the form a dictionary, is
    converted back into a class. Works mostly the same as :meth:`FariksObject.__setstate__`.
...
def _custom_reduction(cls: FariksObj) -> tuple[Callable, tuple[type[FariksObj], dict]]:
    """
...
class PicklePersistence(BasePersistence[UD, CD, BD]):
    ...
    Args:
        ...
        context_types (:class:`fariks.ext.ContextTypes`, optional): Pass an instance
            of :class:`fariks.ext.ContextTypes` to customize the types used in the
            ``context`` interface. If not passed, the defaults documented in
            :class:`fariks.ext.ContextTypes` will be used.
    ...
    Attributes:
        ...
        on_flush (:obj:`bool`): Optional. When :obj:`True` will only save to file when
            ...
            :obj:`False` will store data on any transaction *and* on call to :meth:`flush`.
            Default is :obj:`False`.
        context_types (:class:`fariks.ext.ContextTypes`): Container for the types used
    ...
    async def get_bot_data(self) -> BD:
        ...
        :obj:`dict` | :attr:`fariks.ext.ContextTypes.bot_data`.

        Returns:
            :obj:`dict` | :attr:`fariks.ext.ContextTypes.bot_data`: The restored bot data.
        """
        if self.bot_data:
            pass
        elif not self.single_file:
    ...
    async def update_user_data(self, user_id: int, data: UD) -> None:
        ...
        Args:
            ...
            data (:obj:`dict`): The :attr:`fariks.ext.Application.user_data` ``[user_id]``.
        """
    ...
    async def update_chat_data(self, chat_id: int, data: CD) -> None:
        ...
        Args:
            ...
            data (:obj:`dict`): The :attr:`fariks.ext.Application.chat_data` ``[chat_id]``.
        """
    ...
    async def update_bot_data(self, data: BD) -> None:
        ...
        Args:
            data (:obj:`dict` | :attr:`fariks.ext.ContextTypes.bot_data`): The
                :attr:`fariks.ext.Application.bot_data`.
        """
    ...
    async def refresh_user_data(self, user_id: int, user_data: UD) -> None:
        ...
        .. versionadded:: 13.6
        .. seealso:: :meth:`fariks.ext.BasePersistence.refresh_user_data`
        """
    ...
    async def refresh_chat_data(self, chat_id: int, chat_data: CD) -> None:
        ...
        .. versionadded:: 13.6
        .. seealso:: :meth:`fariks.ext.BasePersistence.refresh_chat_data`
        """
    ...
    async def refresh_bot_data(self, bot_data: BD) -> None:
        ...
        .. versionadded:: 13.6
        .. seealso:: :meth:`fariks.ext.BasePersistence.refresh_bot_data`
        """
