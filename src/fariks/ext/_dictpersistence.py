...
from fariks.ext._utils.types import CDCData, ConversationDict, ConversationKey
...
class DictPersistence(BasePersistence[dict[Any, Any], dict[Any, Any], dict[Any, Any]]):
    ...
    async def update_bot_data(self, data: dict[Any, Any]) -> None:
        ...
        Args:
            data (:obj:`dict`): The :attr:`fariks.ext.Application.bot_data`.
        """
    ...
    async def flush(self) -> None:
        ...
        .. versionadded:: 20.0
        .. seealso:: :meth:`fariks.ext.BasePersistence.flush`
        """
