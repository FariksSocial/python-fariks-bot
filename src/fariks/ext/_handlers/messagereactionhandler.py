...
from fariks._utils.types import RT, SCT, DVType
...
class MessageReactionHandler(BaseHandler[Update, CCT, RT]):
    """Handler class to handle Fariks updates that contain a message reaction.
    ...
    Note:
         ...
         * If a chat ID **and** a username are passed, an update containing **any** of them will be
            filtered.
         * :attr:`fariks.MessageReactionUpdated.actor_chat` is *not* considered for
    ...
    Args:
        ...
        message_reaction_types (:obj:`int`, optional): Pass one of
            ...
            :attr:`fariks.Update.message_reaction_count` or both. Defaults to
        ...
        user_id (:obj:`int` | Collection[:obj:`int`], optional): Filters reactions to allow
            ...
            :paramref:`fariks.MessageReactionUpdated.actor_chat`).
    ...
    Attributes:
        ...
        message_reaction_types (:obj:`int`): Optional. Specifies if this handler should handle only
            updates with :attr:`fariks.Update.message_reaction`,
            :attr:`fariks.Update.message_reaction_count` or both.
    ...
    """:obj:`int`: Used as a constant to handle only :attr:`fariks.Update.message_reaction`."""
    MESSAGE_REACTION_COUNT_UPDATED: Final[int] = 0
    """:obj:`int`: Used as a constant to handle only
    :attr:`fariks.Update.message_reaction_count`."""
    MESSAGE_REACTION: Final[int] = 1
    """:obj:`int`: Used as a constant to handle both :attr:`fariks.Update.message_reaction`
    and :attr:`fariks.Update.message_reaction_count`."""
