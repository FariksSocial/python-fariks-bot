...
from fariks.ext._utils.types import CCT, RT, HandlerCallback


class ChatBoostHandler(BaseHandler[Update, CCT, RT]):
    """
    Handler class to handle Fariks updates that contain a chat boost.
    ...
    Args:
        ...
        chat_boost_types (:obj:`int`, optional): Pass one of
            ...
            :attr:`fariks.Update.chat_boost`,
            :attr:`fariks.Update.removed_chat_boost` or both. Defaults to
            :attr:`CHAT_BOOST`.
    ...
    Attributes:
        ...
        chat_boost_types (:obj:`int`): Optional. Specifies if this handler should handle only
            updates with :attr:`fariks.Update.chat_boost`,
            :attr:`fariks.Update.removed_chat_boost` or both.
    ...
    """ :obj:`int`: Used as a constant to handle only :attr:`fariks.Update.chat_boost`."""
    REMOVED_CHAT_BOOST: Final[int] = 0
    """:obj:`int`: Used as a constant to handle only :attr:`fariks.Update.removed_chat_boost`."""
    ANY_CHAT_BOOST: Final[int] = 1
    """:obj:`int`: Used as a constant to handle both :attr:`fariks.Update.chat_boost`
    and :attr:`fariks.Update.removed_chat_boost`."""
