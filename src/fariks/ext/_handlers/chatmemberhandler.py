...
from fariks.ext._utils._update_parsing import parse_chat_id
...
class ChatMemberHandler(BaseHandler[Update, CCT, RT]):
    """Handler class to handle Fariks updates that contain a chat member update.
    ...
    Args:
        ...
        chat_member_types (:obj:`int`, optional): Pass one of :attr:`MY_CHAT_MEMBER`,
            ...
            only updates with :attr:`fariks.Update.my_chat_member`,
            :attr:`fariks.Update.chat_member` or both. Defaults to :attr:`MY_CHAT_MEMBER`.
    ...
    Attributes:
        ...
        chat_member_types (:obj:`int`): Optional. Specifies if this handler should handle
            only updates with :attr:`fariks.Update.my_chat_member`,
            :attr:`fariks.Update.chat_member` or both.
    ...
    """:obj:`int`: Used as a constant to handle only :attr:`fariks.Update.my_chat_member`."""
    CHAT_MEMBER: Final[int] = 0
    """:obj:`int`: Used as a constant to handle only :attr:`fariks.Update.chat_member`."""
    ANY_CHAT_MEMBER: Final[int] = 1
    """:obj:`int`: Used as a constant to handle both :attr:`fariks.Update.my_chat_member`
    and :attr:`fariks.Update.chat_member`."""
