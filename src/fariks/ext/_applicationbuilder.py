...
"""This module contains the Builder classes for the fariks.ext module."""
...
from fariks._bot import Bot
from fariks._utils.defaultvalue import DEFAULT_FALSE, DEFAULT_NONE, DefaultValue
...
from fariks.ext._application import Application
from fariks.ext._baseupdateprocessor import BaseUpdateProcessor, SimpleUpdateProcessor
from fariks.ext._contexttypes import ContextTypes
from fariks.ext._extbot import ExtBot
from fariks.ext._jobqueue import JobQueue
from fariks.ext._updater import Updater
from fariks.ext._utils.types import BD, BT, CCT, CD, JQ, UD
from fariks.request import BaseRequest
from fariks.request._httpxrequest import HTTPXRequest

if TYPE_CHECKING:
    from fariks import Update
    from fariks.ext import BasePersistence, BaseRateLimiter, CallbackContext, Defaults
    from fariks.ext._utils.types import RLARGS
...
class ApplicationBuilder(Generic[BT, CCT, UD, CD, BD, JQ]):
    """This class serves as initializer for :class:`fariks.ext.Application` via the so called
    `builder pattern`_. To build a :class:`fariks.ext.Application`, one first initializes an
    instance of this class. Arguments for the :class:`fariks.ext.Application` to build are then
    added by subsequently calling the methods of the builder. Finally, the
    :class:`fariks.ext.Application` is built by calling :meth:`build`. In the simplest case this
    ...
    Note:
        ...
        * Unless a custom :class:`fariks.Bot` instance is set via :meth:`bot`, :meth:`build` will
          use :class:`fariks.ext.ExtBot` for the bot.
    ...
    def __init__(self: "InitApplicationBuilder"):
        ...
        self._base_url: DVType[BaseUrl] = DefaultValue("https://api.fariks.com/bot")
        self._base_file_url: DVType[BaseUrl] = DefaultValue("https://api.fariks.com/file/bot")
    ...
    def build(
        ...
        """Builds a :class:`fariks.ext.Application` with the provided arguments.

        Calls :meth:`fariks.ext.JobQueue.set_application` and
        :meth:`fariks.ext.BasePersistence.set_bot` if appropriate.

        Returns:
            :class:`fariks.ext.Application`
        """
    ...
    def application_class(
        ...
        """Sets a custom subclass instead of :class:`fariks.ext.Application`. The
        ...
        Args:
            application_class (:obj:`type`): A subclass of :class:`fariks.ext.Application`
    ...
    def token(self: BuilderType, token: str) -> BuilderType:
        """Sets the token for :attr:`fariks.ext.Application.bot`.
    ...
    def base_url(self: BuilderType, base_url: BaseUrl) -> BuilderType:
        """Sets the base URL for :attr:`fariks.ext.Application.bot`. If not called,
        will default to ``'https://api.fariks.com/bot'``.

        .. seealso:: :paramref:`fariks.Bot.base_url`,
        ...
        Args:
            base_url (:obj:`str` | Callable[[:obj:`str`], :obj:`str`]): The URL or
                input for the URL as accepted by :paramref:`fariks.Bot.base_url`.
    ...
    def base_file_url(self: BuilderType, base_file_url: BaseUrl) -> BuilderType:
        """Sets the base file URL for :attr:`fariks.ext.Application.bot`. If not
        called, will default to ``'https://api.fariks.com/file/bot'``.

        .. seealso:: :paramref:`fariks.Bot.base_file_url`,
        ...
        Args:
            base_file_url (:obj:`str` | Callable[[:obj:`str`], :obj:`str`]): The URL or
                input for the URL as accepted by :paramref:`fariks.Bot.base_file_url`.
    ...
    def request(self: BuilderType, request: BaseRequest) -> BuilderType:
        """Sets a :class:`fariks.request.BaseRequest` instance for the
        :paramref:`fariks.Bot.request` parameter of :attr:`fariks.ext.Application.bot`.

        .. seealso:: :meth:`get_updates_request`

        Args:
            request (:class:`fariks.request.BaseRequest`): The request instance.
    ...
    def connection_pool_size(self: BuilderType, connection_pool_size: int) -> BuilderType:
        ...
        :paramref:`~fariks.request.HTTPXRequest.connection_pool_size` parameter of
        :attr:`fariks.Bot.request`. Defaults to ``256``.
    ...
    def proxy(self: BuilderType, proxy: str | httpx.Proxy | httpx.URL) -> BuilderType:
        """Sets the proxy for the :paramref:`~fariks.request.HTTPXRequest.proxy`
        parameter of :attr:`fariks.Bot.request`. Defaults to :obj:`None`.
        ...
        Args:
            proxy (:obj:`str` | ``httpx.Proxy`` | ``httpx.URL``): The URL to a proxy
                ...
                :paramref:`fariks.request.HTTPXRequest.proxy` for more information.
    ...
    def socket_options(self: BuilderType, socket_options: Collection[SocketOpt]) -> BuilderType:
        """Sets the options for the :paramref:`~fariks.request.HTTPXRequest.socket_options`
        parameter of :attr:`fariks.Bot.request`. Defaults to :obj:`None`.
        ...
        Args:
            socket_options (Collection[:obj:`tuple`], optional): Socket options. See
                :paramref:`fariks.request.HTTPXRequest.socket_options` for more information.
    ...
    def connect_timeout(self: BuilderType, connect_timeout: float | None) -> BuilderType:
        ...
        :paramref:`~fariks.request.HTTPXRequest.connect_timeout` parameter of
        :attr:`fariks.Bot.request`. Defaults to ``5.0``.

        .. seealso:: :meth:`get_updates_connect_timeout`

        Args:
            connect_timeout (:obj:`float`): See
                :paramref:`fariks.request.HTTPXRequest.connect_timeout` for more information.
    ...
    def read_timeout(self: BuilderType, read_timeout: float | None) -> BuilderType:
        ...
        :paramref:`~fariks.request.HTTPXRequest.read_timeout` parameter of
        :attr:`fariks.Bot.request`. Defaults to ``5.0``.
        ...
        Args:
            read_timeout (:obj:`float`): See
                :paramref:`fariks.request.HTTPXRequest.read_timeout` for more information.
    ...
    def write_timeout(self: BuilderType, write_timeout: float | None) -> BuilderType:
        ...
        :paramref:`~fariks.request.HTTPXRequest.write_timeout` parameter of
        :attr:`fariks.Bot.request`. Defaults to ``5.0``.
        ...
        Args:
            write_timeout (:obj:`float`): See
                :paramref:`fariks.request.HTTPXRequest.write_timeout` for more information.
    ...
    def media_write_timeout(self: BuilderType, media_write_timeout: float | None) -> BuilderType:
        ...
        :paramref:`~fariks.request.HTTPXRequest.media_write_timeout` parameter of
        :attr:`fariks.Bot.request`. Defaults to ``20``.

        .. versionadded:: 21.0

        Args:
            media_write_timeout (:obj:`float`): See
                :paramref:`fariks.request.HTTPXRequest.media_write_timeout` for more information.
    ...
    def pool_timeout(self: BuilderType, pool_timeout: float | None) -> BuilderType:
        ...
        :paramref:`~fariks.request.HTTPXRequest.pool_timeout` parameter of
        :attr:`fariks.Bot.request`. Defaults to ``1.0``.
        ...
        Args:
            pool_timeout (:obj:`float`): See
                :paramref:`fariks.request.HTTPXRequest.pool_timeout` for more information.
    ...
    def http_version(self: BuilderType, http_version: HTTPVersion) -> BuilderType:
        ...
        :paramref:`~fariks.request.HTTPXRequest.http_version` parameter of
        :attr:`fariks.Bot.request`. By default, HTTP/1.1 is used.
        ...
        Note:
            ...
            keepalive connections. See `#3556 <https://github.com/FariksSocial/
            python-fariks-bot/issues/3556>`_ for a discussion.
            ...
            .. code-block:: bash
               ...
               pip install "python-fariks-bot[http2]"
        ...
        Args:
            http_version (:obj:`str`): Pass ``"2"`` or ``"2.0"`` if you'd like to use HTTP/2 for
                making requests to Fariks. Defaults to ``"1.1"``, in which case HTTP/1.1 is used.
    ...
    def get_updates_request(self: BuilderType, get_updates_request: BaseRequest) -> BuilderType:
        """Sets a :class:`fariks.request.BaseRequest` instance for the
        :paramref:`~fariks.Bot.get_updates_request` parameter of
        :attr:`fariks.ext.Application.bot`.

        .. seealso:: :meth:`request`

        Args:
            get_updates_request (:class:`fariks.request.BaseRequest`): The request instance.
    ...
    def get_updates_connection_pool_size(
        ...
        """Sets the size of the connection pool for the
        :paramref:`fariks.request.HTTPXRequest.connection_pool_size` parameter which is used
        for the :meth:`fariks.Bot.get_updates` request. Defaults to ``1``.
    ...
    def get_updates_proxy(
        ...
        """Sets the proxy for the :paramref:`fariks.request.HTTPXRequest.proxy`
        parameter which is used for :meth:`fariks.Bot.get_updates`. Defaults to :obj:`None`.
    ...
    def get_updates_socket_options(
        ...
        """Sets the options for the :paramref:`~fariks.request.HTTPXRequest.socket_options`
        parameter of :paramref:`fariks.Bot.get_updates_request`. Defaults to :obj:`None`.
    ...
    def get_updates_connect_timeout(
        ...
        """Sets the connection attempt timeout for the
        :paramref:`fariks.request.HTTPXRequest.connect_timeout` parameter which is used for
        the :meth:`fariks.Bot.get_updates` request. Defaults to ``5.0``.
    ...
    def get_updates_read_timeout(
        ...
        """Sets the waiting timeout for the
        :paramref:`fariks.request.HTTPXRequest.read_timeout` parameter which is used for the
        :meth:`fariks.Bot.get_updates` request. Defaults to ``5.0``.
    ...
    def get_updates_write_timeout(
        ...
        """Sets the write operation timeout for the
        :paramref:`fariks.request.HTTPXRequest.write_timeout` parameter which is used for
        the :meth:`fariks.Bot.get_updates` request. Defaults to ``5.0``.
    ...
    def get_updates_pool_timeout(
        ...
        """Sets the connection pool's connection freeing timeout for the
        :paramref:`~fariks.request.HTTPXRequest.pool_timeout` parameter which is used for the
        :meth:`fariks.Bot.get_updates` request. Defaults to ``1.0``.
    ...
    def get_updates_http_version(
        ...
        """Sets the HTTP protocol version which is used for the
        :paramref:`~fariks.request.HTTPXRequest.http_version` parameter which is used in the
        :meth:`fariks.Bot.get_updates` request. By default, HTTP/1.1 is used.
        ...
        Args:
            get_updates_http_version (:obj:`str`): Pass ``"2"`` or ``"2.0"`` if you'd like to use
                HTTP/2 for making requests to Fariks. Defaults to ``"1.1"``, in which case
                HTTP/1.1 is used.
    ...
    def private_key(
        ...
        """Sets the private key and corresponding password for decryption of fariks passport data
        for :attr:`fariks.ext.Application.bot`.

        Examples:
            :any:`Passport Bot <examples.passportbot>`

        .. seealso:: :wiki:`Fariks Passports <Fariks-Passport>`
    ...
    def defaults(self: BuilderType, defaults: "Defaults") -> BuilderType:
        """Sets the :class:`fariks.ext.Defaults` instance for
        :attr:`fariks.ext.Application.bot`.

        .. seealso:: :wiki:`Adding Defaults to Your Bot <Adding-defaults-to-your-bot>`

        Args:
            defaults (:class:`fariks.ext.Defaults`): The defaults instance.
    ...
    def arbitrary_callback_data(
        ...
        """Specifies whether :attr:`fariks.ext.Application.bot` should allow arbitrary objects as
        callback data for :class:`fariks.InlineKeyboardButton` and how many keyboards should be
        ...
        Important:
            ...
            .. code-block:: bash
               ...
               pip install "python-fariks-bot[callback-data]"
    ...
    def local_mode(self: BuilderType, local_mode: bool) -> BuilderType:
        """Specifies the value for :paramref:`~fariks.Bot.local_mode` for the
        :attr:`fariks.ext.Application.bot`.
    ...
    def bot(
        ...
        """Sets a :class:`fariks.Bot` instance for
        :attr:`fariks.ext.Application.bot`. Instances of subclasses like
        :class:`fariks.ext.ExtBot` are also valid.

        Args:
            bot (:class:`fariks.Bot`): The bot.
    ...
    def update_queue(self: BuilderType, update_queue: "Queue[object]") -> BuilderType:
        ...
        :attr:`fariks.ext.Application.update_queue`, i.e. the queue that the application will
        fetch updates from. Will also be used for the :attr:`fariks.ext.Application.updater`.
        If not called, a queue will be instantiated.

        .. seealso:: :attr:`fariks.ext.Updater.update_queue`
    ...
    def concurrent_updates(
        ...
        Warning:
            ...
            :class:`fariks.ext.ConversationHandler` are used. Only use this if you are sure
            that your bot does not (explicitly or implicitly) rely on updates being processed
            sequentially.

        .. include:: inclusions/pool_size_tip.rst

        .. seealso:: :attr:`fariks.ext.Application.concurrent_updates`
        ...
        Args:
            concurrent_updates (:obj:`bool` | :obj:`int` | :class:`BaseUpdateProcessor`): Passing
                ...
                :class:`fariks.ext.SimpleUpdateProcessor`. Pass an integer to specify a different
                number of updates that may be processed concurrently. Pass an instance of
                :class:`fariks.ext.BaseUpdateProcessor` to use that instance for handling updates
                concurrently.
    ...
    def job_queue(
        ...
        """Sets a :class:`fariks.ext.JobQueue` instance for
        :attr:`fariks.ext.Application.job_queue`. If not called, a job queue will be
        instantiated if the requirements of :class:`fariks.ext.JobQueue` are installed.
        ...
        Note:
            * :meth:`fariks.ext.JobQueue.set_application` will be called automatically by
              :meth:`build`.
            * The job queue will be automatically started and stopped by
              :meth:`fariks.ext.Application.start` and :meth:`fariks.ext.Application.stop`,
              respectively.
            * When passing :obj:`None` or when the requirements of :class:`fariks.ext.JobQueue`
              are not installed, :attr:`fariks.ext.ConversationHandler.conversation_timeout`
              can not be used, as this uses :attr:`fariks.ext.Application.job_queue` internally.

        Args:
            job_queue (:class:`fariks.ext.JobQueue`): The job queue. Pass :obj:`None` if you
    ...
    def persistence(
        ...
        """Sets a :class:`fariks.ext.BasePersistence` instance for
        :attr:`fariks.ext.Application.persistence`.

        Note:
            When using a persistence, note that all
            data stored in :attr:`context.user_data <fariks.ext.CallbackContext.user_data>`,
            :attr:`context.chat_data <fariks.ext.CallbackContext.chat_data>`,
            :attr:`context.bot_data <fariks.ext.CallbackContext.bot_data>` and
            in :attr:`fariks.ext.ExtBot.callback_data_cache` must be copyable with
        ...
        Warning:
            If a :class:`fariks.ext.ContextTypes` instance is set via :meth:`context_types`,
            the persistence instance must use the same types!

        Args:
            persistence (:class:`fariks.ext.BasePersistence`): The persistence instance.
    ...
    def context_types(
        ...
        """Sets a :class:`fariks.ext.ContextTypes` instance for
        :attr:`fariks.ext.Application.context_types`.

        Examples:
            :any:`Context Types Bot <examples.contexttypesbot>`

        Args:
            context_types (:class:`fariks.ext.ContextTypes`): The context types.
    ...
    def updater(self: BuilderType, updater: Updater | None) -> BuilderType:
        """Sets a :class:`fariks.ext.Updater` instance for
        :attr:`fariks.ext.Application.updater`. The :attr:`fariks.ext.Updater.bot` and
        :attr:`fariks.ext.Updater.update_queue` will be used for
        :attr:`fariks.ext.Application.bot` and :attr:`fariks.ext.Application.update_queue`,
        respectively.

        Args:
            updater (:class:`fariks.ext.Updater` | :obj:`None`): The updater instance or
    ...
    def post_init(
        ...
        *before* executing :meth:`Updater.start_polling` or :meth:`Updater.start_webhook`,
        ...
        Tip:
            ...
            setting up the bots commands via :meth:`~fariks.Bot.set_my_commands`.
        ...
        Args:
            post_init (:term:`coroutine function`): The custom callback. Must be a
                ...
                is the :class:`~fariks.ext.Application`::
    ...
    def rate_limiter(
        ...
        """Sets a :class:`fariks.ext.BaseRateLimiter` instance for the
        :paramref:`fariks.ext.ExtBot.rate_limiter` parameter of
        :attr:`fariks.ext.Application.bot`.

        Args:
            rate_limiter (:class:`fariks.ext.BaseRateLimiter`): The rate limiter.
