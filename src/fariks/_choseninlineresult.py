...
"""This module contains an object that represents a Fariks ChosenInlineResult."""
...
class ChosenInlineResult(FariksObject):
    """
    ...
    Args:
        ...
        from_user (:class:`fariks.User`): The user that chose the result.
