...
class KeyboardButtonRequestUsers(FariksObject):
    ...
    about requesting users » <https://core.fariks.org/bots/features#chat-and-user-selection>`_.
    ...
    Args:
        request_id (:obj:`int`): Signed 32-bit identifier of the request, which will be received
            back in the :class:`fariks.UsersShared` object. Must be unique within the message.
        ...
        max_quantity (:obj:`int`, optional): The maximum number of users to be selected;
            :tg-const:`fariks.constants.KeyboardButtonRequestUsersLimit.MIN_QUANTITY` -
            :tg-const:`fariks.constants.KeyboardButtonRequestUsersLimit.MAX_QUANTITY`.
            Defaults to :tg-const:`fariks.constants.KeyboardButtonRequestUsersLimit.MIN_QUANTITY`
            .
...
class KeyboardButtonRequestChat(FariksObject):
    ...
    Args:
        request_id (:obj:`int`): Signed 32-bit identifier of the request, which will be received
            back in the :class:`fariks.ChatShared` object. Must be unique within the message.
...
class KeyboardButtonRequestManagedBot(FariksObject):
    """
    ...
    managed_bot and a :obj:`fariks.Message` with the field
    :attr:`fariks.Message.managed_bot_created`.
