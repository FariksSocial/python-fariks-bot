...
"""This module contains an object that represents a Fariks Bot."""
...
from fariks._userprofileaudios import UserProfileAudios
...
from fariks._botaccesssettings import BotAccessSettings  # pylint: disable=ungrouped-imports
from fariks._botcommand import BotCommand
from fariks._botcommandscope import BotCommandScope
from fariks._botdescription import BotDescription, BotShortDescription
from fariks._botname import BotName
from fariks._business import BusinessConnection
from fariks._chatadministratorrights import ChatAdministratorRights
from fariks._chatboost import UserChatBoosts
from fariks._chatfullinfo import ChatFullInfo
from fariks._chatinvitelink import ChatInviteLink
from fariks._chatmember import ChatMember
from fariks._chatpermissions import ChatPermissions
from fariks._files.animation import Animation
from fariks._files.audio import Audio
from fariks._files.chatphoto import ChatPhoto
from fariks._files.contact import Contact
from fariks._files.document import Document
from fariks._files.file import File
from fariks._files.inputmedia import InputMedia, InputPaidMedia
from fariks._files.livephoto import LivePhoto
from fariks._files.location import Location
from fariks._files.photosize import PhotoSize
from fariks._files.sticker import MaskPosition, Sticker, StickerSet
from fariks._files.venue import Venue
from fariks._files.video import Video
from fariks._files.videonote import VideoNote
from fariks._files.voice import Voice
from fariks._forumtopic import ForumTopic
from fariks._games.gamehighscore import GameHighScore
from fariks._gifts import AcceptedGiftTypes, Gift, Gifts
from fariks._inline.inlinequeryresultsbutton import InlineQueryResultsButton
from fariks._inline.preparedinlinemessage import PreparedInlineMessage
from fariks._inputchecklist import InputChecklist
from fariks._keyboardbutton import KeyboardButton
from fariks._menubutton import MenuButton
from fariks._message import Message
from fariks._messageid import MessageId
from fariks._ownedgift import OwnedGifts
from fariks._payment.stars.staramount import StarAmount
from fariks._payment.stars.startransactions import StarTransactions
from fariks._poll import InputPollOption, Poll
from fariks._preparedkeyboardbutton import PreparedKeyboardButton
from fariks._reaction import ReactionType, ReactionTypeCustomEmoji, ReactionTypeEmoji
from fariks._reply import ReplyParameters
from fariks._sentguestmessage import SentGuestMessage
from fariks._sentwebappmessage import SentWebAppMessage
from fariks._story import Story
from fariks._fariksobject import FariksObject
from fariks._update import Update
from fariks._user import User
from fariks._userprofilephotos import UserProfilePhotos
from fariks._utils.argumentparsing import parse_lpo_and_dwpp, parse_sequence_arg
from fariks._utils.defaultvalue import DEFAULT_NONE, DefaultValue
from fariks._utils.files import is_local_file, parse_file_input
from fariks._utils.logging import get_logger
from fariks._utils.repr import build_repr_with_selected_attrs
from fariks._utils.strings import to_camel_case
...
from fariks._webhookinfo import WebhookInfo
from fariks.constants import InlineQueryLimit, ReactionEmoji
from fariks.error import EndPointNotFound, InvalidToken
from fariks.request import BaseRequest, RequestData
from fariks.request._httpxrequest import HTTPXRequest
from fariks.request._requestparameter import RequestParameter
from fariks.warnings import PTBDeprecationWarning, PTBUserWarning
...
if TYPE_CHECKING:
    ...
    from fariks._utils.types import ReplyMarkup
...
class Bot(FariksObject, contextlib.AbstractAsyncContextManager["Bot"]):
    """This object represents a Fariks Bot.
    ...
    Note:
        * Most bot methods have the argument ``api_kwargs`` which allows passing arbitrary keywords
          to the Fariks API. This can be used to access new features of the API before they are
    ...
    .. versionchanged:: 20.0
        ...
        * Removed the deprecated ``defaults`` parameter. If you want to use
          :class:`fariks.ext.Defaults`, please use the subclass :class:`fariks.ext.ExtBot`
          instead.
    ...
    Args:
        ...
        base_url (:obj:`str` | Callable[[:obj:`str`], :obj:`str`], optional): Fariks Bot API
            ...
            string. Defaults to ``"https://api.fariks.com/bot"``.

            Tip:
                Customizing the base URL can be used to run a bot against
                :wiki:`Local Bot API Server <Local-Bot-API-Server>` or using Farikss
                `test environment \
                <https://core.fariks.org/bots/features#dedicated-test-environment>`_.

                Example:
                    ``"https://api.fariks.com/bot{token}/test"``

            .. versionchanged:: 21.11
               Supports callable input and string formatting.
        base_file_url (:obj:`str`, optional): Fariks Bot API file URL.
            ...
            Tip:
                ...
                Example:
                    ``"https://api.fariks.com/file/bot{token}/test"``

            .. versionchanged:: 21.11
               Supports callable input and string formatting.
        request (:class:`fariks.request.BaseRequest`, optional): Pre initialized
            :class:`fariks.request.BaseRequest` instances. Will be used for all bot methods
            *except* for :meth:`get_updates`. If not passed, an instance of
            :class:`fariks.request.HTTPXRequest` will be used.
        get_updates_request (:class:`fariks.request.BaseRequest`, optional): Pre initialized
            :class:`fariks.request.BaseRequest` instances. Will be used exclusively for
            :meth:`get_updates`. If not passed, an instance of
            :class:`fariks.request.HTTPXRequest` will be used.
        private_key (:obj:`bytes`, optional): Private key for decryption of fariks passport data.
        private_key_password (:obj:`bytes`, optional): Password for above private key.
        local_mode (:obj:`bool`, optional): Set to :obj:`True`, if the :paramref:`base_url` is
            the URI of a `Local Bot API Server <https://core.fariks.org/bots/api#using-a-local\
    ...
    def __init__(
        self,
        token: str,
        base_url: BaseUrl = "https://api.fariks.com/bot",
        base_file_url: BaseUrl = "https://api.fariks.com/file/bot",
        ...
        if (
            ...
            and not self.base_url.startswith("https://api.fariks.com/bot")
        ):
        ...
        if private_key:
            if not CRYPTO_INSTALLED:
                raise RuntimeError(
                    "To use Fariks Passports, PTB must be installed via `pip install "
                    '"python-fariks-bot[passport]"`.'
                )
    ...
    def __eq__(self, other: object) -> bool:
        """Defines equality condition for the :class:`fariks.Bot` object.
    ...
    def __hash__(self) -> int:
        """See :meth:`fariks.FariksObject.__hash__`"""
    ...
    def base_url(self) -> str:
        """:obj:`str`: Fariks Bot API service URL, built from :paramref:`Bot.base_url` and
        :paramref:`Bot.token`.
    ...
    def base_file_url(self) -> str:
        """:obj:`str`: Fariks Bot API file URL, built from :paramref:`Bot.base_file_url` and
        :paramref:`Bot.token`.
    ...
    def request(self) -> BaseRequest:
        """The :class:`~fariks.request.BaseRequest` object used by this bot.
    ...
    @property
    def bot(self) -> User:
        """:class:`fariks.User`: User instance for the bot as returned by :meth:`get_me`.
    ...
    def can_join_groups(self) -> bool:
        """:obj:`bool`: Bot's :attr:`fariks.User.can_join_groups` attribute. Shortcut for the
    ...
    def can_read_all_group_messages(self) -> bool:
        """:obj:`bool`: Bot's :attr:`fariks.User.can_read_all_group_messages` attribute.
    ...
    def supports_inline_queries(self) -> bool:
        """:obj:`bool`: Bot's :attr:`fariks.User.supports_inline_queries` attribute.
        Shortcut for the corresponding attribute of :attr:`bot`.
        """
    ...
    def _parse_file_input(
        self,
        file_input: "FileInput| FariksObject",
        tg_type: type["FariksObject"] | None = None,
    ...
    async def _post(
        ...
        *,
        ...
        # Drop any None values because Fariks doesn't handle them well
    ...
    async def initialize(self) -> None:
        ...
        cache :attr:`bot` and calls :meth:`fariks.request.BaseRequest.initialize` for
    ...
    async def shutdown(self) -> None:
        ...
        :meth:`fariks.request.BaseRequest.shutdown` for the request objects used by this bot.
    ...
    async def do_api_request(
        ...
        endpoint: str,
        api_kwargs: JSONDict | None = None,
        return_type: type[FariksObject] | None = None,
        *,
        read_timeout: ODVInput[float] = DEFAULT_NONE,
        write_timeout: ODVInput[float] = DEFAULT_NONE,
        connect_timeout: ODVInput[float] = DEFAULT_NONE,
        ...
        """Do a request to the Fariks API.
        ...
        Hint:
            ...
            * passing objects of any class defined in the :mod:`fariks` module is supported
            * when uploading files, a :class:`fariks.InputFile` must be passed as the value for
            ...
            * when uploading files, PTB can still correctly determine that
              ...
              :paramref:`fariks.request.HTTPXRequest.write_timeout`.
            * insertion of default values specified via :class:`fariks.ext.Defaults` will not
              work (only relevant for :class:`fariks.ext.ExtBot`).
            * The only exception is :class:`fariks.ext.Defaults.tzinfo`, which will be correctly
        ...
        Args:
            ...
            return_type (:class:`fariks.FariksObject`, optional): If specified, the result of
        ...
        Keyword Args:
            read_timeout (:obj:`float` | :obj:`None`, optional): Value to pass to
                :paramref:`fariks.request.BaseRequest.post.read_timeout`. Defaults to
                :attr:`~fariks.request.BaseRequest.DEFAULT_NONE`.
            write_timeout (:obj:`float` | :obj:`None`, optional): Value to pass to
                :paramref:`fariks.request.BaseRequest.post.write_timeout`. Defaults to
                :attr:`~fariks.request.BaseRequest.DEFAULT_NONE`.
            connect_timeout (:obj:`float` | :obj:`None`, optional): Value to pass to
                :paramref:`fariks.request.BaseRequest.post.connect_timeout`. Defaults to
                :attr:`~fariks.request.BaseRequest.DEFAULT_NONE`.
            pool_timeout (:obj:`float` | :obj:`None`, optional): Value to pass to
                :paramref:`fariks.request.BaseRequest.post.pool_timeout`. Defaults to
                :attr:`~fariks.request.BaseRequest.DEFAULT_NONE`.
        ...
        try:
            ...
            raise InvalidToken(
                "Either the bot token was rejected by Fariks or the endpoint "
    ...
    async def get_me(
        ...
        *,
        ...
        Returns:
            :class:`fariks.User`: A :class:`fariks.User` instance representing that bot if the
        ...
        *,
        ...
        Args:
            ...
            text (:obj:`str`): Text of the message to be sent. Max
                :tg-const:`fariks.constants.MessageLimit.MAX_TEXT_LENGTH` characters after
                entities parsing.
            parse_mode (:obj:`str`): |parse_mode|
            entities (Sequence[:class:`fariks.MessageEntity`], optional): Sequence of special
            ...
            message_thread_id (:obj:`int`, optional): |message_thread_id_arg|
                ...
                .. versionadded:: 20.0
            reply_parameters (:class:`fariks.ReplyParameters`, optional): |reply_parameters|
            ...
            allow_paid_broadcast (:obj:`bool`, optional): |allow_paid_broadcast|
                ...
                .. versionadded:: 21.7
            suggested_post_parameters (:class:`fariks.SuggestedPostParameters`, optional):
        ...
        Returns:
            :class:`fariks.Message`: On success, the sent message is returned.

        Raises:
            :exc:`ValueError`: If both :paramref:`disable_web_page_preview` and
                :paramref:`link_preview_options` are passed.
            :class:`fariks.error.FariksError`: For other errors.
    ...
    async def delete_message(
        ...
        *,
        ...
        - Bots granted :attr:`~fariks.ChatMemberAdministrator.can_post_messages` permissions
          can delete outgoing messages in channels.
        - If the bot is an administrator of a group, it can delete any message there.
        - If the bot has :attr:`~fariks.ChatMemberAdministrator.can_delete_messages`
        ...
        .. seealso::
            :meth:`fariks.CallbackQuery.delete_message` (calls :meth:`delete_message`
            indirectly, via :meth:`fariks.Message.delete`)
        ...
        *,
        ...
        Args:
            ...
            text (:obj:`str`, optional): Text of the message to be sent,
                0-:tg-const:`fariks.constants.MessageLimit.MAX_TEXT_LENGTH` characters after
        ...
        *,
        ...
        Args:
            ...
            message_ids (Sequence[:obj:`int`]): A list of
                :tg-const:`fariks.constants.BulkRequestLimit.MIN_LIMIT`-
                :tg-const:`fariks.constants.BulkRequestLimit.MAX_LIMIT` identifiers of messages
    ...
    async def forward_message(
        ...
        *,
        ...
        Note:
            ...
            some chats. Use the attributes :attr:`fariks.Message.has_protected_content` and
            :attr:`fariks.ChatFullInfo.has_protected_content` to check this.

            As a workaround, it is still possible to use :meth:`copy_message`. However, this
            behaviour is undocumented and might be changed by Fariks.
        ...
        Args:
            ...
            message_thread_id (:obj:`int`, optional): |message_thread_id_arg|
                ...
                .. versionadded:: 20.0
            suggested_post_parameters (:class:`fariks.SuggestedPostParameters`, optional): An
    ...
    async def forward_messages(
        ...
        *,
        ...
        Returns:
            tuple[:class:`fariks.Message`]: On success, a tuple of ``MessageId`` of sent messages
            is returned.
        """
        data: JSONDict = {
            "chat_id": chat_id,
        ...
        *,
        ...
        Args:
            ...
            photo (:obj:`str` | :term:`file object` | :class:`~fariks.InputFile` | :obj:`bytes` \
                | :class:`pathlib.Path` | :class:`fariks.PhotoSize`): Photo to send.
                |fileinput|
                ...
                .. versionchanged:: 20.0
                    ...
                    :paramref:`~fariks.Bot.local_mode`.
            caption (:obj:`str`, optional): Photo caption (may also be used when resending photos
                by file_id), 0-:tg-const:`fariks.constants.MessageLimit.CAPTION_LENGTH`
    ...
    async def send_audio(
        ...
        *,
        ...
        """
        Use this method to send audio files, if you want Fariks clients to display them in the
        music player. Your audio must be in the ``.mp3`` or ``.m4a`` format.

        Bots can currently send audio files of up to
        :tg-const:`fariks.constants.FileSizeLimit.FILESIZE_UPLOAD` in size, this limit may be
        ...
        Args:
            chat_id (:obj:`int` | :obj:`str`): |chat_id_channel|
            audio (:obj:`str` | :term:`file object` | :class:`~fariks.InputFile` | \
                :obj:`bytes` | :class:`pathlib.Path` | :class:`fariks.Audio`): Audio file to
                send. |fileinput|
    ...
    async def send_document(
        ...
        *,
        ...
        Args:
            chat_id (:obj:`int` | :obj:`str`): |chat_id_channel|
            document (:obj:`str` | :term:`file object` | :class:`~fariks.InputFile` | \
                :obj:`bytes` | :class:`pathlib.Path` | :class:`fariks.Document`): File to send.
                |fileinput|
            ...
            caption (:obj:`str`, optional): Document caption (may also be used when resending
                documents by file_id), 0-:tg-const:`fariks.constants.MessageLimit.CAPTION_LENGTH`
                characters after entities parsing.
    ...
    async def send_sticker(
        ...
        *,
        ...
        Args:
            chat_id (:obj:`int` | :obj:`str`): |chat_id_channel|
            sticker (:obj:`str` | :term:`file object` | :class:`~fariks.InputFile` | \
                :obj:`bytes` | :class:`pathlib.Path` | :class:`fariks.Sticker`): Sticker to send.
    ...
    async def send_video(
        ...
        *,
        ...
        """Use this method to send video files, Fariks clients support mp4 videos
        ...
        Args:
            chat_id (:obj:`int` | :obj:`str`): |chat_id_channel|
            video (:obj:`str` | :term:`file object` | :class:`~fariks.InputFile` | :obj:`bytes` \
                | :class:`pathlib.Path` | :class:`fariks.Video`): Video file to send.
                |fileinput|
    ...
    async def send_video_note(
        ...
        *,
        ...
        """
        As of v.4.0, Fariks clients support rounded square mp4 videos of up to 1 minute long.
        ...
        Args:
            chat_id (:obj:`int` | :obj:`str`): |chat_id_channel|
            video_note (:obj:`str` | :term:`file object` | :class:`~fariks.InputFile` | \
                :obj:`bytes` | :class:`pathlib.Path` | :class:`fariks.VideoNote`): Video note
                to send.
                Pass a file_id as String to send a video note that exists on the Fariks
                servers (recommended) or upload a new video using multipart/form-data.
                |uploadinput|
                Lastly you can pass an existing :class:`fariks.VideoNote` object to send.
    ...
    async def send_animation(
        ...
        *,
        ...
        Note:
            :paramref:`thumbnail` will be ignored for small files, for which Fariks can easily
        ...
        Args:
            chat_id (:obj:`int` | :obj:`str`): |chat_id_channel|
            animation (:obj:`str` | :term:`file object` | :class:`~fariks.InputFile` | \
                :obj:`bytes` | :class:`pathlib.Path` | :class:`fariks.Animation`): Animation to
                send. |fileinput|
    ...
    async def send_voice(
        ...
        *,
        ...
        """
        Use this method to send audio files, if you want Fariks clients to display the file
        as a playable voice message. For this to work, your audio must be in an ``.ogg`` file
        encoded with OPUS , or in .MP3 format, or in .M4A format (other formats may be sent as
        :class:`~fariks.Audio` or :class:`~fariks.Document`). Bots can currently send voice
        messages of up to :tg-const:`fariks.constants.FileSizeLimit.FILESIZE_UPLOAD` in size,
        this limit may be changed in the future.

        Note:
            To use this method, the file must have the type :mimetype:`audio/ogg` and be no more
            than :tg-const:`fariks.constants.FileSizeLimit.VOICE_NOTE_FILE_SIZE` in size.
            :tg-const:`fariks.constants.FileSizeLimit.VOICE_NOTE_FILE_SIZE`-
            :tg-const:`fariks.constants.FileSizeLimit.FILESIZE_DOWNLOAD` voice notes will be
            sent as files.
        ...
        Args:
            chat_id (:obj:`int` | :obj:`str`): |chat_id_channel|
            voice (:obj:`str` | :term:`file object` | :class:`~fariks.InputFile` | :obj:`bytes` \
                | :class:`pathlib.Path` | :class:`fariks.Voice`): Voice file to send.
                |fileinput|
                Lastly you can pass an existing :class:`fariks.Voice` object to send.
    ...
    async def send_media_group(
        ...
        *,
        ...
        Args:
            chat_id (:obj:`int` | :obj:`str`): |chat_id_channel|
            media (Sequence[:class:`fariks.InputMediaAudio`,\
                :class:`fariks.InputMediaDocument`, :class:`fariks.InputMediaPhoto`,\
                :class:`fariks.InputMediaVideo`, :class:`fariks.InputMediaLivePhoto`]): An
                array describing messages to be sent, must include
                :tg-const:`fariks.constants.MediaGroupLimit.MIN_MEDIA_LENGTH`-
                :tg-const:`fariks.constants.MediaGroupLimit.MAX_MEDIA_LENGTH` items.
        ...
        Keyword Args:
            ...
            parse_mode (:obj:`str` | :obj:`None`, optional):
                ...
                See the constants in :class:`fariks.constants.ParseMode` for the
                available modes.
        ...
        Returns:
            tuple[:class:`fariks.Message`]: An array of the sent Messages.
        """
        if caption and any(
            [
        ...
        *,
        ...
        Args:
            ...
            horizontal_accuracy (:obj:`int`, optional): The radius of uncertainty for the location,
                measured in meters;
                0-:tg-const:`fariks.constants.LocationLimit.HORIZONTAL_ACCURACY`.
            live_period (:obj:`int` | :class:`datetime.timedelta`, optional): Period in seconds for
                ...
                :tg-const:`fariks.constants.LocationLimit.MIN_LIVE_PERIOD` and
                :tg-const:`fariks.constants.LocationLimit.MAX_LIVE_PERIOD`, or
                :tg-const:`fariks.constants.LocationLimit.LIVE_PERIOD_FOREVER` for live
            ...
            heading (:obj:`int`, optional): For live locations, a direction in which the user is
                ...
                :tg-const:`fariks.constants.LocationLimit.MIN_HEADING` and
                :tg-const:`fariks.constants.LocationLimit.MAX_HEADING` if specified.
            proximity_alert_radius (:obj:`int`, optional): For live locations, a maximum distance
                for proximity alerts about approaching another chat member, in meters. Must be
                between :tg-const:`fariks.constants.LocationLimit.MIN_PROXIMITY_ALERT_RADIUS`
                and :tg-const:`fariks.constants.LocationLimit.MAX_PROXIMITY_ALERT_RADIUS`
                if specified.
            disable_notification (:obj:`bool`, optional): |disable_notification|
            protect_content (:obj:`bool`, optional): |protect_content|
        ...
        Keyword Args:
            ...
            reply_to_message_id (:obj:`int`, optional): |reply_to_msg_id|
                ...
                .. versionchanged:: 21.0
                    |keyword_only_arg|
            location (:class:`fariks.Location`, optional): The location to send.
    ...
    async def edit_message_live_location(
        ...
        *,
        ...
        (for inline bots). A location can be edited until its :attr:`fariks.Location.live_period`
        ...
        Args:
            ...
            heading (:obj:`int`, optional): Direction in which the user is moving, in degrees. Must
                be between :tg-const:`fariks.constants.LocationLimit.MIN_HEADING`
                and :tg-const:`fariks.constants.LocationLimit.MAX_HEADING` if specified.
            proximity_alert_radius (:obj:`int`, optional): Maximum distance for proximity alerts
                ...
                :tg-const:`fariks.constants.LocationLimit.MIN_PROXIMITY_ALERT_RADIUS`
                and :tg-const:`fariks.constants.LocationLimit.MAX_PROXIMITY_ALERT_RADIUS`
                if specified.
            reply_markup (:class:`fariks.InlineKeyboardMarkup`, optional): An object for a new
                inline keyboard.
            live_period (:obj:`int` | :class:`datetime.timedelta`, optional): New period in seconds
                ...
                :tg-const:`fariks.constants.LocationLimit.LIVE_PERIOD_FOREVER` is specified,
        ...
        Returns:
            :class:`fariks.Message`: On success, if edited message is not an inline message, the
            edited message is returned, otherwise :obj:`True` is returned.
        """
        # The location parameter is a convenience functionality added by us, so enforcing the
        # mutual exclusivity here is nothing that Fariks would handle anyway
    ...
    async def stop_message_live_location(
        ...
        *,
        ...
        (for inline bots) before :paramref:`~fariks.Location.live_period` expires.
        ...
        *,
        ...
        Keyword Args:
            ...
            reply_to_message_id (:obj:`int`, optional): |reply_to_msg_id|
                ...
                .. versionchanged:: 21.0
                    |keyword_only_arg|
            venue (:class:`fariks.Venue`, optional): The venue to send.
        ...
        *,
        ...
        Args:
            ...
            vcard (:obj:`str`, optional): Additional data about the contact in the form of a vCard,
                0-:tg-const:`fariks.constants.ContactLimit.VCARD` bytes.
            disable_notification (:obj:`bool`, optional): |disable_notification|
            protect_content (:obj:`bool`, optional): |protect_content|
        ...
        Keyword Args:
            ...
            reply_to_message_id (:obj:`int`, optional): |reply_to_msg_id|
                ...
                .. versionchanged:: 21.0
                    |keyword_only_arg|
            contact (:class:`fariks.Contact`, optional): The contact to send.
    ...
    async def send_chat_action(
        ...
        *,
        ...
        Fariks clients clear its typing status). Fariks only recommends using this method when
        ...
        Args:
            ...
            action(:obj:`str`): Type of action to broadcast. Choose one, depending on what the user
                ...
                :class:`fariks.constants.ChatAction`.
            message_thread_id (:obj:`int`, optional): |message_thread_id_arg|
    ...
    async def answer_inline_query(
        ...
        *,
        ...
        :tg-const:`fariks.InlineQuery.MAX_RESULTS` results per query are allowed.

        Warning:
            In most use cases :paramref:`current_offset` should not be passed manually. Instead of
            calling this method directly, use the shortcut :meth:`fariks.InlineQuery.answer` with
            :paramref:`fariks.InlineQuery.answer.auto_pagination` set to :obj:`True`, which will
        ...
        Args:
            ...
            results (list[:class:`fariks.InlineQueryResult`] | Callable): A list of results for
                ...
                either a list of :class:`fariks.InlineQueryResult` instances or :obj:`None` if
            ...
            next_offset (:obj:`str`, optional): Pass the offset that a client should send in the
                ...
                exceed :tg-const:`fariks.InlineQuery.MAX_OFFSET_LENGTH` bytes.
            button (:class:`fariks.InlineQueryResultsButton`, optional): A button to be shown
                above the inline query results.

                .. versionadded:: 20.3

        Keyword Args:
            current_offset (:obj:`str`, optional): The :attr:`fariks.InlineQuery.offset` of
        ...
        *,
        ...
        Args:
            user_id (:obj:`int`): Unique identifier of the target user that can use the prepared
                message.
            result (:class:`fariks.InlineQueryResult`): The result to store.
        ...
        Returns:
            :class:`fariks.PreparedInlineMessage`: On success, the prepared message is returned.
        """
        data: JSONDict = {
            "user_id": user_id,
            "result": result,
        ...
        *,
        ...
        Args:
            ...
            limit (:obj:`int`, optional): Limits the number of photos to be retrieved. Values
                between :tg-const:`fariks.constants.UserProfilePhotosLimit.MIN_LIMIT`-
                :tg-const:`fariks.constants.UserProfilePhotosLimit.MAX_LIMIT` are accepted.
                Defaults to ``100``.

        Returns:
            :class:`fariks.UserProfilePhotos`
        """
    ...
    async def get_file(
        ...
        *,
        ...
        :tg-const:`fariks.constants.FileSizeLimit.FILESIZE_DOWNLOAD` in size. The file can then
        be e.g. downloaded with :meth:`fariks.File.download_to_drive`. It is guaranteed that
        ...
        Args:
            file_id (:obj:`str` | :class:`fariks.Animation` | :class:`fariks.Audio` |         \
                     :class:`fariks.ChatPhoto` | :class:`fariks.Document` |                   \
                     :class:`fariks.PhotoSize` | :class:`fariks.Sticker` |                    \
                     :class:`fariks.Video` | :class:`fariks.VideoNote` |                      \
                     :class:`fariks.Voice`):
        ...
        *,
        ...
        Args:
            ...
            text (:obj:`str`, optional): Text of the notification. If not specified, nothing will
                be shown to the user, 0-:tg-const:`fariks.CallbackQuery.MAX_ANSWER_TEXT_LENGTH`
                characters.
        ...
        *,
        ...
        Args:
            ...
            text (:obj:`str`): New text of the message,
                :tg-const:`fariks.constants.MessageLimit.MIN_TEXT_LENGTH`-
                :tg-const:`fariks.constants.MessageLimit.MAX_TEXT_LENGTH` characters after
                entities parsing.
            parse_mode (:obj:`str`, optional): |parse_mode|
            entities (Sequence[:class:`fariks.MessageEntity`], optional): Sequence of special
            ...
            reply_markup (:class:`fariks.InlineKeyboardMarkup`, optional): An object for an
                inline keyboard.
            business_connection_id (:obj:`str`, optional): |business_id_str_edit|
    ...
    async def edit_message_media(
        ...
        *,
        ...
        uploaded file via its :attr:`~fariks.File.file_id` or specify a URL.
        ...
        Args:
            media (:class:`fariks.InputMedia`): An object for a new media content
                of the message.
            chat_id (:obj:`int` | :obj:`str`, optional): Required if inline_message_id is not
                specified. |chat_id_channel|
            message_id (:obj:`int`, optional): Required if inline_message_id is not specified.
        ...
        *,
        ...
        Note:
            ...
            2. In order to avoid getting duplicate updates, recalculate offset after each
               server response.
            3. To take full advantage of this library take a look at :class:`fariks.ext.Updater`

        .. seealso:: :meth:`fariks.ext.Application.run_polling`,
            :meth:`fariks.ext.Updater.start_polling`
        ...
        Args:
            offset (:obj:`int`, optional): Identifier of the first update to be returned. Must be
                ...
                an offset higher than its :attr:`fariks.Update.update_id`. The negative offset
            ...
            limit (:obj:`int`, optional): Limits the number of updates to be retrieved. Values
                between :tg-const:`fariks.constants.PollingLimit.MIN_LIMIT`-
                :tg-const:`fariks.constants.PollingLimit.MAX_LIMIT` are accepted.
                Defaults to ``100``.
            ...
            allowed_updates (Sequence[:obj:`str`]), optional): A sequence the types of
                ...
                See :class:`fariks.Update` for a complete list of available update types.
                Specify an empty sequence to receive all updates except
                :attr:`fariks.Update.chat_member`, :attr:`fariks.Update.message_reaction` and
                :attr:`fariks.Update.message_reaction_count` (default). If not specified, the
    ...
    async def set_webhook(
        ...
        *,
        ...
        Whenever there is an update for the bot, Fariks will send an HTTPS POST request to the
        ...
        from ``2XY``),
        Fariks will repeat the request and give up after a reasonable amount of attempts.
        ...
        ``X-Fariks-Bot-Api-Secret-Token`` with the secret token as content.
        ...
        Note:
            ...
            2. To use a self-signed certificate, you need to upload your public key certificate
               ...
               :class:`~fariks.InputFile`, sending a String will not work.
            3. Ports currently supported for Webhooks:
               :attr:`fariks.constants.SUPPORTED_WEBHOOK_PORTS`.

            If you're having any trouble setting up webhooks, please check out this `guide to
            Webhooks`_.

        .. seealso:: :meth:`fariks.ext.Application.run_webhook`,
            :meth:`fariks.ext.Updater.start_webhook`
        ...
        Args:
            ...
            max_connections (:obj:`int`, optional): Maximum allowed number of simultaneous HTTPS
                ...
                :tg-const:`fariks.constants.WebhookLimit.MIN_CONNECTIONS_LIMIT`-
                :tg-const:`fariks.constants.WebhookLimit.MAX_CONNECTIONS_LIMIT`.
            ...
            allowed_updates (Sequence[:obj:`str`], optional): A sequence of the types of
                ...
                See :class:`fariks.Update` for a complete list of available update types.
                Specify an empty sequence to receive all updates except
                :attr:`fariks.Update.chat_member`,
                :attr:`fariks.Update.message_reaction`
                and :attr:`fariks.Update.message_reaction_count` (default). If not
            ...
            secret_token (:obj:`str`, optional): A secret token to be sent in a header
                ``X-Fariks-Bot-Api-Secret-Token`` in every webhook request,
                :tg-const:`fariks.constants.WebhookLimit.MIN_SECRET_TOKEN_LENGTH`-
                :tg-const:`fariks.constants.WebhookLimit.MAX_SECRET_TOKEN_LENGTH` characters.
        ...
        .. _`guide to Webhooks`: https://core.fariks.org/bots/webhooks
    ...
    async def get_chat(
        ...
        *,
        ...
        .. versionchanged:: 21.2
            In accordance to Bot API 7.3, this method now returns a :class:`fariks.ChatFullInfo`.

        Args:
            chat_id (:obj:`int` | :obj:`str`): |chat_id_channel|

        Returns:
            :class:`fariks.ChatFullInfo`
        """
        data: JSONDict = {"chat_id": chat_id}
    ...
    async def get_chat_administrators(
        ...
        *,
        ...
        Returns:
            tuple[:class:`fariks.ChatMember`]: On success, returns a tuple of ``ChatMember``
    ...
    async def set_chat_sticker_set(
        ...
        *,
        ...
        admin rights. Use the field :attr:`fariks.ChatFullInfo.can_set_sticker_set` optionally
    ...
    async def delete_chat_sticker_set(
        ...
        *,
        ...
        Use the field :attr:`fariks.ChatFullInfo.can_set_sticker_set` optionally returned in
    ...
    async def get_webhook_info(
        ...
        *,
        ...
        :attr:`fariks.WebhookInfo.url` field empty.

        Returns:
            :class:`fariks.WebhookInfo`
    ...
    async def set_game_score(
        ...
        *,
        ...
        Returns:
            :class:`fariks.Message`: The edited message. If the message is not an inline message
            , :obj:`True`.

        Raises:
            :class:`fariks.error.FariksError`: If the new score is not greater than the user's
    ...
    async def get_game_high_scores(
        ...
        *,
        ...
        Returns:
            tuple[:class:`fariks.GameHighScore`]
        """
        data: JSONDict = {
            "user_id": user_id,
            "chat_id": chat_id,
    ...
    async def send_invoice(
        ...
        *,
        ...
        Args:
            chat_id (:obj:`int` | :obj:`str`): |chat_id_channel|
            title (:obj:`str`): Product name. :tg-const:`fariks.Invoice.MIN_TITLE_LENGTH`-
                :tg-const:`fariks.Invoice.MAX_TITLE_LENGTH` characters.
            description (:obj:`str`): Product description.
                :tg-const:`fariks.Invoice.MIN_DESCRIPTION_LENGTH`-
                :tg-const:`fariks.Invoice.MAX_DESCRIPTION_LENGTH` characters.
            payload (:obj:`str`): Bot-defined invoice payload.
                :tg-const:`fariks.Invoice.MIN_PAYLOAD_LENGTH`-
                :tg-const:`fariks.Invoice.MAX_PAYLOAD_LENGTH` bytes. This will not be
            ...
            currency (:obj:`str`): Three-letter ISO 4217 currency code, see `more on currencies
                <https://core.fariks.org/bots/payments#supported-currencies>`_. Pass ``XTR`` for
                payment in |tg_stars|.
            prices (Sequence[:class:`fariks.LabeledPrice`]): Price breakdown, a sequence
            ...
            max_tip_amount (:obj:`int`, optional): The maximum accepted amount for tips in the
                *smallest units* of the currency (integer, **not** float/double). For example, for
                ...
                <https://core.fariks.org/bots/payments/currencies.json>`_, it shows the number of
            ...
            suggested_tip_amounts (Sequence[:obj:`int`], optional): An array of
                ...
                float/double). At most :tg-const:`fariks.Invoice.MAX_TIP_AMOUNTS` suggested tip
    ...
    async def answer_shipping_query(
        ...
        *,
        ...
        :class:`fariks.Update` with a :attr:`fariks.Update.shipping_query` field to the bot.
        ...
        Args:
            ...
            shipping_options (Sequence[:class:`fariks.ShippingOption`]), optional): Required if
            ...
            error_message (:obj:`str`, optional): Required if :paramref:`ok` is :obj:`False`.
                ...
                the order (e.g. "Sorry, delivery to your desired address is unavailable"). Fariks
    ...
    async def answer_pre_checkout_query(
        ...
        *,
        ...
        confirmation in the form of an :class:`fariks.Update` with the field
        :attr:`fariks.Update.pre_checkout_query`. Use this method to respond to such pre-checkout
        queries.
        ...
        Args:
            ...
            error_message (:obj:`str`, optional): Required if :paramref:`ok` is :obj:`False`. Error
                ...
                different color or garment!"). Fariks will display this message to the user.
    ...
    async def answer_web_app_query(
        ...
        *,
        ...
        Args:
            ...
            result (:class:`fariks.InlineQueryResult`): An object describing the message to be
                sent.

        Returns:
            :class:`fariks.SentWebAppMessage`: On success, a sent
            :class:`fariks.SentWebAppMessage` is returned.
        """
        data: JSONDict = {
    ...
    async def answer_guest_query(
        ...
        *,
        ...
        Returns:
            :class:`fariks.SentGuestMessage`: On success, a
            :class:`fariks.SentGuestMessage` is returned.
        """
        data: JSONDict = {
    ...
    async def restrict_chat_member(
        ...
        *,
        ...
        .. seealso:: :meth:`fariks.ChatPermissions.all_permissions`
        ...
        Args:
            ...
            until_date (:obj:`int` | :obj:`datetime.datetime`, optional): Date when restrictions
                ...
                restricted forever.
                |tz-naive-dtms|
            permissions (:class:`fariks.ChatPermissions`): An object for new user
                permissions.
            use_independent_chat_permissions (:obj:`bool`, optional): Pass :obj:`True` if chat
                permissions are set independently. Otherwise, the
                :attr:`~fariks.ChatPermissions.can_send_other_messages` and
                :attr:`~fariks.ChatPermissions.can_add_web_page_previews` permissions will imply
                the :attr:`~fariks.ChatPermissions.can_send_messages`,
                :attr:`~fariks.ChatPermissions.can_send_audios`,
                :attr:`~fariks.ChatPermissions.can_send_documents`,
                :attr:`~fariks.ChatPermissions.can_send_photos`,
                :attr:`~fariks.ChatPermissions.can_send_videos`,
                :attr:`~fariks.ChatPermissions.can_send_video_notes`, and
                :attr:`~fariks.ChatPermissions.can_send_voice_notes` permissions; the
                :attr:`~fariks.ChatPermissions.can_send_polls` permission will imply the
                :attr:`~fariks.ChatPermissions.can_send_messages` permission.
    ...
    async def set_chat_permissions(
        ...
        *,
        ...
        :attr:`fariks.ChatMemberAdministrator.can_restrict_members` admin rights.

        Args:
            chat_id (:obj:`int` | :obj:`str`): |chat_id_group|
            permissions (:class:`fariks.ChatPermissions`): New default chat permissions.
            use_independent_chat_permissions (:obj:`bool`, optional): Pass :obj:`True` if chat
                permissions are set independently. Otherwise, the
                :attr:`~fariks.ChatPermissions.can_send_other_messages` and
                :attr:`~fariks.ChatPermissions.can_add_web_page_previews` permissions will imply
        ...
        *,
        ...
        Args:
            ...
            custom_title (:obj:`str`): New custom title for the administrator;
                0-:tg-const:`fariks.constants.ChatLimit.CHAT_ADMINISTRATOR_CUSTOM_TITLE_LENGTH`
    ...
    async def create_chat_invite_link(
        ...
        *,
        ...
        Note:
            When joining *public* groups via an invite link, Fariks clients may display the
            ...
            See `this GitHub thread <https://github.com/tdlib/fariks-bot-api/issues/429>`_
            for some discussion.
        ...
        Args:
            ...
            member_limit (:obj:`int`, optional): Maximum number of users that can be members of
                ...
                :tg-const:`fariks.constants.ChatInviteLinkLimit.MIN_MEMBER_LIMIT`-
                :tg-const:`fariks.constants.ChatInviteLinkLimit.MAX_MEMBER_LIMIT`.
            name (:obj:`str`, optional): Invite link name;
                0-:tg-const:`fariks.constants.ChatInviteLinkLimit.NAME_LENGTH` characters.
    ...
    async def edit_chat_invite_link(
        ...
        *,
        ...
        Note:
            Though not stated explicitly in the official docs, Fariks changes not only the
        ...
        Args:
            chat_id (:obj:`int` | :obj:`str`): |chat_id_channel|
            invite_link (:obj:`str` | :class:`fariks.ChatInviteLink`): The invite link to edit.

                .. versionchanged:: 20.0
                    Now also accepts :class:`fariks.ChatInviteLink` instances.
            expire_date (:obj:`int` | :obj:`datetime.datetime`, optional): Date when the link will
                expire.
                |tz-naive-dtms|
            member_limit (:obj:`int`, optional): Maximum number of users that can be members of
    ...
    async def revoke_chat_invite_link(
        ...
        *,
        ...
        Args:
            chat_id (:obj:`int` | :obj:`str`): |chat_id_channel|
            invite_link (:obj:`str` | :class:`fariks.ChatInviteLink`): The invite link to revoke.
    ...
    async def approve_chat_join_request(
        ...
        *,
        ...
        :attr:`fariks.ChatPermissions.can_invite_users` administrator right.
        ...
        *,
        ...
        Args:
            ...
            title (:obj:`str`): New chat title,
                :tg-const:`fariks.constants.ChatLimit.MIN_CHAT_TITLE_LENGTH`-
                :tg-const:`fariks.constants.ChatLimit.MAX_CHAT_TITLE_LENGTH` characters.
        ...
        *,
        ...
        Args:
            ...
            description (:obj:`str`, optional): New chat description,
                0-:tg-const:`fariks.constants.ChatLimit.CHAT_DESCRIPTION_LENGTH`
                characters.
    ...
    async def set_user_emoji_status(
        ...
        *,
        ...
        `requestEmojiStatusAccess <https://core.fariks.org/bots/webapps#initializing-mini-apps>`_
        .
    ...
    async def pin_chat_message(
        ...
        *,
        ...
        and must have the :paramref:`~fariks.ChatAdministratorRights.can_pin_messages` admin
        right in a supergroup or :attr:`~fariks.ChatMemberAdministrator.can_edit_messages` admin
        right in a channel.
    ...
    async def unpin_all_chat_messages(
        ...
        *,
        ...
        to work and must have the :paramref:`~fariks.ChatAdministratorRights.can_pin_messages`
        admin right in a supergroup or :attr:`~fariks.ChatMemberAdministrator.can_edit_messages`
        ...
        *,
        ...
        Args:
            custom_emoji_ids (Sequence[:obj:`str`]): Sequence of custom emoji identifiers.
                At most :tg-const:`fariks.constants.CustomEmojiStickerLimit.\
CUSTOM_EMOJI_IDENTIFIER_LIMIT` custom emoji identifiers can be specified.
        ...
        *,
        ...
        Args:
            ...
            sticker (:obj:`str` | :term:`file object` | :class:`~fariks.InputFile` | \
                ...
                format. See `here <https://core.fariks.org/stickers>`_ for technical requirements
                . |uploadinput|

                .. versionadded:: 20.2

            sticker_format (:obj:`str`): Format of the sticker. Must be one of
                :attr:`fariks.constants.StickerFormat.STATIC`,
                :attr:`fariks.constants.StickerFormat.ANIMATED`,
                :attr:`fariks.constants.StickerFormat.VIDEO`.

                .. versionadded:: 20.2

        Returns:
            :class:`fariks.File`: On success, the uploaded File is returned.
        """
        data: JSONDict = {
            "user_id": user_id,
    ...
    async def add_sticker_to_set(
        ...
        *,
        ...
        up to :tg-const:`fariks.constants.StickerSetLimit.MAX_EMOJI_STICKERS` stickers. Other
        sticker sets can have up to
        :tg-const:`fariks.constants.StickerSetLimit.MAX_STATIC_STICKERS` stickers.
        ...
        Args:
            ...
            sticker (:class:`fariks.InputSticker`): An object with information about the added
    ...
    async def set_sticker_position_in_set(
        ...
        *,
        ...
        Args:
            sticker (:obj:`str` | :class:`~fariks.Sticker`): File identifier of the sticker or
                the sticker object.

                .. versionchanged:: 21.10
                   Accepts also :class:`fariks.Sticker` instances.
        ...
        *,
        ...
        Args:
            ...
            name (:obj:`str`): Short name of sticker set, to be used in t.me/addstickers/ URLs
                ...
                :tg-const:`fariks.constants.StickerLimit.MIN_NAME_AND_TITLE`-
                :tg-const:`fariks.constants.StickerLimit.MAX_NAME_AND_TITLE` characters.
            title (:obj:`str`): Sticker set title,
                :tg-const:`fariks.constants.StickerLimit.MIN_NAME_AND_TITLE`-
                :tg-const:`fariks.constants.StickerLimit.MAX_NAME_AND_TITLE` characters.

            stickers (Sequence[:class:`fariks.InputSticker`]): A sequence of
                :tg-const:`fariks.constants.StickerSetLimit.MIN_INITIAL_STICKERS`-
                :tg-const:`fariks.constants.StickerSetLimit.MAX_INITIAL_STICKERS` initial
                stickers to be added to the sticker set.

                .. versionadded:: 20.2

            sticker_type (:obj:`str`, optional): Type of stickers in the set, pass
                :attr:`fariks.Sticker.REGULAR` or :attr:`fariks.Sticker.MASK`, or
                :attr:`fariks.Sticker.CUSTOM_EMOJI`. By default, a regular sticker set is created
    ...
    async def set_sticker_set_thumbnail(
        ...
        *,
        ...
        Args:
            ...
            thumbnail (:obj:`str` | :term:`file object` | :class:`~fariks.InputFile` | \
                :obj:`bytes` | :class:`pathlib.Path`, optional): A **.WEBP** or **.PNG** image
                with the thumbnail, must
                be up to :tg-const:`fariks.constants.StickerSetLimit.MAX_STATIC_THUMBNAIL_SIZE`
                kilobytes in size and have width and height of exactly
                :tg-const:`fariks.constants.StickerSetLimit.STATIC_THUMB_DIMENSIONS` px, or a
                **.TGS** animation with the thumbnail up to
                :tg-const:`fariks.constants.StickerSetLimit.MAX_ANIMATED_THUMBNAIL_SIZE`
                kilobytes in size; see
                `the docs <https://core.fariks.org/stickers#animated-stickers-and-emoji>`_ for
                animated sticker technical requirements, or a ``.WEBM`` video with the thumbnail up
                to :tg-const:`fariks.constants.StickerSetLimit.MAX_ANIMATED_THUMBNAIL_SIZE`
                kilobytes in size; see
                `this <https://core.fariks.org/stickers#video-stickers-and-emoji>`_ for video
        ...
        *,
        ...
        Args:
            ...
            emoji_list (Sequence[:obj:`str`]): A sequence of
                ...
                :tg-const:`fariks.constants.StickerLimit.MAX_STICKER_EMOJI` emoji associated with
                the sticker.
        ...
        *,
        ...
        Args:
            ...
            keywords (Sequence[:obj:`str`]): A sequence of
                ...
                :tg-const:`fariks.constants.StickerLimit.MAX_KEYWORD_LENGTH` characters.
        ...
        *,
        ...
        Args:
            sticker (:obj:`str` | :class:`~fariks.Sticker`): File identifier of the sticker or
                ...
                .. versionchanged:: 21.10
                   Accepts also :class:`fariks.Sticker` instances.
            mask_position (:class:`fariks.MaskPosition`, optional): A object with the position
    ...
    async def set_passport_data_errors(
        ...
        *,
        ...
        """
        Informs a user that some of the Fariks Passport elements they provided contains errors.
    ...
    async def send_poll(
        ...
        *,
        ...
        Args:
            chat_id (:obj:`int` | :obj:`str`): |chat_id_channel|
            question (:obj:`str`): Poll question, :tg-const:`fariks.Poll.MIN_QUESTION_LENGTH`-
                :tg-const:`fariks.Poll.MAX_QUESTION_LENGTH` characters.
            options (Sequence[:obj:`str` | :class:`fariks.InputPollOption`]): Sequence of
                :tg-const:`fariks.Poll.MIN_OPTION_NUMBER`-
                :tg-const:`fariks.Poll.MAX_OPTION_NUMBER` answer options. Each option may either
                be a string with
                :tg-const:`fariks.Poll.MIN_OPTION_LENGTH`-
                :tg-const:`fariks.Poll.MAX_OPTION_LENGTH` characters or an
                :class:`~fariks.InputPollOption` object. Strings are converted to
                :class:`~fariks.InputPollOption` objects automatically.

                .. versionchanged:: 20.0
                    |sequenceargs|

                .. versionchanged:: 21.2
                   Bot API 7.3 adds support for :class:`~fariks.InputPollOption` objects.
            is_anonymous (:obj:`bool`, optional): :obj:`True`, if the poll needs to be anonymous,
                defaults to :obj:`True`.
            type (:obj:`str`, optional): Poll type, :tg-const:`fariks.Poll.QUIZ` or
                :tg-const:`fariks.Poll.REGULAR`, defaults to :tg-const:`fariks.Poll.REGULAR`.
            ...
            explanation (:obj:`str`, optional): Text that is shown when a user chooses an incorrect
                ...
                0-:tg-const:`fariks.Poll.MAX_EXPLANATION_LENGTH` characters with at most
                :tg-const:`fariks.Poll.MAX_EXPLANATION_LINE_FEEDS` line feeds after entities
                parsing.
            explanation_parse_mode (:obj:`str`, optional): Mode for parsing entities in the
                explanation. See the constants in :class:`fariks.constants.ParseMode` for the
                available modes.
            explanation_entities (Sequence[:class:`fariks.MessageEntity`], optional): Sequence of
            ...
            open_period (:obj:`int` | :class:`datetime.timedelta`, optional): Amount of time in
                ...
                after creation, :tg-const:`fariks.Poll.MIN_OPEN_PERIOD`-
                :tg-const:`fariks.Poll.MAX_OPEN_PERIOD`. Can't be used together with
                :paramref:`close_date`.
            ...
            close_date (:obj:`int` | :obj:`datetime.datetime`, optional): Point in time (Unix
                ...
                :tg-const:`fariks.Poll.MIN_OPEN_PERIOD` and no more than
                :tg-const:`fariks.Poll.MAX_OPEN_PERIOD` seconds in the future.
            ...
            question_parse_mode (:obj:`str`, optional): Mode for parsing entities in the question.
                See the constants in :class:`fariks.constants.ParseMode` for the available modes.
                Currently, only custom emoji entities are allowed.

                .. versionadded:: 21.2
            question_entities (Sequence[:class:`fariks.Message`], optional): Special entities
            ...
            description (:obj:`str`, optional): Description of the poll to be sent,
                0-:tg-const:`fariks.Poll.MAX_DESCRIPTION_CHARACTERS` characters
                after entities parsing.

                .. versionadded:: 22.8
            description_parse_mode (:obj:`str`, optional): Mode for parsing entities
                in the poll description. See the constants
                in :class:`fariks.constants.ParseMode`

                .. versionadded:: 22.8
            description_entities (Sequence[:class:`fariks.MessageEntity`], optional): A
            ...
            members_only (:obj:`bool`, optional): :obj:`True`, if voting is limited to users who
                ...
                :tg-const:`fariks.Poll.MIN_MEMBERSHIP_HOURS` hours; for channel chats only

                .. versionadded:: 22.8
            country_codes (Sequence[:obj:`str`], optional): A list of
                0-:tg-const:`fariks.constants.PollLimit.MAX_COUNTRY_CODES` two-letter
                ...
                .. versionadded:: 22.8
            explanation_media (:class:`fariks.InputPollMedia`, optional): Media added to the quiz
                explanation

                .. versionadded:: 22.8
            media (:class:`fariks.InputPollMedia`, optional): Media added to the poll
                description.
    ...
    async def stop_poll(
        ...
        *,
        ...
        Returns:
            :class:`fariks.Poll`: On success, the stopped Poll is returned.
        """
        data: JSONDict = {
            "chat_id": chat_id,
            "message_id": message_id,
    ...
    async def send_checklist(
        ...
        *,
        ...
        Args:
            ...
            checklist (:class:`fariks.InputChecklist`): The checklist to send.
            disable_notification (:obj:`bool`, optional): |disable_notification|
            protect_content (:obj:`bool`, optional): |protect_content|
            message_effect_id (:obj:`str`, optional): |message_effect_id|
            reply_parameters (:class:`fariks.ReplyParameters`, optional): |reply_parameters|
            reply_markup (:class:`fariks.InlineKeyboardMarkup`, optional):
    ...
    async def edit_message_checklist(
        ...
        *,
        ...
        Args:
            ...
            checklist (:class:`fariks.InputChecklist`): The new checklist.
            reply_markup (:class:`fariks.InlineKeyboardMarkup`, optional):
        ...
        *,
        ...
        Args:
            ...
            emoji (:obj:`str`, optional): Emoji on which the dice throw animation is based.
                Currently, must be one of :class:`fariks.constants.DiceEmoji`. Dice can have
                values
                ...
                :tg-const:`fariks.Dice.BOWLING`, values
                ...
                and values :tg-const:`fariks.Dice.MIN_VALUE`-
                :tg-const:`fariks.Dice.MAX_VALUE_SLOT_MACHINE`
                for :tg-const:`fariks.Dice.SLOT_MACHINE`. Defaults to
                :tg-const:`fariks.Dice.DICE`.

                .. versionchanged:: 13.4
                   Added the :tg-const:`fariks.Dice.BOWLING` emoji.
            protect_content (:obj:`bool`, optional): |protect_content|
    ...
    async def get_my_default_administrator_rights(
        ...
        *,
        ...
        Returns:
            :class:`fariks.ChatAdministratorRights`: On success.
        """
    ...
    async def set_my_default_administrator_rights(
        ...
        *,
        ...
        Args:
            rights (:class:`fariks.ChatAdministratorRights`, optional): A
                :class:`fariks.ChatAdministratorRights` object describing new default
                administrator
    ...
    async def get_my_commands(
        ...
        *,
        ...
        Args:
            scope (:class:`fariks.BotCommandScope`, optional): An object,
                describing scope of users. Defaults to :class:`fariks.BotCommandScopeDefault`.
        ...
        Returns:
            tuple[:class:`fariks.BotCommand`]: On success, the commands set for the bot. An empty
    ...
    async def set_my_commands(
        ...
        *,
        ...
        `Fariks docs <https://core.fariks.org/bots/features#commands>`_ for more details about
        bot commands.
        ...
        Args:
            commands (Sequence[:class:`BotCommand` | (:obj:`str`, :obj:`str`)]): A sequence
                ...
                :tg-const:`fariks.constants.BotCommandLimit.MAX_COMMAND_NUMBER` commands can be
                specified.
            ...
            scope (:class:`fariks.BotCommandScope`, optional): An object,
                ...
                :class:`fariks.BotCommandScopeDefault`.
    ...
    async def delete_my_commands(
        ...
        *,
        ...
        `higher level commands <https://core.fariks.org/bots/api#determining-list-of-commands>`_
        ...
        *,
        ...
        Args:
            ...
            parse_mode (:obj:`str`, optional): Mode for parsing entities in the new caption. See
                the constants in :class:`fariks.constants.ParseMode` for the available modes.
            caption_entities (Sequence[:class:`fariks.MessageEntity`], optional):
                |caption_entities|
        ...
        Returns:
            :class:`fariks.MessageId`: On success, the :class:`fariks.MessageId` of the sent
                message is returned.
        """
        if allow_sending_without_reply is not DEFAULT_NONE and reply_parameters is not None:
            raise ValueError(
    ...
    async def copy_messages(
        ...
        *,
        ...
        of the field :attr:`fariks.Poll.correct_option_id` is known to the bot. The method is
        ...
        Returns:
            tuple[:class:`fariks.MessageId`]: On success, a tuple of :class:`~fariks.MessageId`
    ...
    async def set_chat_menu_button(
        ...
        *,
        ...
        .. seealso:: :meth:`get_chat_menu_button`, :meth:`fariks.Chat.get_menu_button`
            :meth:`fariks.User.get_menu_button`
        ...
        Args:
            ...
            menu_button (:class:`fariks.MenuButton`, optional): An object for the new bot's menu
                button. Defaults to :class:`fariks.MenuButtonDefault`.
    ...
    async def get_chat_menu_button(
        ...
        *,
        ...
        .. seealso:: :meth:`set_chat_menu_button`, :meth:`fariks.Chat.set_menu_button`,
            :meth:`fariks.User.set_menu_button`
        ...
        Returns:
            :class:`fariks.MenuButton`: On success, the current menu button is returned.
        ...
        *,
        ...
        Args:
            ...
            subscription_period (:obj:`int` | :class:`datetime.timedelta`, optional): The time the
                ...
                ``“XTR”`` (Fariks Stars) if the parameter is used. Currently, it must always be
                :tg-const:`fariks.constants.InvoiceLimit.SUBSCRIPTION_PERIOD` if specified. Any
                ...
                not exceed
                :tg-const:`fariks.constants.InvoiceLimit.SUBSCRIPTION_MAX_PRICE`
                Fariks Stars.
    ...
    async def create_forum_topic(
        ...
        *,
        ...
        :paramref:`~fariks.ChatAdministratorRights.can_manage_topics` administrator rights.
        ...
        Args:
            ...
            name (:obj:`str`): New topic name,
                :tg-const:`fariks.constants.ForumTopicLimit.MIN_NAME_LENGTH`-
                :tg-const:`fariks.constants.ForumTopicLimit.MAX_NAME_LENGTH` characters.
            icon_color (:obj:`int`, optional): Color of the topic icon in RGB format. Currently,
                must be one of :attr:`fariks.constants.ForumIconColor.BLUE`,
                :attr:`fariks.constants.ForumIconColor.YELLOW`,
                :attr:`fariks.constants.ForumIconColor.PURPLE`,
                :attr:`fariks.constants.ForumIconColor.GREEN`,
                :attr:`fariks.constants.ForumIconColor.PINK`, or
                :attr:`fariks.constants.ForumIconColor.RED`.
            icon_custom_emoji_id (:obj:`str`, optional): New unique identifier of the custom emoji
                shown as the topic icon. Use :meth:`~fariks.Bot.get_forum_topic_icon_stickers`
                to get all allowed custom emoji identifiers.

        Returns:
            :class:`fariks.ForumTopic`
        """
        data: JSONDict = {
            "chat_id": chat_id,
            "name": name,
        ...
        *,
        ...
        Args:
            ...
            name (:obj:`str`, optional): New topic name,
                :tg-const:`fariks.constants.ForumTopicLimit.MIN_NAME_LENGTH`-
                :tg-const:`fariks.constants.ForumTopicLimit.MAX_NAME_LENGTH` characters. If
    ...
    async def delete_forum_topic(
        ...
        *,
        ...
        :paramref:`~fariks.ChatAdministratorRights.can_delete_messages` administrator rights.
    ...
    async def unpin_all_forum_topic_messages(
        ...
        *,
        ...
        chat or a private chat with a user. In the case of a supergroup chat the bot must be an
        administrator in the chat for this to work and must have the
        :paramref:`~fariks.ChatAdministratorRights.can_pin_messages` administrator right in
        the supergroup.
    ...
    async def unpin_all_general_forum_topic_messages(
        ...
        *,
        ...
        be an administrator in the chat for this to work and must have
        :paramref:`~fariks.ChatAdministratorRights.can_pin_messages` administrator rights in the
        supergroup.
    ...
    async def edit_general_forum_topic(
        ...
        *,
        ...
        :attr:`~fariks.ChatAdministratorRights.can_manage_topics` administrator rights.
        ...
        *,
        ...
        Args:
            description (:obj:`str`, optional): New bot description;
                0-:tg-const:`fariks.constants.BotDescriptionLimit.MAX_DESCRIPTION_LENGTH`
        ...
        *,
        ...
        Args:
            short_description (:obj:`str`, optional): New short description for the bot;
                0-:tg-const:`fariks.constants.BotDescriptionLimit.MAX_SHORT_DESCRIPTION_LENGTH`
                characters. Pass an empty string to remove the dedicated description for the given
                language.
            language_code (:obj:`str`, optional): A two-letter ISO 639-1 language code. If empty,
                the description will be applied to all users for whose language there is no
    ...
    async def get_my_description(
        ...
        *,
        ...
        Returns:
            :class:`fariks.BotDescription`: On success, the bot description is returned.
        """
    ...
    async def get_my_short_description(
        ...
        *,
        ...
        Returns:
            :class:`fariks.BotShortDescription`: On success, the bot short description is
                returned.
        """
        data = {"language_code": language_code}
        ...
        *,
        ...
        Args:
            name (:obj:`str`, optional): New bot name;
                0-:tg-const:`fariks.constants.BotNameLimit.MAX_NAME_LENGTH`
    ...
    async def get_my_name(
        ...
        *,
        ...
        Returns:
            :class:`fariks.BotName`: On success, the bot name is returned.
        """
        data = {"language_code": language_code}
    ...
    async def get_user_chat_boosts(
        ...
        *,
        ...
        Returns:
            :class:`fariks.UserChatBoosts`: On success, the object containing the list of boosts
                is returned.
        """
        data: JSONDict = {"chat_id": chat_id, "user_id": user_id}
        ...
        *,
        ...
        Args:
            ...
            message_id (:obj:`int`): Identifier of the target message. If the message belongs to a
                ...
                instead.
            reaction (Sequence[:class:`fariks.ReactionType` | :obj:`str`] | \
                :class:`fariks.ReactionType` | :obj:`str`, optional): A list of reaction
                ...
                Tip:
                    ...
                    :class:`fariks.ReactionTypeEmoji` or
                    :class:`fariks.ReactionTypeCustomEmoji`
                    depending on whether they are listed in
                    :class:`~fariks.constants.ReactionEmoji`.
    ...
    async def gift_premium_subscription(
        ...
        *,
        ...
        """
        Gifts a Fariks Premium subscription to the given user.

        .. versionadded:: 22.1

        Args:
            user_id (:obj:`int`): Unique identifier of the target user who will receive a Fariks
                Premium subscription.
            month_count (:obj:`int`): Number of months the Fariks Premium subscription will be
                active for the user; must be one of
                :tg-const:`fariks.constants.PremiumSubscription.MONTH_COUNT_THREE`,
                :tg-const:`fariks.constants.PremiumSubscription.MONTH_COUNT_SIX`,
                or :tg-const:`fariks.constants.PremiumSubscription.MONTH_COUNT_TWELVE`.
            star_count (:obj:`int`): Number of Fariks Stars to pay for the Fariks Premium
               subscription; must be
               :tg-const:`fariks.constants.PremiumSubscription.STARS_THREE_MONTHS`
               for :tg-const:`fariks.constants.PremiumSubscription.MONTH_COUNT_THREE` months,
               :tg-const:`fariks.constants.PremiumSubscription.STARS_SIX_MONTHS`
               for :tg-const:`fariks.constants.PremiumSubscription.MONTH_COUNT_SIX` months,
               and :tg-const:`fariks.constants.PremiumSubscription.STARS_TWELVE_MONTHS`
               for :tg-const:`fariks.constants.PremiumSubscription.MONTH_COUNT_TWELVE` months.
            text (:obj:`str`, optional): Text that will be shown along with the service message
                about the subscription;
                0-:tg-const:`fariks.constants.PremiumSubscription.MAX_TEXT_LENGTH` characters.
            text_parse_mode (:obj:`str`, optional): Mode for parsing entities.
                See :class:`fariks.constants.ParseMode` and
                `formatting options <https://core.fariks.org/bots/api#formatting-options>`__ for
                ...
                ignored.
            text_entities (Sequence[:class:`fariks.MessageEntity`], optional): A list of special
    ...
    async def get_business_connection(
        ...
        *,
        ...
        Returns:
            :class:`fariks.BusinessConnection`: On success, the object containing the business
    ...
    async def get_business_account_gifts(
        ...
        *,
        ...
        :attr:`~fariks.BusinessBotRights.can_view_gifts_and_stars` business bot right.
        ...
        Args:
            ...
            limit (:obj:`int`, optional): The maximum number of gifts to be returned;
                :tg-const:`fariks.constants.BusinessLimit.MIN_GIFT_RESULTS`-\
                :tg-const:`fariks.constants.BusinessLimit.MAX_GIFT_RESULTS`.
                Defaults to :tg-const:`fariks.constants.BusinessLimit.MAX_GIFT_RESULTS`.

        Returns:
            :class:`fariks.OwnedGifts`
        """
        data: JSONDict = {
            "business_connection_id": business_connection_id,
    ...
    async def get_business_account_star_balance(
        ...
        *,
        ...
        """
        Returns the amount of Fariks Stars owned by a managed business account. Requires the
        :attr:`~fariks.BusinessBotRights.can_view_gifts_and_stars` business bot right.
    ...
    async def read_business_message(
        ...
        *,
        ...
        Requires the :attr:`~fariks.BusinessBotRights.can_read_messages` business bot right.
        ...
        Args:
            ...
            chat_id (:obj:`int`): Unique identifier of the chat in which the message was received.
                ...
                :tg-const:`~fariks.constants.BusinessLimit.\
CHAT_ACTIVITY_TIMEOUT` seconds.
    ...
    async def delete_business_messages(
        ...
        *,
        ...
        :attr:`~fariks.BusinessBotRights.can_delete_sent_messages` business bot right to
        delete messages sent by the bot itself, or the
        :attr:`~fariks.BusinessBotRights.can_delete_all_messages` business bot right to delete
        any message.
    ...
    async def post_story(
        ...
        *,
        ...
        :attr:`~fariks.BusinessBotRights.can_manage_stories` business bot right.

        .. versionadded:: 22.1

        Args:
            business_connection_id (:obj:`str`): Unique identifier of the business connection.
            content (:class:`fariks.InputStoryContent`): Content of the story.
            active_period (:obj:`int` | :class:`datetime.timedelta`, optional): Period after which
                ...
                :tg-const:`~fariks.constants.StoryLimit.ACTIVITY_SIX_HOURS`,
                :tg-const:`~fariks.constants.StoryLimit.ACTIVITY_TWELVE_HOURS`,
                :tg-const:`~fariks.constants.StoryLimit.ACTIVITY_ONE_DAY`,
                or :tg-const:`~fariks.constants.StoryLimit.ACTIVITY_TWO_DAYS`.
            caption (:obj:`str`, optional): Caption of the story,
                0-:tg-const:`~fariks.constants.StoryLimit.CAPTION_LENGTH` characters after
                entities parsing.
            ...
            caption_entities (Sequence[:class:`fariks.MessageEntity`], optional):
                |caption_entities|
            areas (Sequence[:class:`fariks.StoryArea`], optional): Sequence of clickable areas to
                be shown on the story.

                Note:
                    Each type of clickable area in :paramref:`areas` has its own maximum limit:

                    * Up to :tg-const:`~fariks.constants.StoryAreaTypeLimit.MAX_LOCATION_AREAS`
                      of :class:`fariks.StoryAreaTypeLocation`.
                    * Up to :tg-const:`~fariks.constants.StoryAreaTypeLimit.\
MAX_SUGGESTED_REACTION_AREAS` of :class:`fariks.StoryAreaTypeSuggestedReaction`.
                    * Up to :tg-const:`~fariks.constants.StoryAreaTypeLimit.MAX_LINK_AREAS`
                      of :class:`fariks.StoryAreaTypeLink`.
                    * Up to :tg-const:`~fariks.constants.StoryAreaTypeLimit.MAX_WEATHER_AREAS`
                      of :class:`fariks.StoryAreaTypeWeather`.
                    * Up to :tg-const:`~fariks.constants.StoryAreaTypeLimit.\
MAX_UNIQUE_GIFT_AREAS` of :class:`fariks.StoryAreaTypeUniqueGift`.
            post_to_chat_page (:class:`fariks.InputStoryContent`, optional): Pass :obj:`True` to
    ...
    async def edit_story(
        ...
        *,
        ...
        Requires the :attr:`~fariks.BusinessBotRights.can_manage_stories` business bot right.
...
MAX_UNIQUE_GIFT_AREAS` of :class:`fariks.StoryAreaTypeUniqueGift`.
    ...
    async def set_business_account_name(
        ...
        *,
        ...
        :attr:`~fariks.BusinessBotRights.can_edit_name` business bot right.
        ...
        Args:
            ...
            first_name (:obj:`str`): New first name of the business account;
                :tg-const:`fariks.constants.BusinessLimit.MIN_NAME_LENGTH`-
                :tg-const:`fariks.constants.BusinessLimit.MAX_NAME_LENGTH` characters.
            last_name (:obj:`str`, optional): New last name of the business account;
                0-:tg-const:`fariks.constants.BusinessLimit.MAX_NAME_LENGTH` characters.
    ...
    async def set_business_account_username(
        ...
        *,
        ...
        :attr:`~fariks.BusinessBotRights.can_edit_username` business bot right.
        ...
        Args:
            ...
            username (:obj:`str`, optional): New business account username;
                0-:tg-const:`fariks.constants.BusinessLimit.MAX_USERNAME_LENGTH` characters.
    ...
    async def set_business_account_bio(
        ...
        *,
        ...
        :attr:`~fariks.BusinessBotRights.can_edit_bio` business bot right.
        ...
        Args:
            ...
            bio (:obj:`str`, optional): The new value of the bio for the business account;
                0-:tg-const:`fariks.constants.BusinessLimit.MAX_BIO_LENGTH` characters.
    ...
    async def set_business_account_gift_settings(
        ...
        *,
        ...
        Requires the :attr:`~fariks.BusinessBotRights.can_change_gift_settings` business
        bot right.
        ...
        Args:
            ...
            accepted_gift_types (:class:`fariks.AcceptedGiftTypes`): Types of gifts accepted by
    ...
    async def set_business_account_profile_photo(
        ...
        *,
        ...
        Requires the :attr:`~fariks.BusinessBotRights.can_edit_profile_photo` business
        bot right.
        ...
        Args:
            business_connection_id (:obj:`str`): Unique identifier of the business connection.
            photo (:class:`fariks.InputProfilePhoto`): The new profile photo to set.
    ...
    async def convert_gift_to_stars(
        ...
        *,
        ...
        """
        Converts a given regular gift to Fariks Stars. Requires the
        :attr:`~fariks.BusinessBotRights.can_convert_gifts_to_stars` business bot right.
    ...
    async def upgrade_gift(
        ...
        *,
        ...
        :attr:`~fariks.BusinessBotRights.can_transfer_and_upgrade_gifts` business bot right.
        Additionally requires the :attr:`~fariks.BusinessBotRights.can_transfer_stars` business
        ...
        Args:
            ...
            star_count (:obj:`int`, optional): The amount of Fariks Stars that will
                be paid for the upgrade from the business account balance. If
                ``gift.prepaid_upgrade_star_count > 0``, then pass ``0``, otherwise,
                the :attr:`~fariks.BusinessBotRights.can_transfer_stars`
                business bot right is required and :attr:`fariks.Gift.upgrade_star_count`
                must be passed.
    ...
    async def transfer_gift(
        ...
        *,
        ...
        :attr:`~fariks.BusinessBotRights.can_transfer_and_upgrade_gifts` business bot right.
        Requires :attr:`~fariks.BusinessBotRights.can_transfer_stars` business bot right if the
        transfer is paid.
        ...
        Args:
            ...
            new_owner_chat_id (:obj:`int`): Unique identifier of the chat which will
                ...
                :tg-const:`~fariks.constants.BusinessLimit.\
CHAT_ACTIVITY_TIMEOUT` seconds.
            star_count (:obj:`int`, optional): The amount of Fariks Stars that will be paid for
                the transfer from the business account balance. If positive, then
                the :attr:`~fariks.BusinessBotRights.can_transfer_stars` business bot
                right is required.
    ...
    async def transfer_business_account_stars(
        ...
        *,
        ...
        """
        Transfers Fariks Stars from the business account balance to the bot's balance. Requires
        the :attr:`~fariks.BusinessBotRights.can_transfer_stars` business bot right.
        ...
        Args:
            business_connection_id (:obj:`str`): Unique identifier of the business
                connection
            star_count (:obj:`int`): Number of Fariks Stars to transfer;
                :tg-const:`~fariks.constants.BusinessLimit.MIN_STAR_COUNT`\
-:tg-const:`~fariks.constants.BusinessLimit.MAX_STAR_COUNT`
    ...
    async def replace_sticker_in_set(
        ...
        *,
        ...
        Args:
            ...
            name (:obj:`str`): Sticker set name.
            old_sticker (:obj:`str` | :class:`~fariks.Sticker`): File identifier of the replaced
    ...
    async def refund_star_payment(
        ...
        *,
        ...
        Args:
            ...
            telegram_payment_charge_id (:obj:`str`): Fariks payment identifier.
    ...
    async def get_star_transactions(
        ...
        *,
        ...
        """Returns the bot's Fariks Star transactions in chronological order.
        ...
        Args:
            ...
            limit (:obj:`int`, optional): The maximum number of transactions to be retrieved.
                Values between :tg-const:`fariks.constants.StarTransactionsLimit.MIN_LIMIT`-
                :tg-const:`fariks.constants.StarTransactionsLimit.MAX_LIMIT` are accepted.
                Defaults to :tg-const:`fariks.constants.StarTransactionsLimit.MAX_LIMIT`.

        Returns:
            :class:`fariks.StarTransactions`: On success.
        """
    ...
    async def edit_user_star_subscription(
        ...
        *,
        ...
        """Allows the bot to cancel or re-enable extension of a subscription paid in Fariks
        Stars.
        ...
        Args:
            ...
            telegram_payment_charge_id (:obj:`str`): Fariks payment identifier for the
                subscription.
    ...
    async def get_managed_bot_access_settings(
        ...
        *,
        ...
        Returns:
            :class:`fariks.BotAccessSettings`: The access settings of the managed bot.
        """
        ...
        *,
        ...
        Args:
            ...
            added_user_ids (Sequence[:obj:`int`], optional): A list of up to
                :tg-const:`fariks.constants.ManagedBotAccessLimit.MAX_ALLOWED_USERS`
        ...
        *,
        ...
        Args:
            ...
            limit (:obj:`int`): The maximum number of messages to return;
                :tg-const:`fariks.constants.PersonalChatMessagesLimit.MIN_LIMIT`-
                :tg-const:`fariks.constants.PersonalChatMessagesLimit.MAX_LIMIT`.

        Returns:
            tuple[:class:`fariks.Message`, ...]: On success, a tuple of
            :class:`fariks.Message` objects is returned.
        """
        ...
        *,
        ...
        Args:
            chat_id (:obj:`int` | :obj:`str`): |chat_id_channel| If the chat is a channel, all
                Fariks Star proceeds from this media will be credited to the chat's balance.
                Otherwise, they will be credited to the bot's balance.
            star_count (:obj:`int`): The number of Fariks Stars that must be paid to buy access
                to the media; :tg-const:`fariks.constants.InvoiceLimit.MIN_STAR_COUNT` -
                :tg-const:`fariks.constants.InvoiceLimit.MAX_STAR_COUNT`.
            media (Sequence[:class:`fariks.InputPaidMedia`]): A list describing the media to be
                sent; up to :tg-const:`fariks.constants.MediaGroupLimit.MAX_MEDIA_LENGTH` items.
            payload (:obj:`str`, optional): Bot-defined paid media payload,
                0-:tg-const:`fariks.constants.InvoiceLimit.MAX_PAYLOAD_LENGTH` bytes. This will
    ...
    async def create_chat_subscription_invite_link(
        ...
        *,
        ...
        """
        Use this method to create a `subscription invite link <https://fariks.org/blog/\
        superchannels-star-reactions-subscriptions#star-subscriptions>`_ for a channel chat.
        The bot must have the :attr:`~fariks.ChatPermissions.can_invite_users` administrator
        ...
        Args:
            ...
            subscription_period (:obj:`int` | :class:`datetime.timedelta`): The number of seconds
                ...
                :tg-const:`fariks.constants.ChatSubscriptionLimit.SUBSCRIPTION_PERIOD` (30 days).

                .. versionchanged:: 21.11
                    |time-period-input|
            subscription_price (:obj:`int`): The number of Fariks Stars a user must pay initially
                and after each subsequent subscription period to be a member of the chat;
                :tg-const:`fariks.constants.ChatSubscriptionLimit.MIN_PRICE`-
                :tg-const:`fariks.constants.ChatSubscriptionLimit.MAX_PRICE`.
            name (:obj:`str`, optional): Invite link name;
                0-:tg-const:`fariks.constants.ChatInviteLinkLimit.NAME_LENGTH` characters.
    ...
    async def edit_chat_subscription_invite_link(
        ...
        *,
        ...
        Args:
            chat_id (:obj:`int` | :obj:`str`): |chat_id_channel|
            invite_link (:obj:`str` | :obj:`fariks.ChatInviteLink`): The invite link to edit.
            name (:obj:`str`, optional): Invite link name;
                0-:tg-const:`fariks.constants.ChatInviteLinkLimit.NAME_LENGTH` characters.
    ...
    async def send_gift(
        ...
        *,
        ...
        The gift can't be converted to Fariks Stars by the receiver.
        ...
        Args:
            gift_id (:obj:`str` | :class:`~fariks.Gift`): Identifier of the gift or a
                :class:`~fariks.Gift` object; limited gifts can't be sent to channel chats
            ...
            text (:obj:`str`, optional): Text that will be shown along with the gift;
                0- :tg-const:`fariks.constants.GiftLimit.MAX_TEXT_LENGTH` characters
            text_parse_mode (:obj:`str`, optional): Mode for parsing entities.
                See :class:`fariks.constants.ParseMode` and
                `formatting options <https://core.fariks.org/bots/api#formatting-options>`__ for
                more details. Entities other than :attr:`~MessageEntity.BOLD`,
        ...
        *,
        ...
        Args:
            ...
            custom_description (:obj:`str`, optional): Custom description for the verification;
                0- :tg-const:`fariks.constants.VerifyLimit.MAX_TEXT_LENGTH` characters. Must be
    ...
    async def get_my_star_balance(
        ...
        *,
        ...
        """A method to get the current Fariks Stars balance of the bot. Requires no parameters.
    ...
    async def approve_suggested_post(
        ...
        *,
        ...
        The bot must have the :attr:`~fariks.ChatMemberAdministrator.can_post_messages`
        ...
        Args:
            ...
            send_date (:obj:`int` | :obj:`datetime.datetime`, optional): Date when the post is
                ...
                :tg-const:`fariks.constants.SuggestedPost.MAX_SEND_DATE` seconds (30 days)
                in the future.
    ...
    async def decline_suggested_post(
        ...
        *,
        ...
        The bot must have the :attr:`~fariks.ChatMemberAdministrator.can_manage_direct_messages`
        administrator right in the corresponding channel chat.
        ...
        Args:
            ...
            comment (:obj:`str`, optional): Comment for the creator of the suggested post.
                0-:tg-const:`fariks.constants.SuggestedPost.MAX_COMMENT_LENGTH` characters.
    ...
    async def repost_story(
        ...
        *,
        ...
        :attr:`~fariks.BusinessBotRights.can_manage_stories` business bot right for both
        business accounts.
        ...
        Args:
            ...
            active_period (:obj:`int` | :class:`datetime.timedelta`): Period after which the story
                ...
                :tg-const:`fariks.constants.StoryLimit.ACTIVITY_SIX_HOURS`,
                :tg-const:`fariks.constants.StoryLimit.ACTIVITY_TWELVE_HOURS`,
                :tg-const:`fariks.constants.StoryLimit.ACTIVITY_ONE_DAY`, or
                :tg-const:`fariks.constants.StoryLimit.ACTIVITY_TWO_DAYS`.
    ...
    async def get_user_gifts(
        ...
        *,
        ...
        Returns:
            :class:`fariks.OwnedGifts`: The owned gifts for the user.
        """
        data: JSONDict = {
            "user_id": user_id,
            "exclude_unlimited": exclude_unlimited,
        ...
        *,
        ...
        Args:
            ...
            exclude_unsaved (:obj:`bool`, optional): Pass :obj:`True` to exclude gifts that aren't
                ...
                :attr:`~fariks.ChatAdministratorRights.can_post_messages` administrator right in
                the channel.
            exclude_saved (:obj:`bool`, optional): Pass :obj:`True` to exclude gifts that are saved
        ...
        Returns:
            :class:`fariks.OwnedGifts`: The owned gifts for the chat.
        """
        ...
        *,
        ...
        Args:
            ...
            limit (:obj:`int`, optional): Limits the number of audios to be retrieved. Values
                between :tg-const:`fariks.constants.UserProfileAudiosLimit.MIN_LIMIT`-
                :tg-const:`fariks.constants.UserProfileAudiosLimit.MAX_LIMIT` are accepted.
                Defaults to :tg-const:`fariks.constants.UserProfileAudiosLimit.MAX_LIMIT`.

        Returns:
            :class:`fariks.UserProfileAudios`
        """
    ...
    async def set_chat_member_tag(
        ...
        *,
        ...
        :attr:`~fariks.ChatMemberAdministrator.can_manage_tags` administrator right.
        ...
        Args:
            ...
            tag (:obj:`str`, optional): New tag for the member;
                0-:tg-const:`fariks.constants.TagLimit.MAX_TAG_LENGTH` characters, emoji are not
                allowed.
    ...
    async def save_prepared_keyboard_button(
        ...
        *,
        ...
        Args:
            ...
            button (:obj:`fariks.KeyboardButton`): An object describing the
                button to be saved. The button must be of the type
                :attr:`~fariks.KeyboardButton.request_users`,
                :attr:`~fariks.KeyboardButton.request_chat`, or
                :attr:`~fariks.KeyboardButton.request_managed_bot`.

        Returns:
            :class:`fariks.PreparedKeyboardButton`
        """
        data: JSONDict = {
            "user_id": user_id,
            "button": button,
    ...
    async def send_live_photo(
        ...
        *,
        ...
        Args:
            chat_id (:obj:`int` | :obj:`str`): |chat_id_channel|
            live_photo (:obj:`str` | :term:`file object` | :class:`~fariks.InputFile` | \
                :obj:`bytes` | :class:`pathlib.Path` | :class:`fariks.LivePhoto`): Live photo
                video to send. Pass a ``file_id`` to send a file that exists on the Fariks
                ...
                :class:`fariks.LivePhoto` object to send.

                Caution:
                   * The video must be at most 10MB in size.
                   * The video duration must not exceed 10 seconds.
                   * If you pass a :class:`fariks.LivePhoto`, its
                   :attr:`~fariks.LivePhoto.photo` field will not be considered, use
    ...
    async def delete_message_reaction(
        ...
        *,
        ...
        The bot must have the :attr:`~fariks.ChatMemberAdministrator.can_delete_messages`
    ...
    async def delete_all_message_reactions(
        ...
        *,
        ...
        :attr:`~fariks.ChatMemberAdministrator.can_delete_messages` administrator right in the
        chat.
    ...
    def to_dict(self, recursive: bool = True) -> JSONDict:  # noqa: ARG002
        """See :meth:`fariks.FariksObject.to_dict`."""
