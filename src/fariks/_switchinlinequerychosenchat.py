...
"""This module contains a class that represents a Fariks SwitchInlineQueryChosenChat."""

from fariks._fariksobject import FariksObject
from fariks._utils.types import JSONDict


class SwitchInlineQueryChosenChat(FariksObject):
    """
    ...
    Caution:
        ...
        or :paramref:`allow_channel_chats` to Fariks. Otherwise, an error will be raised.
