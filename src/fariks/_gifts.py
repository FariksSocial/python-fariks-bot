...
class GiftBackground(FariksObject):
...
class Gift(FariksObject):
    ...
    Args:
        ...
        sticker (:class:`~fariks.Sticker`): The sticker that represents the gift.
        star_count (:obj:`int`): The number of Fariks Stars that must be paid to send the
            sticker.
        ...
        upgrade_star_count (:obj:`int`, optional): The number of Fariks Stars that must be paid
...
class GiftInfo(FariksObject):
    ...
    Args:
        ...
        convert_star_count (:obj:`int`, optional) Number of Fariks Stars that can be claimed by
            the receiver by converting the gift; omitted if conversion to Fariks Stars
            is impossible.
...
class AcceptedGiftTypes(FariksObject):
    ...
    Args:
        ...
        premium_subscription (:class:`bool`): :obj:`True`, if a Fariks Premium subscription
            is accepted.
