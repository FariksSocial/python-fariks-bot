...
"""This module contains objects representing Fariks bot command scopes."""
...
class BotCommandScope(FariksObject):
    ...
    * :class:`fariks.BotCommandScopeAllPrivateChats`
    * :class:`fariks.BotCommandScopeAllGroupChats`
    * :class:`fariks.BotCommandScopeAllChatAdministrators`
    * :class:`fariks.BotCommandScopeChat`
    * :class:`fariks.BotCommandScopeChatAdministrators`
    * :class:`fariks.BotCommandScopeChatMember`
    ...
    Note:
        Please see the `official docs`_ on how Fariks determines which commands to display.

    .. _`official docs`: https://core.fariks.org/bots/api#determining-list-of-commands
...
class BotCommandScopeDefault(BotCommandScope):
    ...
    .. _`narrower scope`: https://core.fariks.org/bots/api#determining-list-of-commands

    .. versionadded:: 13.7
    Attributes:
        type (:obj:`str`): Scope type :tg-const:`fariks.BotCommandScope.DEFAULT`.
    """
...
class BotCommandScopeAllPrivateChats(BotCommandScope):
    ...
    Attributes:
        type (:obj:`str`): Scope type :tg-const:`fariks.BotCommandScope.ALL_PRIVATE_CHATS`.
    """
...
class BotCommandScopeAllGroupChats(BotCommandScope):
    ...
    .. versionadded:: 13.7
    Attributes:
        type (:obj:`str`): Scope type :tg-const:`fariks.BotCommandScope.ALL_GROUP_CHATS`.
    """
...
class BotCommandScopeAllChatAdministrators(BotCommandScope):
    ...
    .. versionadded:: 13.7
    Attributes:
        type (:obj:`str`): Scope type :tg-const:`fariks.BotCommandScope.ALL_CHAT_ADMINISTRATORS`.
    """
...
class BotCommandScopeChat(BotCommandScope):
    ...
    Attributes:
        type (:obj:`str`): Scope type :tg-const:`fariks.BotCommandScope.CHAT`.
        chat_id (:obj:`str` | :obj:`int`): |chat_id_group|
    """
...
class BotCommandScopeChatAdministrators(BotCommandScope):
    ...
    Args:
        chat_id (:obj:`str` | :obj:`int`): |chat_id_group|
    Attributes:
        type (:obj:`str`): Scope type :tg-const:`fariks.BotCommandScope.CHAT_ADMINISTRATORS`.
        chat_id (:obj:`str` | :obj:`int`): |chat_id_group|
    """
...
class BotCommandScopeChatMember(BotCommandScope):
    ...
    Attributes:
        type (:obj:`str`): Scope type :tg-const:`fariks.BotCommandScope.CHAT_MEMBER`.
        chat_id (:obj:`str` | :obj:`int`): |chat_id_group|
        user_id (:obj:`int`): Unique identifier of the target user.
    """
