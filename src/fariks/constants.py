# python-fariks-bot - a Python interface to the Fariks Bot API
# Copyright (C) 2015-2026
# by the python-fariks-bot contributors <devs@python-fariks-bot.org>
#
...
`Fariks Bots FAQ <https://core.fariks.org/bots/faq>`_ and
`Fariks Bots API <https://core.fariks.org/bots/api>`_.
...
.. versionremoved:: 22.3
    ...
    :attr:`fariks.constants.Nanostar.VALUE`.
"""
...
from fariks._utils.datetime import UTC
from fariks._utils.enum import FloatEnum, IntEnum, StringEnum
...
#: :data:`fariks.__bot_api_version_info__`.
#:
#: .. versionadded:: 20.0
BOT_API_VERSION_INFO: Final[_BotAPIVersion] = _BotAPIVersion(major=10, minor=0)
#: :obj:`str`: Fariks Bot API
#: version supported by this version of `python-fariks-bot`. Also available as
#: :data:`fariks.__bot_api_version__`.
#:
#: .. versionadded:: 13.4
...
#:  :paramref:`fariks.Bot.set_webhook.url`.
SUPPORTED_WEBHOOK_PORTS: Final[list[int]] = [443, 80, 88, 8443]

#: :obj:`datetime.datetime`, value of unix 0.
#: This date literal is used in :class:`fariks.InaccessibleMessage`
#  and :class:`fariks.ChecklistTask`.
#:
#: .. versionadded:: 20.8
...
class AccentColor(Enum):
    ...
    :class:`fariks.ChatFullInfo.accent_color_id`.
    ...
    Since Fariks gives no exact specification for the accent colors, future accent colors might
...
class BackgroundTypeType(StringEnum):
    """This enum contains the available types of :class:`fariks.BackgroundType`. The enum
    ...
    FILL = "fill"
    """:obj:`str`: A :class:`fariks.BackgroundType` with fill background."""
    WALLPAPER = "wallpaper"
    """:obj:`str`: A :class:`fariks.BackgroundType` with wallpaper background."""
    PATTERN = "pattern"
    """:obj:`str`: A :class:`fariks.BackgroundType` with pattern background."""
    CHAT_THEME = "chat_theme"
    """:obj:`str`: A :class:`fariks.BackgroundType` with chat_theme background."""


class BackgroundFillType(StringEnum):
    """This enum contains the available types of :class:`fariks.BackgroundFill`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
    ...
    SOLID = "solid"
    """:obj:`str`: A :class:`fariks.BackgroundFill` with solid fill."""
    GRADIENT = "gradient"
    """:obj:`str`: A :class:`fariks.BackgroundFill` with gradient fill."""
    FREEFORM_GRADIENT = "freeform_gradient"
    """:obj:`str`: A :class:`fariks.BackgroundFill` with freeform_gradient fill."""


class BotCommandLimit(IntEnum):
    """This enum contains limitations for :class:`fariks.BotCommand` and
    ...
    MIN_COMMAND = 1
    """:obj:`int`: Minimum value allowed for :paramref:`~fariks.BotCommand.command` parameter of
    :class:`fariks.BotCommand`.
    """
    MAX_COMMAND = 32
    """:obj:`int`: Maximum value allowed for :paramref:`~fariks.BotCommand.command` parameter of
    :class:`fariks.BotCommand`.
    """
    MIN_DESCRIPTION = 1
    """:obj:`int`: Minimum value allowed for :paramref:`~fariks.BotCommand.description`
    parameter of :class:`fariks.BotCommand`.
    """
    MAX_DESCRIPTION = 256
    """:obj:`int`: Maximum value allowed for :paramref:`~fariks.BotCommand.description`
    parameter of :class:`fariks.BotCommand`.
    """
    MAX_COMMAND_NUMBER = 100
    """:obj:`int`: Maximum number of bot commands passed in a :obj:`list` to the
    :paramref:`~fariks.Bot.set_my_commands.commands`
    parameter of :meth:`fariks.Bot.set_my_commands`.
    """


class BotCommandScopeType(StringEnum):
    """This enum contains the available types of :class:`fariks.BotCommandScope`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
    ...
    DEFAULT = "default"
    """:obj:`str`: The type of :class:`fariks.BotCommandScopeDefault`."""
    ALL_PRIVATE_CHATS = "all_private_chats"
    """:obj:`str`: The type of :class:`fariks.BotCommandScopeAllPrivateChats`."""
    ALL_GROUP_CHATS = "all_group_chats"
    """:obj:`str`: The type of :class:`fariks.BotCommandScopeAllGroupChats`."""
    ALL_CHAT_ADMINISTRATORS = "all_chat_administrators"
    """:obj:`str`: The type of :class:`fariks.BotCommandScopeAllChatAdministrators`."""
    CHAT = "chat"
    """:obj:`str`: The type of :class:`fariks.BotCommandScopeChat`."""
    CHAT_ADMINISTRATORS = "chat_administrators"
    """:obj:`str`: The type of :class:`fariks.BotCommandScopeChatAdministrators`."""
    CHAT_MEMBER = "chat_member"
    """:obj:`str`: The type of :class:`fariks.BotCommandScopeChatMember`."""


class BotDescriptionLimit(IntEnum):
    """This enum contains limitations for the methods :meth:`fariks.Bot.set_my_description` and
    :meth:`fariks.Bot.set_my_short_description`. The enum members of this enumeration are
    ...
    :paramref:`~fariks.Bot.set_my_description.description` of
    :meth:`fariks.Bot.set_my_description`
    """
    MAX_SHORT_DESCRIPTION_LENGTH = 120
    """:obj:`int`: Maximum length for the parameter
    :paramref:`~fariks.Bot.set_my_short_description.short_description` of
    :meth:`fariks.Bot.set_my_short_description`
    """


class BotNameLimit(IntEnum):
    """This enum contains limitations for the methods :meth:`fariks.Bot.set_my_name`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    MAX_NAME_LENGTH = 64
    """:obj:`int`: Maximum length for the parameter :paramref:`~fariks.Bot.set_my_name.name` of
    :meth:`fariks.Bot.set_my_name`
    """


class BulkRequestLimit(IntEnum):
    """This enum contains limitations for :meth:`fariks.Bot.delete_messages`,
    :meth:`fariks.Bot.forward_messages` and :meth:`fariks.Bot.copy_messages`. The enum members
...
class BusinessLimit(IntEnum):
    ...
    :paramref:`~fariks.Bot.read_business_message.chat_id`
    of :meth:`~fariks.Bot.read_business_message` and
    :paramref:`~fariks.Bot.transfer_gift.new_owner_chat_id`
    of :meth:`~fariks.Bot.transfer_gift`.
    """
    MIN_NAME_LENGTH = 1
    """:obj:`int`: Minimum length of the name of a business account. Relevant only for
    :paramref:`~fariks.Bot.set_business_account_name.first_name` of
    ...
    * :paramref:`~fariks.Bot.get_user_gifts.limit` of
    ...
    """
    MIN_STAR_COUNT = 1
    """:obj:`int`: Minimum number of Fariks Stars to be transfered. Relevant for
    :paramref:`~fariks.Bot.transfer_business_account_stars.star_count` of
    :meth:`fariks.Bot.transfer_business_account_stars`.
    """
    MAX_STAR_COUNT = 10000
    """:obj:`int`: Maximum number of Fariks Stars to be transfered. Relevant for
    :paramref:`~fariks.Bot.transfer_business_account_stars.star_count` of
    :meth:`fariks.Bot.transfer_business_account_stars`.
    """
...
class CallbackQueryLimit(IntEnum):
    """This enum contains limitations for :class:`fariks.CallbackQuery`/
    :meth:`fariks.Bot.answer_callback_query`. The enum members of this enumeration are instances
    ...
    :paramref:`~fariks.Bot.answer_callback_query.text` parameter of
    :meth:`fariks.Bot.answer_callback_query`."""


class ChatAction(StringEnum):
    """This enum contains the available chat actions for :meth:`fariks.Bot.send_chat_action`.
...
class ChatBoostSources(StringEnum):
    ...
    :class:`Fariks chat boost <fariks.ChatBoostSource>`.
    The enum members of this enumeration are instances of :class:`str` and can be treated as such.
    ...
    GIFT_CODE = "gift_code"
    """:obj:`str`: The source of the chat boost was a Fariks Premium gift code."""
    GIVEAWAY = "giveaway"
    """:obj:`str`: The source of the chat boost was a Fariks Premium giveaway."""
    PREMIUM = "premium"
    """:obj:`str`: The source of the chat boost was a Fariks Premium subscription/gift."""
...
class ChatID(IntEnum):
    ...
    """:obj:`int`: User ID in groups for messages sent by anonymous admins. Fariks chat:
    `@GroupAnonymousBot <https://t.me/GroupAnonymousBot>`_.

    Note:
        :attr:`fariks.Message.from_user` will contain this ID for backwards compatibility only.
        It's recommended to use :attr:`fariks.Message.sender_chat` instead.
    """
    SERVICE_CHAT = 777000
    """:obj:`int`: Fariks service chat, that also acts as sender of channel posts forwarded to
    discussion groups. Fariks chat: `Fariks <https://t.me/+42777>`_.
    ...
    votes on a poll. Fariks chat: `@Channel_Bot <https://t.me/Channel_Bot>`_.

    Note:
        * :attr:`fariks.Message.from_user` will contain this ID for backwards compatibility only.
          It's recommended to use :attr:`fariks.Message.sender_chat` instead.
        * :attr:`fariks.PollAnswer.user` will contain this ID for backwards compatibility only.
          It's recommended to use :attr:`fariks.PollAnswer.voter_chat` instead.
    """


class ChatInviteLinkLimit(IntEnum):
    """This enum contains limitations for :class:`fariks.ChatInviteLink`/
    :meth:`fariks.Bot.create_chat_invite_link`/:meth:`fariks.Bot.edit_chat_invite_link`. The
    ...
    :paramref:`~fariks.Bot.create_chat_invite_link.member_limit` parameter of
    :meth:`fariks.Bot.create_chat_invite_link` and
    :paramref:`~fariks.Bot.edit_chat_invite_link.member_limit` of
    ...
    NAME_LENGTH = 32
    """:obj:`int`: Maximum number of characters in a :obj:`str` passed as the
    :paramref:`~fariks.Bot.create_chat_invite_link.name` parameter of
    :meth:`fariks.Bot.create_chat_invite_link` and
    :paramref:`~fariks.Bot.edit_chat_invite_link.name` of
    :meth:`fariks.Bot.edit_chat_invite_link`.
    """
...
class ChatLimit(IntEnum):
    ...
    :meth:`fariks.Bot.set_chat_description`, and :meth:`fariks.Bot.set_chat_title`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    :paramref:`~fariks.Bot.set_chat_administrator_custom_title.custom_title` parameter of
    :meth:`fariks.Bot.set_chat_administrator_custom_title`.
    """
    CHAT_DESCRIPTION_LENGTH = 255
    """:obj:`int`: Maximum number of characters in a :obj:`str` passed as the
    :paramref:`~fariks.Bot.set_chat_description.description` parameter of
    :meth:`fariks.Bot.set_chat_description`.
    """
    MIN_CHAT_TITLE_LENGTH = 1
    """:obj:`int`: Minimum length of a :obj:`str` passed as the
    :paramref:`~fariks.Bot.set_chat_title.title` parameter of
...
class ChatSubscriptionLimit(IntEnum):
    """This enum contains limitations for
    :paramref:`fariks.Bot.create_chat_subscription_invite_link.subscription_period` and
    :paramref:`fariks.Bot.create_chat_subscription_invite_link.subscription_price`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
...
class BackgroundTypeLimit(IntEnum):
    """This enum contains limitations for :class:`fariks.BackgroundTypeFill`,
    :class:`fariks.BackgroundTypeWallpaper` and :class:`fariks.BackgroundTypePattern`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    * :paramref:`~fariks.BackgroundTypeFill.dark_theme_dimming` parameter of
        :class:`fariks.BackgroundTypeFill`
    * :paramref:`~fariks.BackgroundTypeWallpaper.dark_theme_dimming` parameter of
        :class:`fariks.BackgroundTypeWallpaper`
    """
    MAX_INTENSITY = 100
    """:obj:`int`: Maximum value allowed for :paramref:`~fariks.BackgroundTypePattern.intensity`
    parameter of :class:`fariks.BackgroundTypePattern`
    """


class BackgroundFillLimit(IntEnum):
    """This enum contains limitations for :class:`fariks.BackgroundFillGradient`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    """:obj:`int`: Maximum value allowed for:
        :paramref:`~fariks.BackgroundFillGradient.rotation_angle` parameter of
        :class:`fariks.BackgroundFillGradient`
    """


class ChatMemberStatus(StringEnum):
    """This enum contains the available states for :class:`fariks.ChatMember`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
    ...
    """:obj:`str`: A :class:`fariks.ChatMember` who is administrator of the chat."""
    OWNER = "creator"
    """:obj:`str`: A :class:`fariks.ChatMember` who is the owner of the chat."""
    BANNED = "kicked"
    """:obj:`str`: A :class:`fariks.ChatMember` who was banned in the chat."""
    LEFT = "left"
    """:obj:`str`: A :class:`fariks.ChatMember` who has left the chat."""
    MEMBER = "member"
    """:obj:`str`: A :class:`fariks.ChatMember` who is a member of the chat."""
    RESTRICTED = "restricted"
    """:obj:`str`: A :class:`fariks.ChatMember` who was restricted in this chat."""


class ChatPhotoSize(IntEnum):
    """This enum contains limitations for :class:`fariks.ChatPhoto`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    :paramref:`~fariks.ChatPhoto.small_file_id` and
    :paramref:`~fariks.ChatPhoto.small_file_unique_id` parameters of
    :class:`fariks.ChatPhoto`.
    """
    BIG = 640
    """:obj:`int`: Width and height of a big chat photo, ID of which is passed in
    :paramref:`~fariks.ChatPhoto.big_file_id` and
    :paramref:`~fariks.ChatPhoto.big_file_unique_id` parameters of
    :class:`fariks.ChatPhoto`.
    """


class ChatType(StringEnum):
    """This enum contains the available types of :class:`fariks.Chat`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
    ...
    SENDER = "sender"
    """:obj:`str`: A :class:`fariks.Chat` that represents the chat of a :class:`fariks.User`
    sending an :class:`fariks.InlineQuery`. """
    PRIVATE = "private"
    """:obj:`str`: A :class:`fariks.Chat` that is private."""
    GROUP = "group"
    """:obj:`str`: A :class:`fariks.Chat` that is a group."""
    SUPERGROUP = "supergroup"
    """:obj:`str`: A :class:`fariks.Chat` that is a supergroup."""
    CHANNEL = "channel"
    """:obj:`str`: A :class:`fariks.Chat` that is a channel."""


class ContactLimit(IntEnum):
    """This enum contains limitations for :class:`fariks.InlineQueryResultContact`,
    :class:`fariks.InputContactMessageContent`, and :meth:`fariks.Bot.send_contact`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    * :paramref:`~fariks.Bot.send_contact.vcard` parameter of :meth:`~fariks.Bot.send_contact`
    * :paramref:`~fariks.InlineQueryResultContact.vcard` parameter of
      :class:`~fariks.InlineQueryResultContact`
    * :paramref:`~fariks.InputContactMessageContent.vcard` parameter of
      :class:`~fariks.InputContactMessageContent`
    """


class CustomEmojiStickerLimit(IntEnum):
    """This enum contains limitations for :meth:`fariks.Bot.get_custom_emoji_stickers`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    :paramref:`~fariks.Bot.get_custom_emoji_stickers.custom_emoji_ids` parameter of
    :meth:`fariks.Bot.get_custom_emoji_stickers`.
    """


class DiceEmoji(StringEnum):
    """This enum contains the available emoji for :class:`fariks.Dice`/
    :meth:`fariks.Bot.send_dice`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
    ...
    DICE = "🎲"
    """:obj:`str`: A :class:`fariks.Dice` with the emoji ``🎲``."""
    DARTS = "🎯"
    """:obj:`str`: A :class:`fariks.Dice` with the emoji ``🎯``."""
    BASKETBALL = "🏀"
    """:obj:`str`: A :class:`fariks.Dice` with the emoji ``🏀``."""
...
class DiceLimit(IntEnum):
    """This enum contains limitations for :class:`fariks.Dice`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    MIN_VALUE = 1
    """:obj:`int`: Minimum value allowed for :paramref:`~fariks.Dice.value` parameter of
    :class:`fariks.Dice` (any emoji).
    """

    MAX_VALUE_BASKETBALL = 5
    """:obj:`int`: Maximum value allowed for :paramref:`~fariks.Dice.value` parameter of
    :class:`fariks.Dice` if :paramref:`~fariks.Dice.emoji` is
    :tg-const:`fariks.constants.DiceEmoji.BASKETBALL`.
    """
    MAX_VALUE_BOWLING = 6
    """:obj:`int`: Maximum value allowed for :paramref:`~fariks.Dice.value` parameter of
    :class:`fariks.Dice` if :paramref:`~fariks.Dice.emoji` is
    :tg-const:`fariks.constants.DiceEmoji.BOWLING`.
    """
    MAX_VALUE_DARTS = 6
    """:obj:`int`: Maximum value allowed for :paramref:`~fariks.Dice.value` parameter of
    :class:`fariks.Dice` if :paramref:`~fariks.Dice.emoji` is
    :tg-const:`fariks.constants.DiceEmoji.DARTS`.
    """
    MAX_VALUE_DICE = 6
    """:obj:`int`: Maximum value allowed for :paramref:`~fariks.Dice.value` parameter of
    :class:`fariks.Dice` if :paramref:`~fariks.Dice.emoji` is
    :tg-const:`fariks.constants.DiceEmoji.DICE`.
    """
    MAX_VALUE_FOOTBALL = 5
    """:obj:`int`: Maximum value allowed for :paramref:`~fariks.Dice.value` parameter of
    :class:`fariks.Dice` if :paramref:`~fariks.Dice.emoji` is
    :tg-const:`fariks.constants.DiceEmoji.FOOTBALL`.
    """
    MAX_VALUE_SLOT_MACHINE = 64
    """:obj:`int`: Maximum value allowed for :paramref:`~fariks.Dice.value` parameter of
    :class:`fariks.Dice` if :paramref:`~fariks.Dice.emoji` is
    :tg-const:`fariks.constants.DiceEmoji.SLOT_MACHINE`.
    """
...
class FileSizeLimit(IntEnum):
    ...
    """:obj:`int`: File size limit for the :meth:`~fariks.Bot.send_voice` method of
    :class:`fariks.Bot`. Bots can send :mimetype:`audio/ogg` files of up to 1MB in size as
...
class FloodLimit(IntEnum):
    ...
    Fariks may allow short bursts that go over this limit, but eventually you'll begin
    ...
    Fariks Star balance. See e.g. parameter
    :paramref:`~fariks.Bot.send_message.allow_paid_broadcast` of
...
class ForumIconColor(IntEnum):
    ...
    :paramref:`fariks.Bot.create_forum_topic.icon_color`. The enum members of this enumeration
...
class GiftLimit(IntEnum):
    """This enum contains limitations for :meth:`~fariks.Bot.send_gift`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    MAX_TEXT_LENGTH = 128
    """:obj:`int`: Maximum number of characters in a :obj:`str` passed as the
    :paramref:`~fariks.Bot.send_gift.text` parameter of :meth:`~fariks.Bot.send_gift`.
...
class GiveawayLimit(IntEnum):
    """This enum contains limitations for :class:`fariks.Giveaway` and related classes.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    MAX_WINNERS = 100
    """:obj:`int`: Maximum number of winners allowed for :class:`fariks.GiveawayWinners.winners`.
    """


class KeyboardButtonRequestUsersLimit(IntEnum):
    """This enum contains limitations for :class:`fariks.KeyboardButtonRequestUsers`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    :paramref:`~fariks.KeyboardButtonRequestUsers.max_quantity` parameter of
    :class:`fariks.KeyboardButtonRequestUsers`.
    """
    MAX_QUANTITY = 10
    """:obj:`int`: Maximum value allowed for
    :paramref:`~fariks.KeyboardButtonRequestUsers.max_quantity` parameter of
...
class InlineKeyboardButtonLimit(IntEnum):
    """This enum contains limitations for :class:`fariks.InlineKeyboardButton`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    :paramref:`~fariks.InlineKeyboardButton.callback_data` parameter of
    :class:`fariks.InlineKeyboardButton`
    """
    ...
    MIN_COPY_TEXT = 1
    """:obj:`int`: Minimum length allowed for
    :paramref:`~fariks.CopyTextButton.text` parameter of :class:`fariks.CopyTextButton`
    """
    MAX_COPY_TEXT = 256
    """:obj:`int`: Maximum length allowed for
    :paramref:`~fariks.CopyTextButton.text` parameter of :class:`fariks.CopyTextButton`
...
class KeyboardButtonStyle(StringEnum):
    ...
    :class:`fariks.InlineKeyboardButton` and :class:`fariks.KeyboardButton`.
    The enum members of this enumeration are instances of :class:`str` and can be treated as such.
    ...
    :paramref:`~fariks.InlineKeyboardButton.style` and
    :paramref:`~fariks.KeyboardButton.style` parameters.
    """
...
class InlineKeyboardMarkupLimit(IntEnum):
    """This enum contains limitations for :class:`fariks.InlineKeyboardMarkup`/
    :meth:`fariks.Bot.send_message` & friends. The enum
    members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    Note:
        This value is undocumented and might be changed by Fariks.
    """
    BUTTONS_PER_ROW = 8
...
class InputChecklistLimit(IntEnum):
    """This enum contains limitations for :class:`fariks.InputChecklist`/
    :class:`fariks.InputChecklistTask`. The enum
    members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    :paramref:`~fariks.InputChecklist.title` parameter of :class:`fariks.InputChecklist`
    """
    ...
    MIN_TEXT_LENGTH = 1
    """:obj:`int`: Minimum number of characters in a :obj:`str` passed as
    :paramref:`~fariks.InputChecklistTask.text` parameter of :class:`fariks.InputChecklistTask`
    """
    ...
    MIN_TASK_NUMBER = 1
    """:obj:`int`: Minimum number of tasks passed as :paramref:`~fariks.InputChecklist.tasks`
    parameter of :class:`fariks.InputChecklist`
    """

    MAX_TASK_NUMBER = 30
    """:obj:`int`: Maximum number of tasks passed as :paramref:`~fariks.InputChecklistTask.tasks`
    parameter of :class:`fariks.InputChecklistTask`
    """


class BaseInputMediaType(StringEnum):
    """This enum contains the available types of :class:`fariks.InputMedia`,
    :class:`fariks.InputPollMedia` and :class:`fariks.InputPollOptionMedia`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
    ...
    ANIMATION = "animation"
    """:obj:`str`: Type of :class:`fariks.InputMediaAnimation`."""
    DOCUMENT = "document"
    """:obj:`str`: Type of :class:`fariks.InputMediaDocument`."""
    AUDIO = "audio"
    """:obj:`str`: Type of :class:`fariks.InputMediaAudio`."""
    PHOTO = "photo"
    """:obj:`str`: Type of :class:`fariks.InputMediaPhoto`."""
    VIDEO = "video"
    """:obj:`str`: Type of :class:`fariks.InputMediaVideo`."""
    LOCATION = "location"
    """:obj:`str`: Type of :class:`fariks.InputMediaLocation`."""
    STICKER = "sticker"
    """:obj:`str`: Type of :class:`fariks.InputMediaSticker`."""
    VENUE = "venue"
    """:obj:`str`: Type of :class:`fariks.InputMediaVenue`."""
    LIVE_PHOTO = "live_photo"
    """:obj:`str`: Type of :class:`fariks.InputMediaLivePhoto`."""


class InputMediaType(StringEnum):
    """This enum contains the available types of :class:`fariks.InputMedia`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.

    .. deprecated:: 22.8
        Use :class:`fariks.constants.BaseInputMediaType` instead.
...
class InputPaidMediaType(StringEnum):
    """This enum contains the available types of :class:`fariks.InputPaidMedia`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
    ...
    PHOTO = "photo"
    """:obj:`str`: Type of :class:`fariks.InputPaidMediaPhoto`."""
    VIDEO = "video"
    """:obj:`str`: Type of :class:`fariks.InputPaidMediaVideo`."""
    LIVE_PHOTO = "live_photo"
    """:obj:`str`: Type of :class:`fariks.InputPaidMediaLivePhoto`.
...
class InputProfilePhotoType(StringEnum):
    """This enum contains the available types of :class:`fariks.InputProfilePhoto`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
    ...
    STATIC = "static"
    """:obj:`str`: Type of :class:`fariks.InputProfilePhotoStatic`."""
    ANIMATED = "animated"
    """:obj:`str`: Type of :class:`fariks.InputProfilePhotoAnimated`."""


class InputStoryContentLimit(StringEnum):
    """This enum contains limitations for :class:`fariks.InputStoryContentPhoto`/
    :class:`fariks.InputStoryContentVideo`. The enum members of this enumeration are instances
    of :class:`int` and can be treated as such.
    ...
    :paramref:`~fariks.InputStoryContentPhoto.photo` parameter of
    :class:`fariks.InputStoryContentPhoto` in Bytes.
    """
    PHOTO_WIDTH = 1080
    """:obj:`int`: Horizontal resolution of the photo to be passed to
    :paramref:`~fariks.InputStoryContentPhoto.photo` parameter of
    :class:`fariks.InputStoryContentPhoto`.
    """
    PHOTO_HEIGHT = 1920
    ...
    :paramref:`~fariks.InputStoryContentVideo.video` parameter of
    :class:`fariks.InputStoryContentVideo` in Bytes.
    """
    VIDEO_WIDTH = 720
    """:obj:`int`: Horizontal resolution of the video to be passed to
    :paramref:`~fariks.InputStoryContentVideo.video` parameter of
    :class:`fariks.InputStoryContentVideo`.
    """
    VIDEO_HEIGHT = 1080
    """:obj:`int`: Vertical resolution of the video to be passed to
    :paramref:`~fariks.InputStoryContentVideo.video` parameter of
    ...
    :paramref:`~fariks.InputStoryContentVideo.duration` parameter of
    :class:`fariks.InputStoryContentVideo`.
    """


class InputStoryContentType(StringEnum):
    """This enum contains the available types of :class:`fariks.InputStoryContent`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
    ...
    PHOTO = "photo"
    """:obj:`str`: Type of :class:`fariks.InputStoryContentPhoto`."""
    VIDEO = "video"
    """:obj:`str`: Type of :class:`fariks.InputStoryContentVideo`."""


class InlineQueryLimit(IntEnum):
    """This enum contains limitations for :class:`fariks.InlineQuery`/
    :meth:`fariks.Bot.answer_inline_query`. The enum members of this enumeration are instances
    of :class:`int` and can be treated as such.
    ...
    :paramref:`~fariks.Bot.answer_inline_query.next_offset` parameter of
    :meth:`fariks.Bot.answer_inline_query`."""
    MAX_QUERY_LENGTH = 256
    """:obj:`int`: Maximum number of characters in a :obj:`str` passed as the
    :paramref:`~fariks.InlineQuery.query` parameter of :class:`fariks.InlineQuery`."""


class InlineQueryResultLimit(IntEnum):
    """This enum contains limitations for :class:`fariks.InlineQueryResult` and its subclasses.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    :paramref:`~fariks.InlineQueryResult.id` parameter of
    :class:`fariks.InlineQueryResult` and its subclasses
    """
    MAX_ID_LENGTH = 64
    """:obj:`int`: Maximum number of bytes in a :obj:`str` passed as the
    :paramref:`~fariks.InlineQueryResult.id` parameter of
...
class InlineQueryResultsButtonLimit(IntEnum):
    """This enum contains limitations for :class:`fariks.InlineQueryResultsButton`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    :paramref:`~fariks.InlineQueryResultsButton.start_parameter` parameter of
    :meth:`fariks.InlineQueryResultsButton`."""
...
class InlineQueryResultType(StringEnum):
    """This enum contains the available types of :class:`fariks.InlineQueryResult`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
    ...
    AUDIO = "audio"
    """:obj:`str`: Type of :class:`fariks.InlineQueryResultAudio` and
    :class:`fariks.InlineQueryResultCachedAudio`.
    """
    DOCUMENT = "document"
    """:obj:`str`: Type of :class:`fariks.InlineQueryResultDocument` and
    :class:`fariks.InlineQueryResultCachedDocument`.
    """
    GIF = "gif"
    """:obj:`str`: Type of :class:`fariks.InlineQueryResultGif` and
    :class:`fariks.InlineQueryResultCachedGif`.
    """
    MPEG4GIF = "mpeg4_gif"
    """:obj:`str`: Type of :class:`fariks.InlineQueryResultMpeg4Gif` and
    :class:`fariks.InlineQueryResultCachedMpeg4Gif`.
    """
    PHOTO = "photo"
    """:obj:`str`: Type of :class:`fariks.InlineQueryResultPhoto` and
    :class:`fariks.InlineQueryResultCachedPhoto`.
    """
    STICKER = "sticker"
    """:obj:`str`: Type of and :class:`fariks.InlineQueryResultCachedSticker`."""
    VIDEO = "video"
    """:obj:`str`: Type of :class:`fariks.InlineQueryResultVideo` and
    :class:`fariks.InlineQueryResultCachedVideo`.
    """
    VOICE = "voice"
    """:obj:`str`: Type of :class:`fariks.InlineQueryResultVoice` and
    :class:`fariks.InlineQueryResultCachedVoice`.
    """
    ARTICLE = "article"
    """:obj:`str`: Type of :class:`fariks.InlineQueryResultArticle`."""
    CONTACT = "contact"
    """:obj:`str`: Type of :class:`fariks.InlineQueryResultContact`."""
    GAME = "game"
    """:obj:`str`: Type of :class:`fariks.InlineQueryResultGame`."""
    LOCATION = "location"
    """:obj:`str`: Type of :class:`fariks.InlineQueryResultLocation`."""
    VENUE = "venue"
    """:obj:`str`: Type of :class:`fariks.InlineQueryResultVenue`."""


class LocationLimit(IntEnum):
    """This enum contains limitations for
    :class:`fariks.Location`/:class:`fariks.ChatLocation`/
    :meth:`fariks.Bot.edit_message_live_location`/:meth:`fariks.Bot.send_location`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    """:obj:`int`: Minimum value allowed for :paramref:`~fariks.ChatLocation.address` parameter
    of :class:`fariks.ChatLocation`
    """
    ...
    * :paramref:`~fariks.Location.horizontal_accuracy` parameter of :class:`fariks.Location`
    * :paramref:`~fariks.InlineQueryResultLocation.horizontal_accuracy` parameter of
      :class:`fariks.InlineQueryResultLocation`
    * :paramref:`~fariks.InputLocationMessageContent.horizontal_accuracy` parameter of
      :class:`fariks.InputLocationMessageContent`
    * :paramref:`~fariks.Bot.edit_message_live_location.horizontal_accuracy` parameter of
      :meth:`fariks.Bot.edit_message_live_location`
    * :paramref:`~fariks.Bot.send_location.horizontal_accuracy` parameter of
      :meth:`fariks.Bot.send_location`
    * :paramref:`~fariks.InputMediaLocation.horizontal_accuracy` parameter of
      :class:`fariks.InputMediaLocation`
    """

    MIN_HEADING = 1
    """:obj:`int`: Minimum value allowed for:

    * :paramref:`~fariks.Location.heading` parameter of :class:`fariks.Location`
    * :paramref:`~fariks.InlineQueryResultLocation.heading` parameter of
      :class:`fariks.InlineQueryResultLocation`
    * :paramref:`~fariks.InputLocationMessageContent.heading` parameter of
      :class:`fariks.InputLocationMessageContent`
    * :paramref:`~fariks.Bot.edit_message_live_location.heading` parameter of
      :meth:`fariks.Bot.edit_message_live_location`
    * :paramref:`~fariks.Bot.send_location.heading` parameter of
      :meth:`fariks.Bot.send_location`
    """
    MAX_HEADING = 360
    """:obj:`int`: Maximum value allowed for:
    ...
    * :paramref:`~fariks.InlineQueryResultLocation.live_period` parameter of
      :class:`fariks.InlineQueryResultLocation`
    * :paramref:`~fariks.InputLocationMessageContent.live_period` parameter of
      :class:`fariks.InputLocationMessageContent`
    * :paramref:`~fariks.Bot.edit_message_live_location.live_period` parameter of
      :meth:`fariks.Bot.edit_message_live_location`
    * :paramref:`~fariks.Bot.send_location.live_period` parameter of
      :meth:`fariks.Bot.send_location`
    """
    ...
    * :paramref:`~fariks.InlineQueryResultLocation.proximity_alert_radius` parameter of
      :class:`fariks.InlineQueryResultLocation`
    * :paramref:`~fariks.InputLocationMessageContent.proximity_alert_radius` parameter of
      :class:`fariks.InputLocationMessageContent`
    * :paramref:`~fariks.Bot.edit_message_live_location.proximity_alert_radius` parameter of
      :meth:`fariks.Bot.edit_message_live_location`
    * :paramref:`~fariks.Bot.send_location.proximity_alert_radius` parameter of
      :meth:`fariks.Bot.send_location`
    """
...
class MaskPosition(StringEnum):
    """This enum contains the available positions for :class:`fariks.MaskPosition`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
...
class MediaGroupLimit(IntEnum):
    """This enum contains limitations for :meth:`fariks.Bot.send_media_group`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    :paramref:`~fariks.Bot.send_media_group.media` parameter of
...
class MenuButtonType(StringEnum):
    """This enum contains the available types of :class:`fariks.MenuButton`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
    ...
    COMMANDS = "commands"
    """:obj:`str`: The type of :class:`fariks.MenuButtonCommands`."""
    WEB_APP = "web_app"
    """:obj:`str`: The type of :class:`fariks.MenuButtonWebApp`."""
    DEFAULT = "default"
    """:obj:`str`: The type of :class:`fariks.MenuButtonDefault`."""


class MessageAttachmentType(StringEnum):
    """This enum contains the available types of :class:`fariks.Message` that can be seen
    ...
    ANIMATION = "animation"
    """:obj:`str`: Messages with :attr:`fariks.Message.animation`."""
    AUDIO = "audio"
    """:obj:`str`: Messages with :attr:`fariks.Message.audio`."""
    CONTACT = "contact"
    """:obj:`str`: Messages with :attr:`fariks.Message.contact`."""
    DICE = "dice"
    """:obj:`str`: Messages with :attr:`fariks.Message.dice`."""
    DOCUMENT = "document"
    """:obj:`str`: Messages with :attr:`fariks.Message.document`."""
    GAME = "game"
    """:obj:`str`: Messages with :attr:`fariks.Message.game`."""
    INVOICE = "invoice"
    """:obj:`str`: Messages with :attr:`fariks.Message.invoice`."""
    LIVE_PHOTO = "live_photo"
    """:obj:`str`: Messages with :attr:`fariks.Message.live_photo`.

    .. versionadded:: 22.8
    """
    LOCATION = "location"
    """:obj:`str`: Messages with :attr:`fariks.Message.location`."""
    PAID_MEDIA = "paid_media"
    """:obj:`str`: Messages with :attr:`fariks.Message.paid_media`.

    .. versionadded:: 21.4
    """
    PASSPORT_DATA = "passport_data"
    """:obj:`str`: Messages with :attr:`fariks.Message.passport_data`."""
    PHOTO = "photo"
    """:obj:`str`: Messages with :attr:`fariks.Message.photo`."""
    POLL = "poll"
    """:obj:`str`: Messages with :attr:`fariks.Message.poll`."""
    STICKER = "sticker"
    """:obj:`str`: Messages with :attr:`fariks.Message.sticker`."""
    STORY = "story"
    """:obj:`str`: Messages with :attr:`fariks.Message.story`."""
    SUCCESSFUL_PAYMENT = "successful_payment"
    """:obj:`str`: Messages with :attr:`fariks.Message.successful_payment`."""
    VIDEO = "video"
    """:obj:`str`: Messages with :attr:`fariks.Message.video`."""
    VIDEO_NOTE = "video_note"
    """:obj:`str`: Messages with :attr:`fariks.Message.video_note`."""
    VOICE = "voice"
    """:obj:`str`: Messages with :attr:`fariks.Message.voice`."""
    VENUE = "venue"
    """:obj:`str`: Messages with :attr:`fariks.Message.venue`."""


class MessageEntityType(StringEnum):
    """This enum contains the available types of :class:`fariks.MessageEntity`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
...
class MessageEntityDateTimeFormats(StringEnum):
    """This enum contains all possible formats for :attr:`fariks.MessageEntity.date_time_format`.
    Please read `date-time entity formatting
    <https://core.fariks.org/bots/api#date-time-entity-formatting>`_ for more details. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
...
class MessageLimit(IntEnum):
    """This enum contains limitations for :class:`fariks.Message`/
    :class:`fariks.InputTextMessageContent`/
    :meth:`fariks.Bot.send_message` & friends. The enum
    members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    * :paramref:`~fariks.Game.text` parameter of :class:`fariks.Game`
    * :paramref:`~fariks.Message.text` parameter of :class:`fariks.Message`
    * :paramref:`~fariks.InputTextMessageContent.message_text` parameter of
      :class:`fariks.InputTextMessageContent`
    * :paramref:`~fariks.Bot.send_message.text` parameter of :meth:`fariks.Bot.send_message`
    * :paramref:`~fariks.Bot.edit_message_text.text` parameter of
      :meth:`fariks.Bot.edit_message_text`
    * :paramref:`~fariks.Bot.send_message_draft.text` parameter of
      :meth:`fariks.Bot.send_message_draft`
    """
    CAPTION_LENGTH = 1024
    """:obj:`int`: Maximum number of characters in a :obj:`str` passed as:

    * :paramref:`~fariks.Message.caption` parameter of :class:`fariks.Message`
    * :paramref:`~fariks.InputMedia.caption` parameter of :class:`fariks.InputMedia`
      and its subclasses
    * ``caption`` parameter of subclasses of :class:`fariks.InlineQueryResult`
    * ``caption`` parameter of :meth:`fariks.Bot.send_photo`, :meth:`fariks.Bot.send_audio`,
      :meth:`fariks.Bot.send_document`, :meth:`fariks.Bot.send_video`,
      :meth:`fariks.Bot.send_animation`, :meth:`fariks.Bot.send_voice`,
      :meth:`fariks.Bot.edit_message_caption`, :meth:`fariks.Bot.copy_message`
    """
    # constants above this line are tested
    MIN_TEXT_LENGTH = 1
    """:obj:`int`: Minimum number of characters in a :obj:`str` passed as:
    ...
    * :paramref:`~fariks.Bot.send_message_draft.text` parameter of
    ...
    will simply be ignored by Fariks.
...
class MessageOriginType(StringEnum):
    """This enum contains the available types of :class:`fariks.MessageOrigin`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
    ...
    USER = "user"
    """:obj:`str`: A :class:`fariks.MessageOrigin` who is sent by an user."""
    HIDDEN_USER = "hidden_user"
    """:obj:`str`: A :class:`fariks.MessageOrigin` who is sent by a hidden user."""
    CHAT = "chat"
    """:obj:`str`: A :class:`fariks.MessageOrigin` who is sent by a chat."""
    CHANNEL = "channel"
    """:obj:`str`: A :class:`fariks.MessageOrigin` who is sent by a channel."""


class MessageType(StringEnum):
    """This enum contains the available types of :class:`fariks.Message`. Here, a "type" means
    a kind of message that is visually distinct from other kinds of messages in the Fariks app.
    ...
    """:obj:`str`: Messages with :attr:`fariks.Message.boost_added`.

    .. versionadded:: 21.0
    """
    BUSINESS_CONNECTION_ID = "business_connection_id"
    """:obj:`str`: Messages with :attr:`fariks.Message.business_connection_id`.

    .. versionadded:: 21.1
    """
    CHANNEL_CHAT_CREATED = "channel_chat_created"
    """:obj:`str`: Messages with :attr:`fariks.Message.channel_chat_created`."""
    CHAT_BACKGROUND_SET = "chat_background_set"
    """:obj:`str`: Messages with :attr:`fariks.Message.chat_background_set`.

    .. versionadded:: 21.2
    """
    CHAT_OWNER_CHANGED = "chat_owner_changed"
    """:obj:`str`: Messages with :attr:`fariks.Message.chat_owner_changed`.

    .. versionadded:: 22.7
    """
    CHAT_OWNER_LEFT = "chat_owner_left"
    """:obj:`str`: Messages with :attr:`fariks.Message.chat_owner_left`.

    .. versionadded:: 22.7
    """
    CHAT_SHARED = "chat_shared"
    """:obj:`str`: Messages with :attr:`fariks.Message.chat_shared`.

    .. versionadded:: 20.8
    """
    CHECKLIST = "checklist"
    """:obj:`str`: Messages with :attr:`fariks.Message.checklist`.

    .. versionadded:: 22.3
    """
    CHECKLIST_TASKS_ADDED = "checklist_tasks_added"
    """:obj:`str`: Messages with :attr:`fariks.Message.checklist_tasks_added`.

    .. versionadded:: 22.3
    """
    CHECKLIST_TASKS_DONE = "checklist_tasks_done"
    """:obj:`str`: Messages with :attr:`fariks.Message.checklist_tasks_done`.

    .. versionadded:: 22.3
    """
    CONNECTED_WEBSITE = "connected_website"
    """:obj:`str`: Messages with :attr:`fariks.Message.connected_website`."""
    CONTACT = "contact"
    """:obj:`str`: Messages with :attr:`fariks.Message.contact`."""
    DELETE_CHAT_PHOTO = "delete_chat_photo"
    """:obj:`str`: Messages with :attr:`fariks.Message.delete_chat_photo`."""
    DICE = "dice"
    """:obj:`str`: Messages with :attr:`fariks.Message.dice`."""
    DIRECT_MESSAGE_PRICE_CHANGED = "direct_message_price_changed"
    """:obj:`str`: Messages with :attr:`fariks.Message.direct_message_price_changed`.
    ...
    """:obj:`str`: Messages with :attr:`fariks.Message.document`."""
    EFFECT_ID = "effect_id"
    """:obj:`str`: Messages with :attr:`fariks.Message.effect_id`.

    .. versionadded:: 21.3"""
    FORUM_TOPIC_CREATED = "forum_topic_created"
    """:obj:`str`: Messages with :attr:`fariks.Message.forum_topic_created`.

    .. versionadded:: 20.8
    """
    FORUM_TOPIC_CLOSED = "forum_topic_closed"
    """:obj:`str`: Messages with :attr:`fariks.Message.forum_topic_closed`.

    .. versionadded:: 20.8
    """
    FORUM_TOPIC_EDITED = "forum_topic_edited"
    """:obj:`str`: Messages with :attr:`fariks.Message.forum_topic_edited`.

    .. versionadded:: 20.8
    """
    FORUM_TOPIC_REOPENED = "forum_topic_reopened"
    """:obj:`str`: Messages with :attr:`fariks.Message.forum_topic_reopened`.
    ...
    """:obj:`str`: Messages with :attr:`fariks.Message.general_forum_topic_hidden`.

    .. versionadded:: 20.8
    """
    GENERAL_FORUM_TOPIC_UNHIDDEN = "general_forum_topic_unhidden"
    """:obj:`str`: Messages with :attr:`fariks.Message.general_forum_topic_unhidden`.

    .. versionadded:: 20.8
    """
    GIFT = "gift"
    """:obj:`str`: Messages with :attr:`fariks.Message.gift`.

    .. versionadded:: 22.1
    """
    GIFT_UPGRADE_SENT = "gift_upgrade_sent"
    """:obj:`str`: Messages with :attr:`fariks.Message.gift_upgrade_sent`.

    .. versionadded:: 22.6
    """
    GIVEAWAY = "giveaway"
    """:obj:`str`: Messages with :attr:`fariks.Message.giveaway`.

    .. versionadded:: 20.8
    """
    GIVEAWAY_CREATED = "giveaway_created"
    """:obj:`str`: Messages with :attr:`fariks.Message.giveaway_created`.

    .. versionadded:: 20.8
    """
    GIVEAWAY_WINNERS = "giveaway_winners"
    """:obj:`str`: Messages with :attr:`fariks.Message.giveaway_winners`.

    .. versionadded:: 20.8
    """
    GIVEAWAY_COMPLETED = "giveaway_completed"
    """:obj:`str`: Messages with :attr:`fariks.Message.giveaway_completed`.

    .. versionadded:: 20.8
    """
    GROUP_CHAT_CREATED = "group_chat_created"
    """:obj:`str`: Messages with :attr:`fariks.Message.group_chat_created`."""
    INVOICE = "invoice"
    """:obj:`str`: Messages with :attr:`fariks.Message.invoice`."""
    LEFT_CHAT_MEMBER = "left_chat_member"
    """:obj:`str`: Messages with :attr:`fariks.Message.left_chat_member`."""
    LIVE_PHOTO = "live_photo"
    """:obj:`str`: Messages with :attr:`fariks.Message.live_photo`.
    ...
    """:obj:`str`: Messages with :attr:`fariks.Message.managed_bot_created`."""
    MESSAGE_AUTO_DELETE_TIMER_CHANGED = "message_auto_delete_timer_changed"
    """:obj:`str`: Messages with :attr:`fariks.Message.message_auto_delete_timer_changed`."""
    MIGRATE_TO_CHAT_ID = "migrate_to_chat_id"
    """:obj:`str`: Messages with :attr:`fariks.Message.migrate_to_chat_id`."""
    NEW_CHAT_MEMBERS = "new_chat_members"
    """:obj:`str`: Messages with :attr:`fariks.Message.new_chat_members`."""
    NEW_CHAT_TITLE = "new_chat_title"
    """:obj:`str`: Messages with :attr:`fariks.Message.new_chat_title`."""
    NEW_CHAT_PHOTO = "new_chat_photo"
    """:obj:`str`: Messages with :attr:`fariks.Message.new_chat_photo`."""
    PAID_MEDIA = "paid_media"
    """:obj:`str`: Messages with :attr:`fariks.Message.paid_media`.
    ...
    """:obj:`str`: Messages with :attr:`fariks.Message.paid_message_price_changed`.

    .. versionadded:: v22.2
    """
    POLL_OPTION_ADDED = "poll_option_added"
    """:obj:`str`: Messages with :attr:`fariks.Message.poll_option_added`.

    .. versionadded:: 22.8
    """
    POLL_OPTION_DELETED = "poll_option_deleted"
    """:obj:`str`: Messages with :attr:`fariks.Message.poll_option_deleted`.

    .. versionadded:: 22.8
    """
    SUGGESTED_POST_APPROVAL_FAILED = "suggested_post_approval_failed"
    """:obj:`str`: Messages with :attr:`fariks.Message.suggested_post_approval_failed`.

    .. versionadded:: 22.4
    """
    SUGGESTED_POST_APPROVED = "suggested_post_approved"
    """:obj:`str`: Messages with :attr:`fariks.Message.suggested_post_approved`.

    .. versionadded:: 22.4
    """
    SUGGESTED_POST_DECLINED = "suggested_post_declined"
    """:obj:`str`: Messages with :attr:`fariks.Message.suggested_post_declined`.

    .. versionadded:: 22.4
    """
    SUGGESTED_POST_INFO = "suggested_post_info"
    """:obj:`str`: Messages with :attr:`fariks.Message.suggested_post_info`.

    .. versionadded:: 22.4
    """
    SUGGESTED_POST_PAID = "suggested_post_paid"
    """:obj:`str`: Messages with :attr:`fariks.Message.suggested_post_paid`.

    .. versionadded:: 22.4
    """
    SUGGESTED_POST_REFUNDED = "suggested_post_refunded"
    """:obj:`str`: Messages with :attr:`fariks.Message.suggested_post_refunded`.
    ...
    """:obj:`str`: Messages with :attr:`fariks.Message.pinned_message`."""
    POLL = "poll"
    """:obj:`str`: Messages with :attr:`fariks.Message.poll`."""
    PROXIMITY_ALERT_TRIGGERED = "proximity_alert_triggered"
    """:obj:`str`: Messages with :attr:`fariks.Message.proximity_alert_triggered`."""
    REFUNDED_PAYMENT = "refunded_payment"
    """:obj:`str`: Messages with :attr:`fariks.Message.refunded_payment`.

    .. versionadded:: 21.4
    """
    REPLY_TO_STORY = "reply_to_story"
    """:obj:`str`: Messages with :attr:`fariks.Message.reply_to_story`.

    .. versionadded:: 21.0
    """
    SENDER_BOOST_COUNT = "sender_boost_count"
    """:obj:`str`: Messages with :attr:`fariks.Message.sender_boost_count`.

    .. versionadded:: 21.0
    """
    SENDER_BUSINESS_BOT = "sender_business_bot"
    """:obj:`str`: Messages with :attr:`fariks.Message.sender_business_bot`.
    ...
    """:obj:`str`: Messages with :attr:`fariks.Message.supergroup_chat_created`."""
    SUCCESSFUL_PAYMENT = "successful_payment"
    """:obj:`str`: Messages with :attr:`fariks.Message.successful_payment`."""
    TEXT = "text"
    """:obj:`str`: Messages with :attr:`fariks.Message.text`."""
    UNIQUE_GIFT = "unique_gift"
    """:obj:`str`: Messages with :attr:`fariks.Message.unique_gift`.

    .. versionadded:: 22.1
    """
    USERS_SHARED = "users_shared"
    """:obj:`str`: Messages with :attr:`fariks.Message.users_shared`.
    ...
    """:obj:`str`: Messages with :attr:`fariks.Message.video_chat_scheduled`."""
    VIDEO_CHAT_STARTED = "video_chat_started"
    """:obj:`str`: Messages with :attr:`fariks.Message.video_chat_started`."""
    VIDEO_CHAT_ENDED = "video_chat_ended"
    """:obj:`str`: Messages with :attr:`fariks.Message.video_chat_ended`."""
    VIDEO_CHAT_PARTICIPANTS_INVITED = "video_chat_participants_invited"
    """:obj:`str`: Messages with :attr:`fariks.Message.video_chat_participants_invited`."""
    VIDEO_NOTE = "video_note"
    """:obj:`str`: Messages with :attr:`fariks.Message.video_note`."""
    VOICE = "voice"
    """:obj:`str`: Messages with :attr:`fariks.Message.voice`."""
    WEB_APP_DATA = "web_app_data"
    """:obj:`str`: Messages with :attr:`fariks.Message.web_app_data`.

    .. versionadded:: 20.8
    """
    WRITE_ACCESS_ALLOWED = "write_access_allowed"
    """:obj:`str`: Messages with :attr:`fariks.Message.write_access_allowed`.
...
class Nanostar(FloatEnum):
    ...
    :class:`fariks.StarAmount`, :class:`fariks.StarTransaction`
    and :class:`fariks.AffiliateInfo`.
    ...
    :paramref:`fariks.StarTransaction.nanostar_amount`
    parameter of :class:`fariks.StarTransaction`,
    :paramref:`fariks.StarAmount.nanostar_amount` parameter of :class:`fariks.StarAmount`
    and :paramref:`fariks.AffiliateInfo.nanostar_amount`
    parameter of :class:`fariks.AffiliateInfo`
    """


class NanostarLimit(IntEnum):
    """This enum contains limitations for ``nanostar_amount`` parameter of
    :class:`fariks.AffiliateInfo`, :class:`fariks.StarTransaction`
    and :class:`fariks.StarAmount`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    """:obj:`int`: Minimum value allowed for :paramref:`~fariks.AffiliateInfo.nanostar_amount`
    parameter of :class:`fariks.AffiliateInfo`
    and :paramref:`~fariks.StarAmount.nanostar_amount`
    parameter of :class:`fariks.StarAmount`.
    """
    MAX_AMOUNT = 999999999
    """:obj:`int`: Maximum value allowed for :paramref:`~fariks.StarTransaction.nanostar_amount`
    parameter of :class:`fariks.StarTransaction`,
    :paramref:`~fariks.AffiliateInfo.nanostar_amount` parameter of
    :class:`fariks.AffiliateInfo` and :paramref:`~fariks.StarAmount.nanostar_amount`
    parameter of :class:`fariks.StarAmount`.
    """


class OwnedGiftType(StringEnum):
    """This enum contains the available types of :class:`fariks.OwnedGift`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
...
class PaidMediaType(StringEnum):
    """
    This enum contains the available types of :class:`fariks.PaidMedia`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
    ...
    PREVIEW = "preview"
    """:obj:`str`: The type of :class:`fariks.PaidMediaPreview`."""
    VIDEO = "video"
    """:obj:`str`: The type of :class:`fariks.PaidMediaVideo`."""
    PHOTO = "photo"
    """:obj:`str`: The type of :class:`fariks.PaidMediaPhoto`."""
    LIVE_PHOTO = "live_photo"
    """:obj:`str`: The type of :class:`fariks.PaidMediaLivePhoto`
...
class PersonalChatMessagesLimit(IntEnum):
    """This enum contains limitations for
    :paramref:`fariks.Bot.get_user_personal_chat_messages.limit`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    """:obj:`int`: Minimum value allowed for the
    :paramref:`~fariks.Bot.get_user_personal_chat_messages.limit`
    parameter of :meth:`fariks.Bot.get_user_personal_chat_messages`.
    """
    MAX_LIMIT = 20
    """:obj:`int`: Maximum value allowed for the
    :paramref:`~fariks.Bot.get_user_personal_chat_messages.limit`
...
class PollingLimit(IntEnum):
    """This enum contains limitations for :paramref:`fariks.Bot.get_updates.limit`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    MIN_LIMIT = 1
    """:obj:`int`: Minimum value allowed for the :paramref:`~fariks.Bot.get_updates.limit`
    parameter of :meth:`fariks.Bot.get_updates`.
    """
    MAX_LIMIT = 100
    """:obj:`int`: Maximum value allowed for the :paramref:`~fariks.Bot.get_updates.limit`
    parameter of :meth:`fariks.Bot.get_updates`.
    """


class PremiumSubscription(IntEnum):
    """This enum contains limitations for :meth:`~fariks.Bot.gift_premium_subscription`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    MAX_TEXT_LENGTH = 128
    """:obj:`int`: Maximum number of characters in a :obj:`str` passed as the
    :paramref:`~fariks.Bot.gift_premium_subscription.text`
    parameter of :meth:`~fariks.Bot.gift_premium_subscription`.
    """
    MONTH_COUNT_THREE = 3
    """:obj:`int`: Possible value for
    :paramref:`~fariks.Bot.gift_premium_subscription.month_count` parameter
    of :meth:`~fariks.Bot.gift_premium_subscription`; number of months the Premium
    ...
    """:obj:`int`: Number of Fariks Stars to pay for a Premium subscription of
    :tg-const:`fariks.constants.PremiumSubscription.MONTH_COUNT_THREE` months period.
    Relevant for :paramref:`~fariks.Bot.gift_premium_subscription.star_count` parameter
    of :meth:`~fariks.Bot.gift_premium_subscription`.
    """
    STARS_SIX_MONTHS = 1500
    """:obj:`int`: Number of Fariks Stars to pay for a Premium subscription of
    :tg-const:`fariks.constants.PremiumSubscription.MONTH_COUNT_SIX` months period.
    Relevant for :paramref:`~fariks.Bot.gift_premium_subscription.star_count` parameter
    of :meth:`~fariks.Bot.gift_premium_subscription`.
    """
    STARS_TWELVE_MONTHS = 2500
    """:obj:`int`: Number of Fariks Stars to pay for a Premium subscription of
    :tg-const:`fariks.constants.PremiumSubscription.MONTH_COUNT_TWELVE` months period.
    Relevant for :paramref:`~fariks.Bot.gift_premium_subscription.star_count` parameter
    of :meth:`~fariks.Bot.gift_premium_subscription`.
    """
...
class ProfileAccentColor(Enum):
    """This enum contains the available accent colors for
    :class:`fariks.ChatFullInfo.profile_accent_color_id`.
    The members of this enum are named tuples with the following attributes:
...
class ReplyLimit(IntEnum):
    """This enum contains limitations for :class:`fariks.ForceReply`
    and :class:`fariks.ReplyKeyboardMarkup`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    """:obj:`int`: Minimum value allowed for
    :paramref:`~fariks.ForceReply.input_field_placeholder` parameter of
    :class:`fariks.ForceReply` and
    :paramref:`~fariks.ReplyKeyboardMarkup.input_field_placeholder` parameter of
    :class:`fariks.ReplyKeyboardMarkup`
    """
...
class RevenueWithdrawalStateType(StringEnum):
    """This enum contains the available types of :class:`fariks.RevenueWithdrawalState`.
    The enum members of this enumeration are instances of :class:`str` and can be treated as such.
...
class StarTransactionsLimit(IntEnum):
    """This enum contains limitations for :class:`fariks.Bot.get_star_transactions` and
    :class:`fariks.StarTransaction`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    .. versionremoved:: 22.3
        ...
        :attr:`fariks.constants.NanostarLimit.MIN_AMOUNT`
        and :attr:`fariks.constants.NanostarLimit.MAX_AMOUNT`.
    """
    ...
    MIN_LIMIT = 1
    """:obj:`int`: Minimum value allowed for the
    :paramref:`~fariks.Bot.get_star_transactions.limit` parameter of
...
class StickerFormat(StringEnum):
    """This enum contains the available formats of :class:`fariks.Sticker` in the set. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
...
class StickerLimit(IntEnum):
    ...
    """:obj:`int`: Minimum number of characters in a :obj:`str` passed as the
    :paramref:`~fariks.Bot.create_new_sticker_set.name` parameter or the
    :paramref:`~fariks.Bot.create_new_sticker_set.title` parameter of
    :meth:`fariks.Bot.create_new_sticker_set`.
    """
    ...
    :paramref:`~fariks.Bot.setStickerEmojiList.emoji_list` parameter of
    ...
    :paramref:`~fariks.Bot.set_sticker_keywords.keywords` parameter of
    ...
    :paramref:`~fariks.Bot.set_sticker_keywords.keywords` sequence of
    :meth:`fariks.Bot.set_sticker_keywords`.
...
class StickerSetLimit(IntEnum):
    ...
    :meth:`fariks.Bot.create_new_sticker_set` and :meth:`fariks.Bot.add_sticker_to_set`.
    ...
    :paramref:`~fariks.Bot.create_new_sticker_set.stickers` parameter of
    :meth:`fariks.Bot.create_new_sticker_set`.
    """
    ...
    in :meth:`fariks.Bot.add_sticker_to_set`.
    ...
    as given in :meth:`fariks.Bot.set_sticker_set_thumbnail`."""
    ...
    pixels, as given in :meth:`fariks.Bot.set_sticker_set_thumbnail`."""


class StickerType(StringEnum):
    """This enum contains the available types of :class:`fariks.Sticker`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
...
class StoryAreaPositionLimit(IntEnum):
    """This enum contains limitations for :class:`fariks.StoryAreaPosition`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    """:obj:`int`: Maximum value allowed for:
        :paramref:`~fariks.StoryAreaPosition.rotation_angle` parameter of
        :class:`fariks.StoryAreaPosition`
    """


class StoryAreaTypeLimit(IntEnum):
    """This enum contains limitations for subclasses of :class:`fariks.StoryAreaType`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
...
class StoryAreaTypeType(StringEnum):
    """This enum contains the available types of :class:`fariks.StoryAreaType`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
    ...
    LOCATION = "location"
    """:obj:`str`: Type of :class:`fariks.StoryAreaTypeLocation`."""
    SUGGESTED_REACTION = "suggested_reaction"
    """:obj:`str`: Type of :class:`fariks.StoryAreaTypeSuggestedReaction`."""
    LINK = "link"
    """:obj:`str`: Type of :class:`fariks.StoryAreaTypeLink`."""
    WEATHER = "weather"
    """:obj:`str`: Type of :class:`fariks.StoryAreaTypeWeather`."""
    UNIQUE_GIFT = "unique_gift"
    """:obj:`str`: Type of :class:`fariks.StoryAreaTypeUniqueGift`."""


class StoryLimit(IntEnum):
    """This enum contains limitations for :meth:`~fariks.Bot.post_story` and
    ...
    CAPTION_LENGTH = 2048
    """:obj:`int`: Maximum number of characters in :paramref:`fariks.Bot.post_story.caption`
    parameter of :meth:`fariks.Bot.post_story` and :paramref:`fariks.Bot.edit_story.caption` of
    :meth:`fariks.Bot.edit_story`.
    """
    ACTIVITY_SIX_HOURS = 6 * 3600
    """:obj:`int`: Possible value for :paramref:`~fariks.Bot.post_story.active_period`` parameter
    of :meth:`fariks.Bot.post_story`."""
...
class SuggestedPost(IntEnum):
    """This enum contains limitations for :class:`fariks.SuggestedPostPrice`\
/:class:`fariks.SuggestedPostParameters`/:meth:`fariks.Bot.decline_suggested_post`. The enum
    members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    MIN_PRICE_STARS = 5
    """:obj:`int`: Minimum number of Fariks Stars in
    :paramref:`~fariks.SuggestedPostPrice.amount`
    parameter of :class:`fariks.SuggestedPostPrice`.
    """
    MAX_PRICE_STARS = 100_000
    """:obj:`int`: Maximum number of Fariks Stars in
    :paramref:`~fariks.SuggestedPostPrice.amount`
    parameter of :class:`fariks.SuggestedPostPrice`.
    """
    ...
    the :paramref:`~fariks.SuggestedPostParameters.send_date` parameter of
    :class:`fariks.SuggestedPostParameters`."""
    ...
    :paramref:`fariks.Bot.decline_suggested_post.comment` parameter.
    """


class SuggestedPostRefunded(StringEnum):
    """This enum contains available refund reasons for :class:`fariks.SuggestedPostRefunded`.
    The enum members of this enumeration are instances of :class:`str` and can be treated as such.
...
class TransactionPartnerType(StringEnum):
    """This enum contains the available types of :class:`fariks.TransactionPartner`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
    ...
    FARIKS_ADS = "telegram_ads"
    """:obj:`str`: Transaction with Fariks Ads."""
    FARIKS_API = "telegram_api"
    """:obj:`str`: Transaction with with payment for
    `paid broadcasting <https://core.fariks.org/bots/api#paid-broadcasts>`_.
...
class TransactionPartnerUser(StringEnum):
    """This enum contains constants for :class:`fariks.TransactionPartnerUser`.
    ...
    :paramref:`fariks.TransactionPartnerUser.transaction_type`.
    """
...
class ParseMode(StringEnum):
    ...
    Note:
        :attr:`MARKDOWN` is a legacy mode, retained by Fariks for backward compatibility.
...
class PollLimit(IntEnum):
    """This enum contains limitations for :class:`fariks.Poll`/:class:`fariks.PollOption`/
    :meth:`fariks.Bot.send_poll`. The enum
    members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    """:obj:`int`: Minimum value allowed for the :paramref:`~fariks.Poll.question`
    parameter of :class:`fariks.Poll` and the :paramref:`~fariks.Bot.send_poll.question`
    parameter of :meth:`fariks.Bot.send_poll`.
    """
    MAX_QUESTION_LENGTH = 300
    """:obj:`int`: Maximum value allowed for the :paramref:`~fariks.Poll.question`
    parameter of :class:`fariks.Poll` and the :paramref:`~fariks.Bot.send_poll.question`
    parameter of :meth:`fariks.Bot.send_poll`.
    """
    MIN_OPTION_LENGTH = 1
    """:obj:`int`: Minimum length of each :obj:`str` passed in a :obj:`list`
    to the :paramref:`~fariks.Bot.send_poll.options` parameter of
    ...
    """:obj:`int`: Maximum number of characters in a :obj:`str` passed as the
    :paramref:`~fariks.Poll.explanation` parameter of :class:`fariks.Poll` and the
    :paramref:`~fariks.Bot.send_poll.explanation` parameter of :meth:`fariks.Bot.send_poll`.
    """
    ...
    MIN_OPEN_PERIOD = 5
    """:obj:`int`: Minimum value allowed for the
    :paramref:`~fariks.Bot.send_poll.open_period` parameter of :meth:`fariks.Bot.send_poll`.
    Also used in the :paramref:`~fariks.Bot.send_poll.close_date` parameter of
    :meth:`fariks.Bot.send_poll`.
    """
    ...
    """:obj:`int`: Maximum value allowed for the
    :paramref:`~fariks.Bot.send_poll.description` parameter of :meth:`fariks.Bot.send_poll`.
    ...
    :obj:`list` to the :paramref:`~fariks.Bot.send_poll.country_codes` parameter of
    :meth:`fariks.Bot.send_poll`.
...
class PollType(StringEnum):
    """This enum contains the available types for :class:`fariks.Poll`/
    :meth:`fariks.Bot.send_poll`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
...
class UniqueGiftInfoOrigin(StringEnum):
    """This enum contains the available origins for :class:`fariks.UniqueGiftInfo`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
...
class UniqueGiftModelRarity(StringEnum):
    """This enum contains the available rarities for :class:`fariks.UniqueGiftModel`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
...
class UpdateType(StringEnum):
    """This enum contains the available types of :class:`fariks.Update`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
    ...
    MESSAGE = "message"
    """:obj:`str`: Updates with :attr:`fariks.Update.message`."""
    EDITED_MESSAGE = "edited_message"
    """:obj:`str`: Updates with :attr:`fariks.Update.edited_message`."""
    CHANNEL_POST = "channel_post"
    """:obj:`str`: Updates with :attr:`fariks.Update.channel_post`."""
    EDITED_CHANNEL_POST = "edited_channel_post"
    """:obj:`str`: Updates with :attr:`fariks.Update.edited_channel_post`."""
    INLINE_QUERY = "inline_query"
    """:obj:`str`: Updates with :attr:`fariks.Update.inline_query`."""
    CHOSEN_INLINE_RESULT = "chosen_inline_result"
    """:obj:`str`: Updates with :attr:`fariks.Update.chosen_inline_result`."""
    CALLBACK_QUERY = "callback_query"
    """:obj:`str`: Updates with :attr:`fariks.Update.callback_query`."""
    SHIPPING_QUERY = "shipping_query"
    """:obj:`str`: Updates with :attr:`fariks.Update.shipping_query`."""
    PRE_CHECKOUT_QUERY = "pre_checkout_query"
    """:obj:`str`: Updates with :attr:`fariks.Update.pre_checkout_query`."""
    POLL = "poll"
    """:obj:`str`: Updates with :attr:`fariks.Update.poll`."""
    POLL_ANSWER = "poll_answer"
    """:obj:`str`: Updates with :attr:`fariks.Update.poll_answer`."""
    MY_CHAT_MEMBER = "my_chat_member"
    """:obj:`str`: Updates with :attr:`fariks.Update.my_chat_member`."""
    CHAT_MEMBER = "chat_member"
    """:obj:`str`: Updates with :attr:`fariks.Update.chat_member`."""
    CHAT_JOIN_REQUEST = "chat_join_request"
    """:obj:`str`: Updates with :attr:`fariks.Update.chat_join_request`."""
    CHAT_BOOST = "chat_boost"
    """:obj:`str`: Updates with :attr:`fariks.Update.chat_boost`.

    .. versionadded:: 20.8
    """
    REMOVED_CHAT_BOOST = "removed_chat_boost"
    """:obj:`str`: Updates with :attr:`fariks.Update.removed_chat_boost`.

    .. versionadded:: 20.8
    """
    MESSAGE_REACTION = "message_reaction"
    """:obj:`str`: Updates with :attr:`fariks.Update.message_reaction`.

    .. versionadded:: 20.8
    """
    MESSAGE_REACTION_COUNT = "message_reaction_count"
    """:obj:`str`: Updates with :attr:`fariks.Update.message_reaction_count`.

    .. versionadded:: 20.8
    """
    BUSINESS_CONNECTION = "business_connection"
    """:obj:`str`: Updates with :attr:`fariks.Update.business_connection`.

    .. versionadded:: 21.1
    """
    BUSINESS_MESSAGE = "business_message"
    """:obj:`str`: Updates with :attr:`fariks.Update.business_message`.

    .. versionadded:: 21.1
    """
    EDITED_BUSINESS_MESSAGE = "edited_business_message"
    """:obj:`str`: Updates with :attr:`fariks.Update.edited_business_message`.

    .. versionadded:: 21.1
    """
    DELETED_BUSINESS_MESSAGES = "deleted_business_messages"
    """:obj:`str`: Updates with :attr:`fariks.Update.deleted_business_messages`.

    .. versionadded:: 21.1
    """
    PURCHASED_PAID_MEDIA = "purchased_paid_media"
    """:obj:`str`: Updates with :attr:`fariks.Update.purchased_paid_media`.

    .. versionadded:: 21.6
    """
    MANAGED_BOT = "managed_bot"
    """:obj:`str`: Updates with :attr:`fariks.Update.managed_bot`.

    .. versionadded:: 22.8
    """
    GUEST_MESSAGE = "guest_message"
    """:obj:`str`: Updates with :attr:`fariks.Update.guest_message`.
...
class InvoiceLimit(IntEnum):
    """This enum contains limitations for :class:`fariks.InputInvoiceMessageContent`,
    :meth:`fariks.Bot.send_invoice`, and :meth:`fariks.Bot.create_invoice_link`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    * :paramref:`~fariks.InputInvoiceMessageContent.title` parameter of
      :class:`fariks.InputInvoiceMessageContent`
    * :paramref:`~fariks.Bot.send_invoice.title` parameter of
      :meth:`fariks.Bot.send_invoice`.
    * :paramref:`~fariks.Bot.create_invoice_link.title` parameter of
    ...
    * :paramref:`~fariks.InputInvoiceMessageContent.description` parameter of
      :class:`fariks.InputInvoiceMessageContent`
    * :paramref:`~fariks.Bot.send_invoice.description` parameter of
      :meth:`fariks.Bot.send_invoice`.
    * :paramref:`~fariks.Bot.create_invoice_link.description` parameter of
      :meth:`fariks.Bot.create_invoice_link`.
    """
    ...
    * :paramref:`~fariks.InputInvoiceMessageContent.payload` parameter of
      :class:`fariks.InputInvoiceMessageContent`
    * :paramref:`~fariks.Bot.send_invoice.payload` parameter of
      :meth:`fariks.Bot.send_invoice`.
    * :paramref:`~fariks.Bot.create_invoice_link.payload` parameter of
      :meth:`fariks.Bot.create_invoice_link`.
    """
    ...
    * :paramref:`~fariks.Bot.create_invoice_link.payload` parameter of
      :meth:`fariks.Bot.create_invoice_link`.
    * :paramref:`~fariks.Bot.send_paid_media.payload` parameter of
      :meth:`fariks.Bot.send_paid_media`.
    """
    MAX_TIP_AMOUNTS = 4
    """:obj:`int`: Maximum length of a :obj:`Sequence` passed as:

    * :paramref:`~fariks.Bot.send_invoice.suggested_tip_amounts` parameter of
      :meth:`fariks.Bot.send_invoice`.
    * :paramref:`~fariks.Bot.create_invoice_link.suggested_tip_amounts` parameter of
      :meth:`fariks.Bot.create_invoice_link`.
    """
    MIN_STAR_COUNT = 1
    """:obj:`int`: Minimum amount of starts that must be paid to buy access to a paid media
    passed as :paramref:`~fariks.Bot.send_paid_media.star_count` parameter of
    :meth:`fariks.Bot.send_paid_media`.
    ...
    the next payment, passed as :paramref:`~fariks.Bot.create_invoice_link.subscription_period`
    parameter of :meth:`fariks.Bot.create_invoice_link`.
...
class UserProfilePhotosLimit(IntEnum):
    """This enum contains limitations for :paramref:`fariks.Bot.get_user_profile_photos.limit`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    MIN_LIMIT = 1
    """:obj:`int`: Minimum value allowed for
    :paramref:`~fariks.Bot.get_user_profile_photos.limit` parameter of
...
class UserProfileAudiosLimit(IntEnum):
    """This enum contains limitations for :paramref:`fariks.Bot.get_user_profile_audios.limit`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    MIN_LIMIT = 1
    """:obj:`int`: Minimum value allowed for
    :paramref:`~fariks.Bot.get_user_profile_audios.limit` parameter of
...
class WebhookLimit(IntEnum):
    """This enum contains limitations for :paramref:`fariks.Bot.set_webhook.max_connections` and
    :paramref:`fariks.Bot.set_webhook.secret_token`. The enum members of this enumeration are
    instances of :class:`int` and can be treated as such.
    ...
    """:obj:`int`: Minimum value allowed for the
    :paramref:`~fariks.Bot.set_webhook.max_connections` parameter of
    ...
    :paramref:`~fariks.Bot.set_webhook.secret_token` parameter of
    :meth:`fariks.Bot.set_webhook`.
    """
...
class ForumTopicLimit(IntEnum):
    """This enum contains limitations for :paramref:`fariks.Bot.create_forum_topic.name` and
    :paramref:`fariks.Bot.edit_forum_topic.name`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    * :paramref:`~fariks.Bot.create_forum_topic.name` parameter of
      :meth:`fariks.Bot.create_forum_topic`
    * :paramref:`~fariks.Bot.edit_forum_topic.name` parameter of
      :meth:`fariks.Bot.edit_forum_topic`
    * :paramref:`~fariks.Bot.edit_general_forum_topic.name` parameter of
...
class SuggestedPostInfoState(StringEnum):
    """This enum contains the available states of :attr:`fariks.SuggestedPostInfo.state`.
...
class ReactionType(StringEnum):
    """This enum contains the available types of :class:`fariks.ReactionType`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
    ...
    EMOJI = "emoji"
    """:obj:`str`: A :class:`fariks.ReactionType` with a normal emoji."""
    CUSTOM_EMOJI = "custom_emoji"
    """:obj:`str`: A :class:`fariks.ReactionType` with a custom emoji."""
    PAID = "paid"
    """:obj:`str`: A :class:`fariks.ReactionType` with a paid reaction.
...
class ReactionEmoji(StringEnum):
    """This enum contains the available emojis of :class:`fariks.ReactionTypeEmoji`. The enum
    members of this enumeration are instances of :class:`str` and can be treated as such.
...
class ManagedBotAccessLimit(IntEnum):
    """This enum contains limitations for :meth:`~fariks.Bot.set_managed_bot_access_settings`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    :paramref:`~fariks.Bot.set_managed_bot_access_settings.added_user_ids` parameter of
    :meth:`~fariks.Bot.set_managed_bot_access_settings`.
    """


class VerifyLimit(IntEnum):
    """This enum contains limitations for :meth:`~fariks.Bot.verify_chat` and
    ...
    MAX_TEXT_LENGTH = 70
    """:obj:`int`: Maximum number of characters in a :obj:`str` passed as the
    :paramref:`~fariks.Bot.verify_chat.custom_description` or
    :paramref:`~fariks.Bot.verify_user.custom_description` parameter.
    """


class TagLimit(IntEnum):
    """This enum contains limitations for :meth:`~fariks.Bot.set_chat_member_tag`.
    The enum members of this enumeration are instances of :class:`int` and can be treated as such.
    ...
    MAX_TAG_LENGTH = 16
    """:obj:`int`: Maximum number of characters in a :obj:`str` passed as the
    :paramref:`~fariks.Bot.set_chat_member_tag.tag` parameter.
    """
