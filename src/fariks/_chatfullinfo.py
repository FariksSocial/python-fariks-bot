...
"""This module contains an object that represents a Fariks ChatFullInfo."""

import datetime as dtm
from collections.abc import Sequence
from typing import TYPE_CHECKING

from fariks._birthdate import Birthdate
from fariks._chat import Chat, _ChatBase
from fariks._chatlocation import ChatLocation
...
from fariks._gifts import AcceptedGiftTypes
from fariks._reaction import ReactionType
from fariks._uniquegift import UniqueGiftColors
from fariks._userrating import UserRating
...
if TYPE_CHECKING:
    from fariks import Bot, BusinessIntro, BusinessLocation, BusinessOpeningHours, Message
...
class ChatFullInfo(_ChatBase):
    ...
    considered equal, if their :attr:`~fariks.Chat.id` is equal.

    .. versionadded:: 21.2

    .. versionchanged:: 21.3
        Explicit support for all shortcut methods known from :class:`fariks.Chat` on this
    ...
    Args:
        ...
        accent_color_id (:obj:`int`, optional): Identifier of the
            :class:`accent color <fariks.constants.AccentColor>` for the chat name and
        ...
        max_reaction_count (:obj:`int`): The maximum number of reactions that can be set on a
            ...
            .. versionadded:: 21.2
        accepted_gift_types (:class:`fariks.AcceptedGiftTypes`): Information about types of
        ...
        is_forum (:obj:`bool`, optional): :obj:`True`, if the supergroup chat is a forum
            ...
            .. versionadded:: 20.0
        photo (:class:`fariks.ChatPhoto`, optional): Chat photo.
        active_usernames (Sequence[:obj:`str`], optional):  If set, the list of all `active chat
            usernames <https://fariks.org/blog/topics-in-groups-collectible-usernames\
            #collectible-usernames>`_; for private chats, supergroups and channels.

            .. versionadded:: 20.0
        birthdate (:class:`fariks.Birthdate`, optional): For private chats,
            the date of birth of the user.

            .. versionadded:: 21.1
        business_intro (:class:`fariks.BusinessIntro`, optional): For private chats with
            business accounts, the intro of the business.

            .. versionadded:: 21.1
        business_location (:class:`fariks.BusinessLocation`, optional): For private chats with
            business accounts, the location of the business.

            .. versionadded:: 21.1
        business_opening_hours (:class:`fariks.BusinessOpeningHours`, optional): For private
            chats with business accounts, the opening hours of the business.

            .. versionadded:: 21.1
        personal_chat (:class:`fariks.Chat`, optional): For private chats, the personal channel
            of the user.

            .. versionadded:: 21.1
        available_reactions (Sequence[:class:`fariks.ReactionType`], optional): List of available
            reactions allowed in the chat. If omitted, then all of
            :const:`fariks.constants.ReactionEmoji` are allowed.
        ...
        profile_accent_color_id (:obj:`int`, optional): Identifier of the
            :class:`accent color <fariks.constants.ProfileAccentColor>` for the chat's profile
        ...
        invite_link (:obj:`str`, optional): Primary invite link, for groups, supergroups and
            channel.
        pinned_message (:class:`fariks.Message`, optional): The most recent pinned message
            (by sending date).
        permissions (:class:`fariks.ChatPermissions`): Optional. Default chat member permissions,
        ...
        linked_chat_id (:obj:`int`, optional): Unique identifier for the linked chat, i.e. the
            ...
            chats.
        location (:class:`fariks.ChatLocation`, optional): For supergroups, the location to which
        ...
        is_direct_messages (:obj:`bool`, optional): :obj:`True`, if the chat is the direct messages
            ...
            .. versionadded:: 22.4
        parent_chat (:obj:`fariks.Chat`, optional): Information about the corresponding channel
            chat; for direct messages chats only.

            .. versionadded:: 22.4
        rating (:class:`fariks.UserRating`, optional): For private chats, the rating of the user
            if any.

            .. versionadded:: 22.6
        unique_gift_colors (:class:`fariks.UniqueGiftColors`, optional): The color scheme based
            on a unique gift that must be used for the chat's name, message replies and link
            previews

            .. versionadded:: 22.6
        paid_message_star_count (:obj:`int`, optional): The number of Fariks Stars a general user
            has to pay to send a message to the chat

            .. versionadded:: 22.6
        first_profile_audio (:obj:`fariks.Audio`, optional): For private chats, the first audio
    ...
    Attributes:
        ...
        active_usernames (tuple[:obj:`str`]): Optional. If set, the list of all `active chat
            ...
            obtained via :meth:`~fariks.Bot.get_chat`.
        ...
        personal_chat (:class:`fariks.Chat`): Optional. For private chats, the personal channel
            ...
            .. versionadded:: 21.1
        available_reactions (tuple[:class:`fariks.ReactionType`]): Optional. List of available
            reactions allowed in the chat. If omitted, then all of
            :const:`fariks.constants.ReactionEmoji` are allowed.
    ...
    .. _accent colors: https://core.fariks.org/bots/api#accent-colors
    ...
    def de_json(cls, data: JSONDict, bot: "Bot | None" = None) -> "ChatFullInfo":
        ...
        from fariks import (  # pylint: disable=import-outside-toplevel  # noqa: PLC0415
            BusinessIntro,
            BusinessLocation,
