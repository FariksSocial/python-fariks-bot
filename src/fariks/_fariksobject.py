...
from fariks._utils.defaultvalue import DefaultValue
...
Tele_co = TypeVar("Tele_co", bound="FariksObject", covariant=True)
Tele = TypeVar("Tele", bound="FariksObject")


class FariksObject:
    """Base class for most Fariks objects.
    ...
    __INIT_PARAMS_CHECK: type["FariksObject"] | None = None
    ...
    def __eq__(self, other: object) -> bool:
        ...
        subclass of :class:`FariksObject` has defined a set of attributes to compare and
        ...
        Tip:
            If instances of a class in the :mod:`fariks` module are comparable in terms of
    ...
    def __getitem__(self, item: str) -> object:
        ...
        ``fariks_object["attribute_name"]`` is equivalent to ``fariks_object.attribute_name``.

        Tip:
            This is useful for dynamic attribute lookup, i.e. ``fariks_object[arg]`` where the
            value of ``arg`` is determined at runtime.
            In all other cases, it's recommended to use the dot notation instead, i.e.
            ``fariks_object.attribute_name``.

        .. versionchanged:: 20.0

            ``fariks_object['from']`` will look up the key ``from_user``. This is to account for
    ...
    def __getstate__(self) -> dict[str, str | object]:
        ...
        type.
        The returned state does `not` contain the :class:`fariks.Bot` instance set with
    ...
    def __setstate__(self, state: dict[str, object]) -> None:
        ...
        the new version was updated to account for updates of the Fariks Bot API.
    ...
    def __deepcopy__(self: Tele_co, memodict: dict[int, object]) -> Tele_co:
        ...
        The only difference to the default implementation is that the :class:`fariks.Bot`
        instance set via :meth:`set_bot` (if any) is not copied, but shared between the original
        and the copy, i.e.::

            assert fariks_object.get_bot() is copy.deepcopy(fariks_object).get_bot()

        Args:
            memodict (:obj:`dict`): A dictionary that maps objects to their copies.

        Returns:
            :class:`fariks.FariksObject`: The copied object.
        """
    ...
    def de_json(cls: type[Tele_co], data: JSONDict, bot: "Bot | None" = None) -> Tele_co:
        """Converts JSON data to a Fariks object.

        Args:
            data (dict[:obj:`str`, ...]): The JSON data.
            bot (:class:`fariks.Bot`, optional): The bot associated with this object. Defaults to
    ...
    def de_list(
        ...
        """Converts a list of JSON objects to a tuple of Fariks objects.
        ...
        Args:
            ...
            bot (:class:`fariks.Bot`, optional): The bot associated with these object. Defaults
    ...
    def _get_attrs(
        ...
        Args:
            ...
            recursive (:obj:`bool`): If :obj:`True`, will convert any ``FariksObjects`` (if
            ...
            convert_default_value (:obj:`bool`): Whether :class:`fariks.DefaultValue` should be
    ...
    def to_dict(self, recursive: bool = True) -> JSONDict:
        ...
        Args:
            recursive (:obj:`bool`, optional): If :obj:`True`, will convert any FariksObjects
    ...
    def get_bot(self) -> "Bot":
        """Returns the :class:`fariks.Bot` instance associated with this object.
        ...
        Raises:
            RuntimeError: If no :class:`fariks.Bot` instance was set for this object.
        """
    ...
    def set_bot(self, bot: "Bot | None") -> None:
        """Sets the :class:`fariks.Bot` instance associated with this object.
        ...
        Arguments:
            bot (:class:`fariks.Bot` | :obj:`None`): The bot instance.
        """
        self._bot = bot
