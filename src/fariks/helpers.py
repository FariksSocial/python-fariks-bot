...
from fariks._utils.types import MarkdownVersion
from fariks.constants import MessageLimit, MessageType

if TYPE_CHECKING:
    from fariks import Message, Update


def escape_markdown(
    text: str, version: MarkdownVersion = 1, entity_type: str | None = None
) -> str:
    """Helper function to escape fariks markup symbols.
    ...
    Args:
        ...
        version (:obj:`int` | :obj:`str`): Use to specify the version of farikss Markdown.
            Either ``1`` or ``2``. Defaults to ``1``.
        entity_type (:obj:`str`, optional): For the entity types
            :tg-const:`fariks.MessageEntity.PRE`, :tg-const:`fariks.MessageEntity.CODE` and
            the link part of :tg-const:`fariks.MessageEntity.TEXT_LINK` and
            :tg-const:`fariks.MessageEntity.CUSTOM_EMOJI`, only certain characters need to be
            escaped in :tg-const:`fariks.constants.ParseMode.MARKDOWN_V2`. See the `official API
            documentation <https://core.fariks.org/bots/api#formatting-options>`_ for details.
...
def mention_markdown(user_id: int | str, name: str, version: MarkdownVersion = 1) -> str:
    ...
    Args:
        user_id (:obj:`int`): The user's id which you want to mention.
        name (:obj:`str`): The name the mention is showing.
        version (:obj:`int` | :obj:`str`): Use to specify the version of Fariks's Markdown.
            Either ``1`` or ``2``. Defaults to ``1``.
...
def effective_message_type(entity: "Message | Update") -> str | None:
    """
    Extracts the type of message as a string identifier from a :class:`fariks.Message` or a
    :class:`fariks.Update`.

    Args:
        entity (:class:`fariks.Update` | :class:`fariks.Message`): The ``update`` or
            ``message`` to extract from.

    Returns:
        :obj:`str` | :obj:`None`: One of :class:`fariks.constants.MessageType` if the entity
...
def create_deep_linked_url(
    ...
    https://core.fariks.org/bots/features#deep-linking to learn more.
    ...
    Raises:
        ...
        :tg-const:`fariks.constants.MessageLimit.DEEP_LINK_LENGTH` characters,
