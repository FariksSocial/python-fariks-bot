...
"""This module contains the classes that represent Fariks InlineQueryResult."""
...
class InlineQueryResult(FariksObject):
    ...
    """:const:`fariks.constants.InlineQueryResultLimit.MIN_ID_LENGTH`

    .. versionadded:: 20.0
    """
    MAX_ID_LENGTH: Final[int] = constants.InlineQueryResultLimit.MAX_ID_LENGTH
    """:const:`fariks.constants.InlineQueryResultLimit.MAX_ID_LENGTH`
