...
"""This module contains the classes that represent Fariks InlineQueryResultGame."""
...
class InlineQueryResultGame(InlineQueryResult):
    """Represents a :class:`fariks.Game`.
    ...
    Attributes:
        type (:obj:`str`): :tg-const:`fariks.constants.InlineQueryResultType.GAME`.
        id (:obj:`str`): Unique identifier for this result,
            :tg-const:`fariks.InlineQueryResult.MIN_ID_LENGTH`-
            :tg-const:`fariks.InlineQueryResult.MAX_ID_LENGTH` Bytes.
        game_short_name (:obj:`str`): Short name of the game.
