...
"""This module contains the classes that represent Fariks InlineQueryResultLocation."""
...
class InlineQueryResultLocation(InlineQueryResult):
    ...
    Args:
        ...
        horizontal_accuracy (:obj:`float`, optional): The radius of uncertainty for the location,
            ...
            :tg-const:`fariks.InlineQueryResultLocation.HORIZONTAL_ACCURACY`.
        live_period (:obj:`int` | :class:`datetime.timedelta`, optional): Period in seconds for
            ...
            :tg-const:`fariks.InlineQueryResultLocation.MIN_LIVE_PERIOD` and
            :tg-const:`fariks.InlineQueryResultLocation.MAX_LIVE_PERIOD`.

            .. versionchanged:: v22.2
                |time-period-input|
        heading (:obj:`int`, optional): For live locations, a direction in which the user is
            moving, in degrees. Must be between
            :tg-const:`fariks.InlineQueryResultLocation.MIN_HEADING` and
            :tg-const:`fariks.InlineQueryResultLocation.MAX_HEADING` if specified.
        proximity_alert_radius (:obj:`int`, optional): For live locations, a maximum distance
            for proximity alerts about approaching another chat member, in meters. Must be
            between :tg-const:`fariks.InlineQueryResultLocation.MIN_PROXIMITY_ALERT_RADIUS`
            and :tg-const:`fariks.InlineQueryResultLocation.MAX_PROXIMITY_ALERT_RADIUS`
            if specified.
    ...
    Attributes:
        type (:obj:`str`): :tg-const:`fariks.constants.InlineQueryResultType.LOCATION`.
        id (:obj:`str`): Unique identifier for this result,
            :tg-const:`fariks.InlineQueryResult.MIN_ID_LENGTH`-
            :tg-const:`fariks.InlineQueryResult.MAX_ID_LENGTH` Bytes.
        latitude (:obj:`float`): Location latitude in degrees.
        ...
        live_period (:obj:`int` | :class:`datetime.timedelta`): Optional. Period in seconds for
            which the location will be updated, should be between
            :tg-const:`fariks.InlineQueryResultLocation.MIN_LIVE_PERIOD` and
            :tg-const:`fariks.InlineQueryResultLocation.MAX_LIVE_PERIOD` or
