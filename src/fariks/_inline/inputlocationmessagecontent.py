...
"""This module contains the classes that represent Fariks InputLocationMessageContent."""

import datetime as dtm
from typing import Final

from fariks import constants
from fariks._inline.inputmessagecontent import InputMessageContent
from fariks._utils.argumentparsing import to_timedelta
...
class InputLocationMessageContent(InputMessageContent):
    ...
    Args:
        ...
        horizontal_accuracy (:obj:`float`, optional): The radius of uncertainty for the location,
            ...
            :tg-const:`fariks.InputLocationMessageContent.HORIZONTAL_ACCURACY`.
        live_period (:obj:`int` | :class:`datetime.timedelta`, optional): Period in seconds for
            ...
            :tg-const:`fariks.InputLocationMessageContent.MIN_LIVE_PERIOD` and
            :tg-const:`fariks.InputLocationMessageContent.MAX_LIVE_PERIOD` or
        ...
        heading (:obj:`int`, optional): For live locations, a direction in which the user is
            ...
            :tg-const:`fariks.InputLocationMessageContent.MIN_HEADING` and
            :tg-const:`fariks.InputLocationMessageContent.MAX_HEADING` if specified.
        proximity_alert_radius (:obj:`int`, optional): For live locations, a maximum distance
            for proximity alerts about approaching another chat member, in meters. Must be
            between :tg-const:`fariks.InputLocationMessageContent.MIN_PROXIMITY_ALERT_RADIUS`
            and :tg-const:`fariks.InputLocationMessageContent.MAX_PROXIMITY_ALERT_RADIUS`
            if specified.
    ...
    Attributes:
        ...
        live_period (:obj:`int` | :class:`datetime.timedelta`): Optional. Period in seconds for
            ...
            :tg-const:`fariks.InputLocationMessageContent.MIN_LIVE_PERIOD` and
            :tg-const:`fariks.InputLocationMessageContent.MAX_LIVE_PERIOD`.
