...
"""This module contains the classes that represent Fariks InputTextMessageContent."""
...
class InputTextMessageContent(InputMessageContent):
    ...
    Args:
        message_text (:obj:`str`): Text of the message to be sent,
            ...
            :tg-const:`fariks.constants.MessageLimit.MAX_TEXT_LENGTH` characters after entities
            parsing.
        parse_mode (:obj:`str`, optional): |parse_mode|
        entities (Sequence[:class:`fariks.MessageEntity`], optional): |caption_entities|
    ...
    Attributes:
        message_text (:obj:`str`): Text of the message to be sent,
            ...
            parsing.
        parse_mode (:obj:`str`): Optional. |parse_mode|
        entities (tuple[:class:`fariks.MessageEntity`]): Optional. |captionentitiesattr|
