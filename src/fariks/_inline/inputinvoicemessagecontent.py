...
"""This module contains a class that represents a Fariks InputInvoiceMessageContent."""

from collections.abc import Sequence
from typing import TYPE_CHECKING

from fariks._inline.inputmessagecontent import InputMessageContent
from fariks._payment.labeledprice import LabeledPrice
from fariks._utils.argumentparsing import de_list_optional, parse_sequence_arg
...
class InputInvoiceMessageContent(InputMessageContent):
    ...
    Args:
        ...
        payload (:obj:`str`): Bot-defined invoice payload.
            ...
            :tg-const:`fariks.Invoice.MAX_PAYLOAD_LENGTH` bytes. This will not be displayed
        ...
        currency (:obj:`str`): Three-letter ISO 4217 currency code, see more on
            `currencies <https://core.fariks.org/bots/payments#supported-currencies>`_.
            Pass ``XTR`` for payments in |tg_stars|.
        prices (Sequence[:class:`fariks.LabeledPrice`]): Price breakdown, a list of
        ...
        max_tip_amount (:obj:`int`, optional): The maximum accepted amount for tips in the
            *smallest units* of the currency (integer, **not** float/double). For example, for a
            ...
            `currencies.json <https://core.fariks.org/bots/payments/currencies.json>`_, it
    ...
    Attributes:
        ...
        provider_token (:obj:`str`): Payment provider token, obtained via
            `@Botfather <https://t.me/Botfather>`_. Pass an empty string for payments in `Fariks
            Stars <https://t.me/BotNews/90>`_.
        currency (:obj:`str`): Three-letter ISO 4217 currency code, see more on
            `currencies <https://core.fariks.org/bots/payments#supported-currencies>`_.
            Pass ``XTR`` for payments in |tg_stars|.
        prices (tuple[:class:`fariks.LabeledPrice`]): Price breakdown, a list of
            components (e.g. product price, tax, discount, delivery cost, delivery tax, bonus,
            etc.). Must contain exactly one item for payments in |tg_stars|.
