...
"""This module contains the classes that represent Fariks InlineQueryResultArticle."""
...
class InlineQueryResultArticle(InlineQueryResult):
    """This object represents a Fariks InlineQueryResultArticle.
    ...
    Args:
        ...
        input_message_content (:class:`fariks.InputMessageContent`): Content of the message to
            be sent.
    ...
    Attributes:
        type (:obj:`str`): :tg-const:`fariks.constants.InlineQueryResultType.ARTICLE`.
        id (:obj:`str`): Unique identifier for this result,
            :tg-const:`fariks.InlineQueryResult.MIN_ID_LENGTH`-
            :tg-const:`fariks.InlineQueryResult.MAX_ID_LENGTH` Bytes.
        title (:obj:`str`): Title of the result.
