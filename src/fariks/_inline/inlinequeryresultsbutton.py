...
"""This module contains the class that represent a Fariks InlineQueryResultsButton."""
...
class InlineQueryResultsButton(FariksObject):
    ...
    Args:
        ...
        web_app (:class:`fariks.WebAppInfo`, optional): Description of the
            `Web App <https://core.fariks.org/bots/webapps>`_ that will be launched when the
            user presses the button. The Web App will be able to switch back to the inline mode
            using the method
            `switchInlineQuery <https://core.fariks.org/bots/webapps#initializing-mini-apps>`_
            inside the Web App.
        start_parameter (:obj:`str`, optional):  Deep-linking parameter for the
            ...
            :tg-const:`fariks.constants.InlineQueryResultsButtonLimit.MIN_START_PARAMETER_LENGTH`
            -
            :tg-const:`fariks.constants.InlineQueryResultsButtonLimit.MAX_START_PARAMETER_LENGTH`
    ...
    """:const:`fariks.constants.InlineQueryResultsButtonLimit.MIN_START_PARAMETER_LENGTH`"""
    MAX_START_PARAMETER_LENGTH: Final[int] = (
        constants.InlineQueryResultsButtonLimit.MAX_START_PARAMETER_LENGTH
    )
    """:const:`fariks.constants.InlineQueryResultsButtonLimit.MAX_START_PARAMETER_LENGTH`"""
