...
"""This module contains an object that represents a Fariks ChatMemberUpdated."""
...
class ChatMemberUpdated(FariksObject):
    ...
    Args:
        chat (:class:`fariks.Chat`): Chat the user belongs to.
        from_user (:class:`fariks.User`): Performer of the action, which resulted in the change.
        date (:class:`datetime.datetime`): Date the change was done in Unix time. Converted to
            :class:`datetime.datetime`.

            .. versionchanged:: 20.3
                |datetime_localization|
        old_chat_member (:class:`fariks.ChatMember`): Previous information about the chat member.
        new_chat_member (:class:`fariks.ChatMember`): New information about the chat member.
        invite_link (:class:`fariks.ChatInviteLink`, optional): Chat invite link, which was used
    ...
    def difference(
        ...
        Note:
            To determine, if the :attr:`fariks.ChatMember.user` attribute has changed, *every*
