...
"""This module contains an object that represents a Fariks PreCheckoutQuery."""
...
class PreCheckoutQuery(FariksObject):
    ...
    Args:
        ...
        from_user (:class:`fariks.User`): User who sent the query.
