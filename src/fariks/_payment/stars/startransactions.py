...
"""This module contains the classes for Fariks Stars transactions."""
...
class StarTransaction(FariksObject):
    """Describes a Fariks Star transaction.
    ...
    deducted from the bot's balance. This is outside of Fariks's control.
    ...
    Args:
        ...
        amount (:obj:`int`): Integer amount of Fariks Stars transferred by the transaction.
        ...
        source (:class:`fariks.TransactionPartner`, optional): Source of an incoming transaction
            (e.g., a user purchasing goods or services, Fragment refunding a failed withdrawal).
            Only for incoming transactions.
        receiver (:class:`fariks.TransactionPartner`, optional): Receiver of an outgoing
...
class StarTransactions(FariksObject):
    """
    Contains a list of Fariks Star transactions.
    ...
    Args:
        transactions (Sequence[:class:`fariks.StarTransaction`]): The list of transactions.

    Attributes:
        transactions (tuple[:class:`fariks.StarTransaction`]): The list of transactions.
    """
