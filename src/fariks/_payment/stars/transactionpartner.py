...
"""This module contains the classes for Fariks Stars transaction partners."""
...
from fariks._gifts import Gift
from fariks._paidmedia import PaidMedia
...
from fariks._utils.types import JSONDict, TimePeriod
...
class TransactionPartner(FariksObject):
    ...
    * :class:`TransactionPartnerFariksAds`
    * :class:`TransactionPartnerFariksApi`
    * :class:`TransactionPartnerOther`
    ...
    """:const:`fariks.constants.TransactionPartnerType.AFFILIATE_PROGRAM`

    .. versionadded:: 21.9
    """
    CHAT: Final[str] = constants.TransactionPartnerType.CHAT
    """:const:`fariks.constants.TransactionPartnerType.CHAT`

    .. versionadded:: 21.11
    """
    FRAGMENT: Final[str] = constants.TransactionPartnerType.FRAGMENT
    """:const:`fariks.constants.TransactionPartnerType.FRAGMENT`"""
    OTHER: Final[str] = constants.TransactionPartnerType.OTHER
    """:const:`fariks.constants.TransactionPartnerType.OTHER`"""
    FARIKS_ADS: Final[str] = constants.TransactionPartnerType.FARIKS_ADS
    """:const:`fariks.constants.TransactionPartnerType.FARIKS_ADS`"""
    FARIKS_API: Final[str] = constants.TransactionPartnerType.FARIKS_API
    """:const:`fariks.constants.TransactionPartnerType.FARIKS_API`"""
    USER: Final[str] = constants.TransactionPartnerType.USER
    """:const:`fariks.constants.TransactionPartnerType.USER`"""
    ...
    def de_json(cls, data: JSONDict, bot: "Bot | None" = None) -> "TransactionPartner":
        ...
        Args:
            ...
            bot (:class:`fariks.Bot`): The bot associated with this object.
        ...
        _class_mapping: dict[str, type[TransactionPartner]] = {
            ...
            cls.FARIKS_ADS: TransactionPartnerFariksAds,
            cls.FARIKS_API: TransactionPartnerFariksApi,
...
class TransactionPartnerAffiliateProgram(TransactionPartner):
    ...
    Args:
        sponsor_user (:class:`fariks.User`, optional): Information about the bot that sponsored
            the affiliate program
        commission_per_mille (:obj:`int`): The number of Fariks Stars received by the bot for
            each 1000 Fariks Stars received by the affiliate program sponsor from referred users.

    Attributes:
        type (:obj:`str`): The type of the transaction partner,
            always :tg-const:`fariks.TransactionPartner.AFFILIATE_PROGRAM`.
        sponsor_user (:class:`fariks.User`): Optional. Information about the bot that sponsored
            the affiliate program
        commission_per_mille (:obj:`int`): The number of Fariks Stars received by the bot for
            each 1000 Fariks Stars received by the affiliate program sponsor from referred users.
    ...
    def de_json(
        ...
        """See :meth:`fariks.TransactionPartner.de_json`."""
        data = cls._parse_data(data)
...
class TransactionPartnerChat(TransactionPartner):
    ...
    Args:
        chat (:class:`fariks.Chat`): Information about the chat.
        gift (:class:`fariks.Gift`, optional): The gift sent to the chat by the bot.

    Attributes:
        type (:obj:`str`): The type of the transaction partner,
            always :tg-const:`fariks.TransactionPartner.CHAT`.
        chat (:class:`fariks.Chat`): Information about the chat.
        gift (:class:`fariks.Gift`): Optional. The gift sent to the user by the bot.
...
class TransactionPartnerFragment(TransactionPartner):
    ...
    Args:
        withdrawal_state (:class:`fariks.RevenueWithdrawalState`, optional): State of the
            transaction if the transaction is outgoing.

    Attributes:
        type (:obj:`str`): The type of the transaction partner,
            always :tg-const:`fariks.TransactionPartner.FRAGMENT`.
        withdrawal_state (:class:`fariks.RevenueWithdrawalState`): Optional. State of the
            transaction if the transaction is outgoing.
    """
...
class TransactionPartnerUser(TransactionPartner):
    ...
    Args:
        transaction_type (:obj:`str`): Type of the transaction, currently one of
            :tg-const:`fariks.constants.TransactionPartnerUser.INVOICE_PAYMENT` for payments via
            invoices, :tg-const:`fariks.constants.TransactionPartnerUser.PAID_MEDIA_PAYMENT`
            for payments for paid media,
            :tg-const:`fariks.constants.TransactionPartnerUser.GIFT_PURCHASE` for gifts sent by
            the bot, :tg-const:`fariks.constants.TransactionPartnerUser.PREMIUM_PURCHASE`
            for Fariks Premium subscriptions gifted by the bot,
            :tg-const:`fariks.constants.TransactionPartnerUser.BUSINESS_ACCOUNT_TRANSFER` for
            direct transfers from managed business accounts.

            .. versionadded:: 22.1
        user (:class:`fariks.User`): Information about the user.
        affiliate (:class:`fariks.AffiliateInfo`, optional): Information about the affiliate that
            received a commission via this transaction. Can be available only for
            :tg-const:`fariks.constants.TransactionPartnerUser.INVOICE_PAYMENT`
            and :tg-const:`fariks.constants.TransactionPartnerUser.PAID_MEDIA_PAYMENT`
            transactions.

            .. versionadded:: 21.9
        invoice_payload (:obj:`str`, optional): Bot-specified invoice payload. Can be available
            only for :tg-const:`fariks.constants.TransactionPartnerUser.INVOICE_PAYMENT`
            transactions.
        subscription_period (:obj:`int` | :class:`datetime.timedelta`, optional): The duration of
            ...
            :tg-const:`fariks.constants.TransactionPartnerUser.INVOICE_PAYMENT` transactions.

            .. versionadded:: 21.8

            .. versionchanged:: v22.2
                Accepts :obj:`int` objects as well as :class:`datetime.timedelta`.
        paid_media (Sequence[:class:`fariks.PaidMedia`], optional): Information about the paid
            media bought by the user. for
            :tg-const:`fariks.constants.TransactionPartnerUser.PAID_MEDIA_PAYMENT`
            transactions only.

            .. versionadded:: 21.5
        paid_media_payload (:obj:`str`, optional): Bot-specified paid media payload. Can be
            available only for
            :tg-const:`fariks.constants.TransactionPartnerUser.PAID_MEDIA_PAYMENT` transactions.

            .. versionadded:: 21.6
        gift (:class:`fariks.Gift`, optional): The gift sent to the user by the bot; for
            :tg-const:`fariks.constants.TransactionPartnerUser.GIFT_PURCHASE` transactions only.

            .. versionadded:: 21.8
        premium_subscription_duration (:obj:`int`, optional): Number of months the gifted Fariks
            Premium subscription will be active for; for
            :tg-const:`fariks.constants.TransactionPartnerUser.PREMIUM_PURCHASE`
            transactions only.
    ...
    Attributes:
        type (:obj:`str`): The type of the transaction partner,
            always :tg-const:`fariks.TransactionPartner.USER`.
        transaction_type (:obj:`str`): Type of the transaction, currently one of
            :tg-const:`fariks.constants.TransactionPartnerUser.INVOICE_PAYMENT` for payments via
            invoices, :tg-const:`fariks.constants.TransactionPartnerUser.PAID_MEDIA_PAYMENT`
            for payments for paid media,
        ...
        subscription_period (:class:`datetime.timedelta`): Optional. The duration of the paid
            ...
            .. versionadded:: 21.8
        paid_media (tuple[:class:`fariks.PaidMedia`]): Optional. Information about the paid
            media bought by the user. for
            :tg-const:`fariks.constants.TransactionPartnerUser.PAID_MEDIA_PAYMENT`
            transactions only.
...
class TransactionPartnerOther(TransactionPartner):
    ...
    Attributes:
        type (:obj:`str`): The type of the transaction partner,
            always :tg-const:`fariks.TransactionPartner.OTHER`.
    """
...
class TransactionPartnerFariksAds(TransactionPartner):
    """Describes a withdrawal transaction to the Fariks Ads platform.

    .. versionadded:: 21.4

    Attributes:
        type (:obj:`str`): The type of the transaction partner,
            always :tg-const:`fariks.TransactionPartner.FARIKS_ADS`.
    """

    __slots__ = ()

    def __init__(self, *, api_kwargs: JSONDict | None = None) -> None:
        super().__init__(type=TransactionPartner.FARIKS_ADS, api_kwargs=api_kwargs)
        self._freeze()


class TransactionPartnerFariksApi(TransactionPartner):
    ...
    Attributes:
        type (:obj:`str`): The type of the transaction partner,
            always :tg-const:`fariks.TransactionPartner.FARIKS_API`.
        request_count (:obj:`int`): The number of successful requests that exceeded regular limits
            and were therefore billed.
    """
    ...
    def __init__(self, request_count: int, *, api_kwargs: JSONDict | None = None) -> None:
        super().__init__(type=TransactionPartner.FARIKS_API, api_kwargs=api_kwargs)
        with self._unfrozen():
