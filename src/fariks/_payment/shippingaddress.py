...
"""This module contains an object that represents a Fariks ShippingAddress."""

from fariks._fariksobject import FariksObject
from fariks._utils.types import JSONDict


class ShippingAddress(FariksObject):
    """This object represents a Fariks ShippingAddress.
