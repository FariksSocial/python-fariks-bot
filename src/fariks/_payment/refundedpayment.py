...
"""This module contains an object that represents a Fariks RefundedPayment."""

from fariks._fariksobject import FariksObject
from fariks._utils.types import JSONDict


class RefundedPayment(FariksObject):
    ...
    Args:
        currency (:obj:`str`): Three-letter ISO 4217 `currency
            <https://core.fariks.org/bots/payments#supported-currencies>`_ code, or ``XTR`` for
