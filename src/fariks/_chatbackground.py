...
from fariks._utils.argumentparsing import de_json_optional, parse_sequence_arg
...
class BackgroundFill(FariksObject):
    """Base class for Fariks BackgroundFill Objects. It can be one of:

    * :class:`fariks.BackgroundFillSolid`
    * :class:`fariks.BackgroundFillGradient`
    * :class:`fariks.BackgroundFillFreeformGradient`
    ...
    Args:
        type (:obj:`str`): Type of the background fill. Can be one of:
            :attr:`~fariks.BackgroundFill.SOLID`, :attr:`~fariks.BackgroundFill.GRADIENT`
            or :attr:`~fariks.BackgroundFill.FREEFORM_GRADIENT`.
...
class BackgroundFillSolid(BackgroundFill):
    ...
    Attributes:
        type (:obj:`str`): Type of the background fill. Always
            :attr:`~fariks.BackgroundFill.SOLID`.
        color (:obj:`int`): The color of the background fill in the `RGB24` format.
    """
...
class BackgroundFillGradient(BackgroundFill):
    ...
    Args:
        ...
        rotation_angle (:obj:`int`): Clockwise rotation angle of the background
            fill in degrees;
            0-:tg-const:`fariks.constants.BackgroundFillLimit.MAX_ROTATION_ANGLE`.


    Attributes:
        type (:obj:`str`): Type of the background fill. Always
            :attr:`~fariks.BackgroundFill.GRADIENT`.
        top_color (:obj:`int`): Top color of the gradient in the `RGB24` format.
        bottom_color (:obj:`int`): Bottom color of the gradient in the `RGB24` format.
        rotation_angle (:obj:`int`): Clockwise rotation angle of the background
            fill in degrees;
...
class BackgroundFillFreeformGradient(BackgroundFill):
    ...
    Attributes:
        type (:obj:`str`): Type of the background fill. Always
            :attr:`~fariks.BackgroundFill.FREEFORM_GRADIENT`.
        colors (Sequence[:obj:`int`]): A list of the 3 or 4 base colors that are used to
            generate the freeform gradient in the `RGB24` format
    """
...
class BackgroundType(FariksObject):
    """Base class for Fariks BackgroundType Objects. It can be one of:

    * :class:`fariks.BackgroundTypeFill`
    * :class:`fariks.BackgroundTypeWallpaper`
    * :class:`fariks.BackgroundTypePattern`
    * :class:`fariks.BackgroundTypeChatTheme`.
    ...
    Args:
        type (:obj:`str`): Type of the background. Can be one of:
            :attr:`~fariks.BackgroundType.FILL`, :attr:`~fariks.BackgroundType.WALLPAPER`
            :attr:`~fariks.BackgroundType.PATTERN` or
            :attr:`~fariks.BackgroundType.CHAT_THEME`.
...
class BackgroundTypeFill(BackgroundType):
    ...
    Args:
        fill (:class:`fariks.BackgroundFill`): The background fill.
        dark_theme_dimming (:obj:`int`): Dimming of the background in dark themes, as a
            percentage;
            0-:tg-const:`fariks.constants.BackgroundTypeLimit.MAX_DIMMING`.

    Attributes:
        type (:obj:`str`): Type of the background. Always
            :attr:`~fariks.BackgroundType.FILL`.
        fill (:class:`fariks.BackgroundFill`): The background fill.
        dark_theme_dimming (:obj:`int`): Dimming of the background in dark themes, as a
            percentage;
            0-:tg-const:`fariks.constants.BackgroundTypeLimit.MAX_DIMMING`.
...
class BackgroundTypeWallpaper(BackgroundType):
    ...
    Args:
        document (:class:`fariks.Document`): Document with the wallpaper
        dark_theme_dimming (:obj:`int`): Dimming of the background in dark themes, as a
            percentage;
            0-:tg-const:`fariks.constants.BackgroundTypeLimit.MAX_DIMMING`.
    ...
    Attributes:
        type (:obj:`str`): Type of the background. Always
            :attr:`~fariks.BackgroundType.WALLPAPER`.
        document (:class:`fariks.Document`): Document with the wallpaper
        dark_theme_dimming (:obj:`int`): Dimming of the background in dark themes, as a
            percentage;
            0-:tg-const:`fariks.constants.BackgroundTypeLimit.MAX_DIMMING`.
...
class BackgroundTypePattern(BackgroundType):
    ...
    Args:
        document (:class:`fariks.Document`): Document with the pattern.
        fill (:class:`fariks.BackgroundFill`): The background fill that is combined with
            the pattern.
        intensity (:obj:`int`): Intensity of the pattern when it is shown above the filled
            background;
            0-:tg-const:`fariks.constants.BackgroundTypeLimit.MAX_INTENSITY`.
    ...
    Attributes:
        type (:obj:`str`): Type of the background. Always
            :attr:`~fariks.BackgroundType.PATTERN`.
        document (:class:`fariks.Document`): Document with the pattern.
        fill (:class:`fariks.BackgroundFill`): The background fill that is combined with
            the pattern.
        intensity (:obj:`int`): Intensity of the pattern when it is shown above the filled
...
class ChatBackground(FariksObject):
    """
    ...
    Args:
        type (:class:`fariks.BackgroundType`): Type of the background.
