...
class DirectMessagesTopic(FariksObject):
    """
    ...
    Args:
        ...
        user (:class:`fariks.User`, optional): Information about the user that created the topic.

            .. hint::
                According to Fariks, this field is always present as of Bot API 9.2.
