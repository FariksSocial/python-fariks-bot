...
"""This module contains an object that represents a Fariks ChatJoinRequest."""
...
class ChatJoinRequest(FariksObject):
    ...
    Note:
        * Since Bot API 5.5, bots are allowed to contact users who sent a join request to a chat
          ...
          :attr:`~fariks.ChatMemberAdministrator.can_invite_users` administrator right - even
          if the user never interacted with the bot before.
        * Fariks does not guarantee that :attr:`from_user.id <from_user>` coincides with the
    ...
    Args:
        chat (:class:`fariks.Chat`): Chat to which the request was sent.
        from_user (:class:`fariks.User`): User that sent the join request.
        ...
        invite_link (:class:`fariks.ChatInviteLink`, optional): Chat invite link that was used
    ...
    Attributes:
        ...
        invite_link (:class:`fariks.ChatInviteLink`): Optional. Chat invite link that was used
            ...
            Note:
                ...
                See `this GitHub thread <https://github.com/tdlib/fariks-bot-api/issues/428>`_
                for some discussion.
