...
"""This module contains objects related to Fariks forum topics."""

from fariks._fariksobject import FariksObject
from fariks._utils.types import JSONDict


class ForumTopic(FariksObject):
    """
...
class ForumTopicCreated(FariksObject):
    """
...
class ForumTopicClosed(FariksObject):
    """
...
class ForumTopicReopened(FariksObject):
    """
...
class ForumTopicEdited(FariksObject):
    """
...
class GeneralForumTopicHidden(FariksObject):
    """
...
class GeneralForumTopicUnhidden(FariksObject):
    """
