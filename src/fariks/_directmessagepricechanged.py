...
class DirectMessagePriceChanged(FariksObject):
    """
    ...
    Args:
        ...
        direct_message_star_count (:obj:`int`, optional):
            The new number of Fariks Stars that must be paid by users for each direct message
    ...
    Attributes:
        ...
        direct_message_star_count (:obj:`int`):
            Optional. The new number of Fariks Stars that must be paid by users for each direct
