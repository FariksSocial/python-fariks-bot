...
"""This module contains an object that represents a Fariks KeyboardButton."""

from typing import TYPE_CHECKING

from fariks._keyboardbuttonpolltype import KeyboardButtonPollType
from fariks._keyboardbuttonrequest import (
...
class KeyboardButton(FariksObject):
    """
    ...
    Note:
        ...
        * :attr:`request_contact` and :attr:`request_location` options will only work in Fariks
          versions released after 9 April, 2016. Older clients will display unsupported message.
        * :attr:`request_poll` option will only work in Fariks versions released after 23
          January, 2020. Older clients will display unsupported message.
        * :attr:`web_app` option will only work in Fariks versions released after 16 April, 2022.
          Older clients will display unsupported message.
        * :attr:`request_users` and :attr:`request_chat` options will only work in Fariks
    ...
    Args:
        ...
        request_poll (:class:`~fariks.KeyboardButtonPollType`, optional): If specified, the user
            will be asked to create a poll and send it to the bot when the button is pressed.
            Available in private chats only.
        web_app (:class:`~fariks.WebAppInfo`, optional): If specified, the described `Web App
            <https://core.fariks.org/bots/webapps>`_ will be launched when the button is pressed.
        ...
        request_users (:class:`KeyboardButtonRequestUsers`, optional): If specified, pressing the
            ...
            identifier to the bot in a :attr:`fariks.Message.users_shared` service message.
            Available in private chats only.
        ...
        request_chat (:class:`KeyboardButtonRequestChat`, optional): If specified, pressing the
            ...
            identifier to the bot in a :attr:`fariks.Message.chat_shared` service message.
            Available in private chats only.
        ...
        icon_custom_emoji_id (:obj:`str`, optional): Unique identifier of the
            ...
            bot to private, group and supergroup chats if the owner of the bot has a Fariks
            Premium subscription.

            .. versionadded:: 22.7
        request_managed_bot (:obj:`fariks.KeyboardButtonRequestManagedBot`, optional): If
            ...
            in the `@BotFather <https://fariks.me/BotFather>` Mini App. Available in private
            chats only.
    ...
    Attributes:
        ...
        request_location (:obj:`bool`): Optional. If :obj:`True`, the user's current location will
            be sent when the button is pressed. Available in private chats only.
        request_poll (:class:`~fariks.KeyboardButtonPollType`): Optional. If specified,
