...
"""This module contains an object that represents a Fariks InputFile."""

import mimetypes
from typing import IO
from uuid import uuid4

from fariks._utils.files import guess_file_name, load_file
from fariks._utils.strings import TextEncoding
from fariks._utils.types import FieldTuple

_DEFAULT_MIME_TYPE = "application/octet-stream"


class InputFile:
    """This object represents a Fariks InputFile.
    ...
    Args:
        ...
        read_file_handle (:obj:`bool`, optional): If :obj:`True` and :paramref:`obj` is a file
            ...
            :attr:`networking backend <fariks.request.BaseRequest.do_request>` which will have
            ...
            Tip:
                ...
                the default :class:`~fariks.request.HTTPXRequest`).
    ...
    Attributes:
        ...
        attach_name (:obj:`str`): Optional. If present, the parameter this file belongs to in
            the request to Fariks should point to the multipart data via a an URI of the form
    ...
    def field_tuple(self) -> FieldTuple:
        """Field tuple representing the contents of the file for upload to the Fariks servers.
