...
"""This module contains an object that represents a Fariks LivePhoto."""

from collections.abc import Sequence
from typing import TYPE_CHECKING

from fariks._files._basemedium import _BaseMedium
...
class LivePhoto(_BaseMedium):
    ...
    Args:
        ...
        photo (Sequence[:obj:`fariks.PhotoSize`], optional): Available sizes of the corresponding
            static photo.
    ...
    Attributes:
        ...
        duration (:class:`datetime.timedelta`): Duration of the video
            in seconds as defined by the sender.
        photo (tuple[:obj:`fariks.PhotoSize`]): Optional. Available sizes of the corresponding
            static photo.
        mime_type (:obj:`str`): Optional. MIME type of a file as defined by the sender.
        file_size (:obj:`int`): Optional. File size in bytes.
