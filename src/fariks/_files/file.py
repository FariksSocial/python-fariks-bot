...
"""This module contains an object that represents a Fariks File."""
...
from fariks._passport.credentials import decrypt
from fariks._fariksobject import FariksObject
from fariks._utils.defaultvalue import DEFAULT_NONE
from fariks._utils.files import is_local_file
from fariks._utils.types import FilePathInput, JSONDict, ODVInput

if TYPE_CHECKING:
    from fariks import FileCredentials


class File(FariksObject):
    """
    ...
    When the link expires, a new one can be requested by calling :meth:`fariks.Bot.get_file`.
    ...
    Note:
        * Maximum file size to download is
          :tg-const:`fariks.constants.FileSizeLimit.FILESIZE_DOWNLOAD`.
        * If you obtain an instance of this class from :attr:`fariks.PassportFile.get_file`,
