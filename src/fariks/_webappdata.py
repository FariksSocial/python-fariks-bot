...
"""This module contains an object that represents a Fariks WebAppData."""

from fariks._fariksobject import FariksObject
from fariks._utils.types import JSONDict


class WebAppData(FariksObject):
    """Contains data sent from a `Web App <https://core.fariks.org/bots/webapps>`_ to the bot.
    ...
    Args:
        data (:obj:`str`): The data. Be aware that a bad client can send arbitrary data in this
            field.
        button_text (:obj:`str`): Text of the :paramref:`~fariks.KeyboardButton.web_app` keyboard
