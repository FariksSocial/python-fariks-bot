...
"""This module contains two objects that represent a Fariks bots (short) description."""

from fariks._fariksobject import FariksObject
from fariks._utils.types import JSONDict


class BotDescription(FariksObject):
...
class BotShortDescription(FariksObject):
