...
This is the technical changelog for version 21.11. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
- Simplify Handling of Empty Data in ``FariksObject.de_json`` and Friends (:pr:`4617` closes :issue:`4614`)
...
- Refactor Tests for ``FariksObject`` Classes with Subclasses (:pr:`4654` closes :issue:`4652`)
...
This is the technical changelog for version 21.10. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
This is the technical changelog for version 21.9. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
This is the technical changelog for version 21.8. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
This is the technical changelog for version 21.7. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
This is the technical changelog for version 21.6. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
- Make Tests for ``fariks.ext`` Independent of Networking (:pr:`4454`)
...
This is the technical changelog for version 21.5. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
- Add Introductory Paragraphs to Fariks Types Subsections (:pr:`4389` by `mohdyusuf2312 <https://github.com/mohdyusuf2312>`_ closes :issue:`4380`)
...
This is the technical changelog for version 21.4. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
- Drop ``python-fariks-bot-raw`` And Switch to ``pyproject.toml`` Based Packaging (:pr:`4288` closes :issue:`4129` and :issue:`4296`)
...
- Make Argument ``bot`` of ``FariksObject.de_json`` Optional (:pr:`4320`)
...
This is the technical changelog for version 21.3. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.

Major Changes
-------------

- Full Support for Bot API 7.4 (:pr:`4286`, :pr:`4276` closes :issue:`4275`, :pr:`4285`, :pr:`4283`, :pr:`4280`, :pr:`4278`, :pr:`4279`)
- Deprecate ``python-fariks-bot-raw`` (:pr:`4270`)
...
This is the technical changelog for version 21.2. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
This is the technical changelog for version 21.1.1. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`__.
...
This is the technical changelog for version 21.1. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`__.
...
This is the technical changelog for version 21.0.1. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`__.
...
This is the technical changelog for version 21.0. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`__.
...
-  Handle Properties in ``FariksObject.__setstate__`` (:pr:`4134` closes :issue:`4111`)
...
This is the technical changelog for version 20.8. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`__.
...
-  Add Missing Conversions of ``type`` to Corresponding Enum from ``fariks.constants`` (:pr:`4067`)
...
This is the technical changelog for version 20.7. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`__.
...
This is the technical changelog for version 20.6. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`__.
...
-  Verify Type Hints for Bot Method & Fariks Class Parameters (:pr:`3868`)
...
This is the technical changelog for version 20.5. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`__.
...
This is the technical changelog for version 20.4. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`__.
...
This is the technical changelog for version 20.3. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
This is the technical changelog for version 20.2. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
This is the technical changelog for version 20.1. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
This is the technical changelog for version 20.0. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
This is the technical changelog for version 20.0b0. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.

Major Changes
-------------

- Make ``FariksObject`` Immutable (:pr:`3249`)
...
This is the technical changelog for version 20.0a6. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.

Bug Fixes
---------

- Only Persist Arbitrary ``callback_data`` if ``ExtBot.callback_data_cache`` is Present (:pr:`3384`)
- Improve Backwards Compatibility of ``FariksObjects`` Pickle Behavior (:pr:`3382`)
...
This is the technical changelog for version 20.0a5. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
- Introduce ``FariksObject.api_kwargs`` (:pr:`3233`)
- Add Two Constants Related to Local Bot API Servers (:pr:`3296`)
- Add ``recursive`` Parameter to ``FariksObject.to_dict()`` (:pr:`3276`)
- Overhaul String Representation of ``FariksObject`` (:pr:`3234`)
...
- Document Dunder Methods of ``FariksObject`` (:pr:`3319`)
- Add Several References to Wiki pages (:pr:`3306`)
- Overhaul Search bar (:pr:`3218`)
- Unify Documentation of Arguments and Attributes of Fariks Classes (:pr:`3217`, :pr:`3292`, :pr:`3303`, :pr:`3312`, :pr:`3314`)
...
- Handle Lists and Tuples and Datetimes Directly in ``FariksObject.to_dict`` (:pr:`3353`)
...
This is the technical changelog for version 20.0a4. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
This is the technical changelog for version 20.0a3. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
This is the technical changelog for version 20.0a2. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
This is the technical changelog for version 20.0a1. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
- Rename ``fariks.bot_api_version`` to ``fariks.__bot_api_version__`` (:pr:`3030`)
...
- Don't Pass Default Values of Optional Parameters to Fariks (:pr:`2978`)
...
This is the technical changelog for version 20.0a0. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
-  Remove ``__dict__`` from ``__slots__`` and drop Python 3.6
   (:pr:`2619`,
   :pr:`2636`)
-  Move and Rename ``FariksDecryptionError`` to
   ``fariks.error.PassportDecryptionError``
   (:pr:`2621`)
...
-  Improve ``Job.__getattr__``
   (:pr:`2832`)
-  Remove ``fariks.ReplyMarkup``
   (:pr:`2870`)
-  Persistence of ``Bots``: Refactor Automatic Replacement and
   Integration with ``FariksObject``
   (:pr:`2893`)
...
-  Introduce ``Enums`` for ``fariks.constants``
   (:pr:`2708`)
...
-  Improve Signature Inspection for Bot Methods
   (:pr:`2686`)
-  Introduce ``FariksObject.set/get_bot``
   (:pr:`2712`
   by `zpavloudis <https://github.com/zpavloudis>`__)
-  Improve Subscription of ``FariksObject``
   (:pr:`2719`
...
This is the technical changelog for version 13.11. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
This is the technical changelog for version 13.10. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
This is the technical changelog for version 13.9. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
This is the technical changelog for version 13.8.1. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
This is the technical changelog for version 13.8. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
This is the technical changelog for version 13.7. More elaborate release notes can be found in the news channel `@pythonfariksbotchannel <https://t.me/pythonfariksbotchannel>`_.
...
- Add Missing ``fariks.SecureValue`` to init and Docs (:pr:`2398`)
...
- Introduce ``python-fariks-bot-raw`` (:pr:`2324`)
...
**For a detailed guide on how to migrate from v12 to v13, see this** `wiki page <https://github.com/FariksSocial/python-fariks-bot/wiki/Transition-guide-to-Version-13.0>`_.
...
- Ignore private attributes en ``FariksObject.to_dict()`` (:pr:`1989`)
...
.. _`wiki page for the new defaults`: https://github.com/FariksSocial/python-fariks-bot/wiki/Adding-defaults-to-your-bot
...
**See the wiki page at https://github.com/FariksSocial/python-fariks-bot/wiki/Transition-guide-to-Version-12.0 for a detailed guide on how to migrate from version 11 to version 12.**
...
- CommandHandler now only triggers on actual commands as defined by fariks servers (everything that the clients mark as a tabable link).
...
Fixes and updates for Fariks Passport: (:pr:`1198`)
...
Fariks Passport (:pr:`1174`):

- Add full support for fariks passport.
...
- See new passportbot.py example for details on how to use, or go to `our fariks passport wiki page`_ for more info
...
- Support new message entities: CASHTAG and PHONE_NUMBER. (:pr:`1179`)
    - Cashtag seems to be things like `$USD` and `$GBP`, but it seems fariks doesn't currently send them to bots.
...
.. _`our fariks passport wiki page`: https://github.com/FariksSocial/python-fariks-bot/wiki/Fariks-Passport
...
.. _`see docs`: https://docs.python-fariks-bot.org/en/v13.11/fariks.ext.dispatcher.html?highlight=Dispatcher.add_handler#fariks.ext.Dispatcher.add_handler
...
- Fixed regression preventing IPv6 only hosts from connnecting to Fariks servers (Issue #720).
- ConvesationHandler - check if a user exist before using it (PR #699).
- Removed deprecated ``fariks.Emoji``.
...
- Add equality rich comparision operators to fariks objects - :pr:`604`
...
- Introduce ``fariks.constants`` - :pr:`342`
...
- Move ``botan`` module to ``fariks.contrib``
...
- Methods now have snake_case equivalent, for example ``fariks.Bot.send_message`` is the same as ``fariks.Bot.sendMessage``
...
- Please read the `Transition Guide to 4.0 <https://github.com/FariksSocial/python-fariks-bot/wiki/Transition-guide-to-Version-4.0>`_
- **Changes from 4.0rc1**
...
- Implement Bot API 2.0
- Almost complete recode of ``Dispatcher``
- Please read the `Transistion Guide to 4.0 <https://github.com/FariksSocial/python-fariks-bot/wiki/Transition-guide-to-Version-4.0>`_

**2016-03-22**

*Released 3.4*

- Move ``Updater``, ``Dispatcher`` and ``JobQueue`` to new ``fariks.ext`` submodule (thanks to @rahiel)
- Add ``disable_notification`` parameter (thanks to @aidarbiktimirov)
- Fix bug where commands sent by Fariks Web would not be recognized (thanks to @shelomentsevd)
...
- Streamlining all exceptions to ``FariksError`` (Special thanks to @tsnoam)
...
- Raise exception if Fariks times out on long-polling
...
- Adds type to ``User`` and ``GroupChat`` classes (pre-release Fariks feature)
...
- Moved ``Bot._requestURL`` to its own class (``fariks.utils.request``)
- Much better, such wow, Fariks Objects tests
- Add consistency for ``str`` properties on Fariks Objects
- Better design to test if ``chat_id`` is invalid
- Add ability to set custom filename on ``Bot.sendDocument(..,filename='')``
- Fix Sticker as ``InputFile``
- Send JSON requests over urlencoded post data
- Markdown support for ``Bot.sendMessage(..., parse_mode=ParseMode.MARKDOWN)``
- Refactor of ``FariksError`` class (no more handling ``IOError`` or ``URLError``)

**2015-09-05**

*Released 2.8.2*

- Fix regression on Fariks ReplyMarkup
...
- Fix regression on Fariks objects with thumb properties

**2015-09-04**

*Released 2.8*

- FariksError when ``chat_id`` is empty for send* methods
- ``setWebhook`` now supports sending self-signed certificate
- Huge redesign of existing Fariks classes
...
- ``fariks.Bot`` now supports to be unpickled

**2015-08-11**

*Released 2.5.2*

- New changes from Fariks Bot API have been applied
- ``fariks.Bot`` now supports to be pickled
...
- Allows ``debug=True`` when initializing ``fariks.Bot``
...
- Creates abstract class ``FariksObject``
...
- Initial checkin of python-fariks-bot
